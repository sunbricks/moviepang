...
public class NaverVO {
   //네이버 기본 정보
   private String client_id = "zivZPkTrvNjoT_Gli09V";
   private String callback_url = "http://moviepang.kro.kr";
   private String client_secret = "_lyCsmYZuD";
   ...
   public String toString() {
      return "NaverVO [client_id=" + client_id + ", callback_url=" + callback_url + ", client_secret=" + client_secret
