...
<%-- 	<input type="button" onclick="location.href='${pageContext.request.contextPath }/productList.ko';" value="상품목록보기" /> --%>
	<form action="insertBoard.do" method="post" id="dataTransferForm" enctype="multipart/form-data">
...
<!-- 		썸네일 이미지 등록: <input type="file" name="pthumbnailimg" id="pthumbnailimg"> -->
		...
		<input type="text" name="bn_title" id="pname" placeholder="공지사항 제목입력">
<!-- 		<input type="number" name="pprice" id="pprice" placeholder="상품금액 입력"> -->
		<input type="submit" onclick="submitContents();" value="서버로 내용 전송" />
	</form>
