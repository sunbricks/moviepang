...
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/dashmodal.css">
...
<!-- 	<form action="updateBoard.do" method="post" id="dataTransferForm" enctype="multipart/form-data"> -->
<!-- 		<textarea name="bn_content" id="ir1" rows="10" cols="100" style="width:766px; height:412px; display:none;"></textarea> -->
<!-- 		썸네일 이미지 등록: <input type="file" name="pthumbnailimg" id="pthumbnailimg"> -->
<!-- 		<input type="text" name="bn_title" id="bn_title"> -->
<!-- <!-- 		<input type="number" name="pprice" id="pprice" placeholder="상품금액 입력"> -->
<!-- 		<input type="button" onclick="submitContents();" value="서버로 내용 전송" /> -->
<!-- 	</form> -->
	 <form action="updateBoard.do" method="post" id="dataTransferForm" enctype="multipart/form-data">
    <input type="hidden" name="bn_num" id="bnNum" value="${Board.bn_num}">
    <div>
        <label for="bn_title">제목:</label>
        <input type="text" name="bn_title" id="bn_title" value="${Board.bn_title}">
    </div>
    <div>
        <label for="bn_content">내용:</label>
        <textarea name="bn_content" id="ir1" rows="10" cols="100" style="width:766px; height:412px;">${Board.bn_content}</textarea>
    </div>
<!--     <div> -->
<!--         썸네일 이미지 등록: <input type="file" name="pthumbnailimg" id="pthumbnailimg"> -->
<!--     </div> -->
...
<div class="modal_btn_box">
        <input type="submit" onclick="submitContents();" class="modify_btn" value="수정">
        <button type="button" class="delete_btn anno_delete_btn" id="deleteButton">삭제</button>
        <button type="button" class="confirm_btn close_modify_board_modal" id="closeButton">닫기</button>
    </div>
</form>
...
$(document).ready(function() {
    $('#deleteButton').on('click', function(event) {
        ...
        if (!bnNum) {
//             alert('bn_num 값이 정의되지 않았습니다.');
            return;
        }

        var deleteUrl = 'deleteBoard.do?bn_num=' + bnNum;
...
//                 alert(response);
                window.location.href = 'dashboard.do'; // 성공 시 리다이렉트
            },
...
if(window.frameElement){
	...
	function submitContents() {
	    // 불필요한 요소 제거
	    let imgSetDiv = document.getElementById("imgSetDiv");
	    if (imgSetDiv) {
	        imgSetDiv.remove();
	    }
	    ...
	    // 폼 입력값 검증
	    let form = document.getElementById("dataTransferForm");
	    if (form.bn_title.value === '') {
	        alert('제목을 입력해주세요.');
	        form.bn_title.focus();
	        return false;
	    }
	    if (form.bn_content.value === '') {
	        alert('내용을 입력해주세요.');
	        form.bn_content.focus();
	        return false;
	    }
