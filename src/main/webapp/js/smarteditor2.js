...
, function(e, t) {
    ...
    nhn.husky || (nhn.husky = {}),
    h = /^\$(LOCAL|BEFORE|ON|AFTER)_/,
    r = /^\$(BEFORE|ON|AFTER)_MSG_APP_READY$/,
    d = [],
    a = {},
    nhn.husky.HuskyCore = jindo.$Class({
        ...
        $init: function(e) {
            this.htOptions = e || {},
            d.push(this),
            this.htOptions.oDebugger && (nhn.husky.HuskyCore.getCore = function() {
                return d
            }
            ,
        ...
        exec: function(e, t, i) {
            if (this.appStatus == nhn.husky.APP_STATUS.NOT_READY)
                return this.messageQueue[this.messageQueue.length] = {
                    msg: e,
                    args: t,
                    event: i
                },
        ...
        _execWithDebugger: function(e, t, i) {
            ...
            return this.htOptions.oDebugger.log_MessageEnd(e, t),
            n
        },
        ...
        _doExec: function(e, t, i) {
            ...
            if (this.oLazyMessage[e]) {
                ...
                return this._loadLazyFiles(e, t, i, o.aFilenames, 0),
                !1
            }
            if (!this.oDisabledMessage[e]) {
                ...
                if (t && t.length)
                    for (var r = t.length, a = 0; a < r; a++)
                        s[a] = t[a];
                i && (s[s.length] = i),
                n = (n = (n = this._execMsgStep("BEFORE", e, s)) && this._execMsgStep("ON", e, s)) && this._execMsgStep("AFTER", e, s)
            }
            return n
        },
        registerPlugin: function(e) {
            ...
            if (e.nIdx = this.aPlugins.length,
            ((e.oApp = this).aPlugins[e.nIdx] = e).status != nhn.husky.PLUGIN_STATUS.NOT_READY && (e.status = nhn.husky.PLUGIN_STATUS.READY),
            this.appStatus != nhn.husky.APP_STATUS.NOT_READY)
                for (var t in e)
                    h.test(t) && this.addToMessageMap(t, e);
            return this.exec("MSG_PLUGIN_REGISTERED", [e]),
            e.nIdx
        },
        ...
        createMessageMap: function(e) {
            this.oMessageMap[e] = [];
            for (var t = this.aPlugins.length, i = 0; i < t; i++)
                this._doAddToMessageMap(e, this.aPlugins[i])
        },
        ...
        _changeAppStatus: function(e) {
            this.appStatus = e,
            this.appStatus == nhn.husky.APP_STATUS.READY && this.exec("MSG_APP_READY")
        },
        ...
        _execMsgStepWithDebugger: function(e, t, i) {
            ...
            return this.htOptions.oDebugger.log_MessageStepEnd(e, t, i),
            n
        },
        ...
        _execMsgHandler: function(e, t) {
            ...
            if (r.test(e)) {
                for (i = 0; i < o; i++)
                    if (!1 === this._execHandler(n[i], e, t)) {
                        s = !1;
                        break
                    }
            } else
                for (i = 0; i < o; i++)
                    if ((n[i]._husky_bRun || (n[i]._husky_bRun = !0,
                    "function" != typeof n[i].$LOCAL_BEFORE_FIRST || !1 !== this._execHandler(n[i], "$LOCAL_BEFORE_FIRST", [e, t]))) && ("function" != typeof n[i].$LOCAL_BEFORE_ALL || !1 !== this._execHandler(n[i], "$LOCAL_BEFORE_ALL", [e, t])) && !1 === this._execHandler(n[i], e, t)) {
                        s = !1;
                        break
                    }
            return s
        ...
        _execHandlerWithDebugger: function(e, t, i) {
            ...
            try {
                ...
                this.htOptions.oDebugger.handleException(o),
                n = !1
            }
            return this.htOptions.oDebugger.log_CallHandlerEnd(e, t, i),
            n
        },
        _execHandlerWithoutDebugger: function(e, t, i) {
            this.aCallerStack.push(e);
            var n = e[t].apply(e, i);
            return this.aCallerStack.pop(),
            n
        },
        _doAddToMessageMap: function(e, t) {
            if ("function" == typeof t[e]) {
                for (var i = 0, n = this.oMessageMap[e].length; i < n; i++)
                    if (this.oMessageMap[e][i] == t)
                        return;
                this.oMessageMap[e][i] = t
            }
        },
        _waitForPluginReady: function() {
            for (var e = !0, t = 0; t < this.aPlugins.length; t++)
                if (this.aPlugins[t].status == nhn.husky.PLUGIN_STATUS.NOT_READY) {
                    e = !1;
                    break
                }
        ...
        _loadLazyFiles: function(e, t, i, n, o) {
            if (n.length <= o)
                return this.oLazyMessage[e] = null,
                void this.oApp.exec(e, t, i);
            var s = n[o];
            a[s] ? this._loadLazyFiles(e, t, i, n, o + 1) : jindo.LazyLoading.load(nhn.husky.SE2M_Configuration.LazyLoad.sJsBaseURI + "/" + s, jindo.$Fn(function(e, t, i, n, o) {
                var s = n[o];
                a[s] = 1,
                this._loadLazyFiles(e, t, i, n, o + 1)
        ...
        registerLazyMessage: function(e, t) {
            ...
            for (var i, n, o = 0; i = e[o]; o++)
                (n = this.oLazyMessage[i]) ? n.aFilenames = n.aFilenames.concat(t) : this.oLazyMessage[i] = {
                    sMsg: i,
                    aFilenames: t
                }
        }
    ...
    nhn.husky.HuskyCore.mixin = function(e, t, i) {
        ...
        for (n = 0; r = d[n]; n++)
            for (o = 0; a = r.aPlugins[o]; o++)
                if (a instanceof e)
                    l.push(a),
                    "function" != typeof a.$LOCAL_BEFORE_FIRST && a.oApp.acceptLocalBeforeFirstAgain(a, !0);
                else if (a._$superClass === e)
                    for (s in "function" != typeof a.$LOCAL_BEFORE_FIRST && a.oApp.acceptLocalBeforeFirstAgain(a, !0),
                    t)
                        !i && Object.prototype.hasOwnProperty.call(a, s) || (a[s] = t[s],
                        h.test(s) && a.oApp.addToMessageMap(s, a));
        for (s in t)
            if ((i || !Object.prototype.hasOwnProperty.call(e.prototype, s)) && (e.prototype[s] = t[s],
            h.test(s)))
                for (o = 0; a = l[o]; o++)
                    a.oApp.addToMessageMap(s, a)
    }
    ,
...
, function(e, t) {
    ...
    nhn.CurrentSelection_IE = function() {
        this.getCommonAncestorContainer = function() {
            try {
                return this._oSelection = this._document.selection,
                "Control" == this._oSelection.type ? this._oSelection.createRange().item(0) : this._oSelection.createRangeCollection().item(0).parentElement()
            } catch (e) {
    ...
    nhn.W3CDOMRange = jindo.$Class({
        ...
        cloneContents: function() {
            var e = this._document.createDocumentFragment()
              , t = this._document.createDocumentFragment()
              , i = this._getNodesInRange();
            if (i.length < 1)
                return e;
            var n = this._constructClonedTree(i, t)
              , o = t.firstChild;
            if (o)
                for (var s, r = o.firstChild; r; )
                    s = r.nextSibling,
                    e.appendChild(r),
                    r = s;
            ...
            })).oStartContainer && n.oStartContainer.previousSibling && nhn.DOMFix.parentNode(n.oStartContainer).removeChild(n.oStartContainer.previousSibling),
            n.oEndContainer && n.oEndContainer.nextSibling && nhn.DOMFix.parentNode(n.oEndContainer).removeChild(n.oEndContainer.nextSibling),
            e
        },
        _constructClonedTree: function(e, t) {
            ...
            return this._recurConstructClonedTree = function(e, t, i) {
                ...
                var n = t - 1
                  , o = e[t].cloneNode(!1);
                for (e[t] == a && (s = o),
                e[t] == l && (r = o); 0 <= n && nhn.DOMFix.parentNode(e[n]) == e[t]; )
                    n = this._recurConstructClonedTree(e, n, o);
                return i.insertBefore(o, i.firstChild),
                n
            }
            ,
            e[e.length] = nhn.DOMFix.parentNode(e[e.length - 1]),
            this._recurConstructClonedTree(e, e.length - 1, t),
            {
                oStartContainer: s,
                oEndContainer: r
            }
        ...
        _copyRange: function(e) {
            ...
            e.commonAncestorContainer = this.commonAncestorContainer,
            e.endContainer = this.endContainer,
            e.endOffset = this.endOffset,
            e.startContainer = this.startContainer,
            e.startOffset = this.startOffset,
            e._document = this._document,
            e
        },
        collapse: function(e) {
            e ? (this.endContainer = this.startContainer,
        ...
        deleteContents: function() {
            if (!this.collapsed) {
                ...
                if (!(e.length < 1)) {
                    for (var t = e[0].previousSibling; t && this._isBlankTextNode(t); )
                        t = t.previousSibling;
                    var i, n = -1;
                    t || (i = nhn.DOMFix.parentNode(e[0]),
                    n = 0);
                    for (var o = 0; o < e.length; o++) {
                        var s = e[o];
                        !s.firstChild || this._isAllChildBlankText(s) ? (i == s && (n = this._getPosIdx(i),
                        i = nhn.DOMFix.parentNode(s)),
                        s.parentNode.removeChild(s)) : i == s && 0 === n && (n = this._getPosIdx(i),
                        i = nhn.DOMFix.parentNode(s))
                    }
                    t ? "BODY" == t.tagName ? this.setStartBefore(t, !0) : this.setStartAfter(t, !0) : this.setStart(i, n, !0, !0),
                    this.collapse(!0)
                }
            }
        },
        ...
        getInsertBeforeNodes: function() {
            var e, t = null;
            return (t = "3" == this.startContainer.nodeType ? (e = nhn.DOMFix.parentNode(this.startContainer),
            this.startContainer.nodeValue.length <= this.startOffset ? this.startContainer.nextSibling : this.startContainer.splitText(this.startOffset)) : (e = this.startContainer,
            nhn.DOMFix.childNodes(this.startContainer)[this.startOffset])) && nhn.DOMFix.parentNode(t) || (t = null),
            {
                elParent: e,
                elBefore: t
            }
        ...
        insertNode: function(e) {
            ...
            t.elParent.insertBefore(e, t.elBefore),
        ...
        selectNodeContents: function(e) {
            this.reset(this._window),
            this.setStart(e, 0, !0),
            this.setEnd(e, nhn.DOMFix.childNodes(e).length)
        },
        _endsNodeValidation: function(e, t) {
            if (!e || this._findBody(e) != this._document.body)
                throw new Error("INVALID_NODE_TYPE_ERR oNode is not part of current document");
            return 3 == e.nodeType ? t > e.nodeValue.length && (t = e.nodeValue.length) : t > nhn.DOMFix.childNodes(e).length && (t = nhn.DOMFix.childNodes(e).length),
            t
        },
        setEnd: function(e, t, i, n) {
            i || (t = this._endsNodeValidation(e, t)),
            this.endContainer = e,
            this.endOffset = t,
            n || (this.startContainer && -1 == this._compareEndPoint(this.startContainer, this.startOffset, this.endContainer, this.endOffset) ? this._updateRangeInfo() : this.collapse(!1))
        },
        ...
        setStart: function(e, t, i, n) {
            ...
            this.startOffset = t,
            n || (this.endContainer && -1 == this._compareEndPoint(this.startContainer, this.startOffset, this.endContainer, this.endOffset) ? this._updateRangeInfo() : this.collapse(!0))
        },
        ...
        surroundContents: function(e) {
            e.appendChild(this.extractContents()),
            this.insertNode(e),
            this.selectNode(e)
        },
        toString: function() {
        ...
        _isAllChildBlankText: function(e) {
            for (var t = 0, i = e.childNodes.length; t < i; t++)
                if (!this._isBlankTextNode(e.childNodes[t]))
                    return !1;
            return !0
        },
        _getPosIdx: function(e) {
            for (var t = 0, i = e.previousSibling; i; i = i.previousSibling)
                t++;
            return t
        },
        _updateRangeInfo: function() {
            this.startContainer ? (this.collapsed = this.oBrowserSelection.isCollapsed(this) || this.startContainer === this.endContainer && this.startOffset === this.endOffset,
            this.commonAncestorContainer = this.oBrowserSelection.getCommonAncestorContainer(this)) : this.reset(this._window)
        },
        _isCollapsed: function(e, t, i, n) {
            ...
            if (e == i && t == n)
                ...
                var s = this._getActualStartNode(e, t)
                  , r = this._getActualEndNode(i, n);
                s = this._getNextNode(this._getPrevNode(s)),
                r = this._getPrevNode(this._getNextNode(r)),
                s && r && "BODY" != r.tagName && (this._getNextNode(r) == s || r == s && this._isBlankTextNode(r)) && (o = !0)
            }
            return o
        },
        _splitTextEndNodesOfTheRange: function() {
            ...
            this.startContainer = e.oStartContainer,
            this.startOffset = e.iStartOffset,
            this.endContainer = e.oEndContainer,
            this.endOffset = e.iEndOffset
        },
        _splitTextEndNodes: function(e) {
            return e = this._splitStartTextNode(e),
            e = this._splitEndTextNode(e)
        },
        _splitStartTextNode: function(e) {
            var t = e.oStartContainer
              , i = e.iStartOffset
              , n = e.oEndContainer
              , o = e.iEndOffset;
            if (!t)
        ...
        _getActualStartNode: function(e, t) {
            var i = e;
            return 3 == e.nodeType ? t >= e.nodeValue.length ? "BODY" == (i = this._getNextNode(e)).tagName && (i = null) : i = e : t < nhn.DOMFix.childNodes(e).length ? i = nhn.DOMFix.childNodes(e)[t] : "BODY" == (i = this._getNextNode(e)).tagName && (i = null),
            i
        },
        _getActualEndNode: function(e, t) {
            var i = e;
            return 0 === t ? "BODY" == (i = this._getPrevNode(e)).tagName && (i = null) : i = 3 == e.nodeType ? e : nhn.DOMFix.childNodes(e)[t - 1],
            i
        },
        ...
        _recurGetNextNodesUntil: function(e, t, i) {
            if (!e)
                return !1;
            if (!this._recurGetChildNodesUntil(e, t, i))
                return !1;
            for (var n = e.nextSibling; !n; ) {
                if (!(e = nhn.DOMFix.parentNode(e)))
                    return !1;
                if ((i[this._nNodesBetweenLen++] = e) == t)
                    return !1;
                n = e.nextSibling
            }
        ...
        _recurGetChildNodesUntil: function(e, t, i) {
            ...
            return i[this._nNodesBetweenLen++] = e,
            !n && e != t
        }
    }),
    ...
    nhn.HuskyRange = jindo.$Class({
        ...
        setRange: function(e, t) {
            this.reset(this._window),
            this.setStart(e.startContainer, e.startOffset, t, !0),
            this.setEnd(e.endContainer, e.endOffset, t)
        },
        setEndNodes: function(e, t) {
            this.reset(this._window),
            this.setEndAfter(t, !0),
            this.setStartBefore(e)
        },
        ...
        getNodeAroundRange: function(e, t) {
            return this.collapsed ? this.startContainer && 3 == this.startContainer.nodeType ? this.startContainer : (n = this.startOffset >= nhn.DOMFix.childNodes(this.startContainer).length ? this._getNextNode(this.startContainer) : nhn.DOMFix.childNodes(this.startContainer)[this.startOffset],
            i = 0 === this.endOffset ? this._getPrevNode(this.endContainer) : nhn.DOMFix.childNodes(this.endContainer)[this.endOffset - 1],
            e ? (o = i) || t || (o = n) : (o = n) || t || (o = i),
            o) : this.getStartNode();
            var i, n, o
        },
        _getXPath: function(e) {
            for (var t = ""; e && 1 == e.nodeType; )
                t = "/" + e.tagName + "[" + this._getPosIdx4XPath(e) + "]" + t,
                e = nhn.DOMFix.parentNode(e);
            return t
        },
        _getPosIdx4XPath: function(e) {
            for (var t = 0, i = e.previousSibling; i; i = i.previousSibling)
                i.tagName == e.tagName && t++;
            return t
        },
        _evaluateXPath: function(e, t) {
            for (var i = (e = e.substring(1, e.length - 1)).split(/\//), n = t.body, o = 2; o < i.length && n; o++) {
                i[o].match(/([^[]+)\[(\d+)/i);
                for (var s = RegExp.$1, r = RegExp.$2, a = nhn.DOMFix.childNodes(n), l = [], h = a.length, d = 0, c = 0; c < h; c++)
                    a[c].tagName == s && (l[d++] = a[c]);
        ...
        _evaluateXPathBookmark: function(e) {
            var t = e.sXPath
              , i = e.nTextNodeIdx
              , n = e.nOffset
              , o = this._evaluateXPath(t, this._document);
            if (-1 < i && o) {
                for (var s = nhn.DOMFix.childNodes(o), r = null, a = i, l = n; (r = s[a]) && 3 == r.nodeType && r.nodeValue.length < l; )
                    l -= r.nodeValue.length,
                    a++;
                o = nhn.DOMFix.childNodes(o)[a],
                n = l
            }
            return o || (o = this._document.body,
            n = 0),
            {
                elContainer: o,
                nOffset: n
        ...
        getXPathBookmark: function() {
            ...
            3 == i.nodeType && (t = this._getFixedStartTextNode(),
            e = this._getPosIdx(t.elContainer),
            i = nhn.DOMFix.parentNode(i));
            var n, o = this._getXPath(i), s = {
                sXPath: o,
                nTextNodeIdx: e,
                nOffset: t.nOffset
            };
            if (this.collapsed)
                ...
                var r = -1
                  ...
                  , l = this.endContainer;
                3 == l.nodeType && (a = this._getFixedEndTextNode(),
                r = this._getPosIdx(a.elContainer),
                l = nhn.DOMFix.parentNode(l)),
                n = {
        ...
        moveToXPathBookmark: function(e) {
            if (!e)
                return !1;
            var t = this._evaluateXPathBookmark(e[0])
              , i = this._evaluateXPathBookmark(e[1]);
            return t.elContainer && i.elContainer ? (this.startContainer = t.elContainer,
            this.startOffset = t.nOffset,
            this.endContainer = i.elContainer,
            this.endOffset = i.nOffset,
            !0) : void 0
        },
        _getFixedTextContainer: function(e, t) {
            for (; e && 3 == e.nodeType && e.previousSibling && 3 == e.previousSibling.nodeType; )
                t += e.previousSibling.nodeValue.length,
                e = e.previousSibling;
            return {
                elContainer: e,
                nOffset: t
        ...
        placeStringBookmark_NonWebkit: function() {
            ...
            i.id = this.HUSKY_BOOMARK_END_ID_PREFIX + e,
            t.insertNode(i),
            (t = this.cloneRange()).collapseToStart();
            var n = this._document.createElement("SPAN");
            if (n.id = this.HUSKY_BOOMARK_START_ID_PREFIX + e,
            t.insertNode(n),
        ...
        placeStringBookmark_Webkit: function() {
            ...
            n.collapseToEnd(),
            e = this._document.createTextNode(""),
            n.insertNode(e),
            t = e.parentNode,
            e.previousSibling && "TD" == e.previousSibling.tagName && (t = e.previousSibling,
            e = null);
            var o = this._document.createElement("SPAN");
            o.id = this.HUSKY_BOOMARK_END_ID_PREFIX + i,
            t.insertBefore(o, e),
            (n = this.cloneRange()).collapseToStart(),
            e = this._document.createTextNode(""),
            n.insertNode(e),
            t = e.parentNode,
            e.nextSibling && "TD" == e.nextSibling.tagName && (e = (t = e.nextSibling).firstChild);
            var s = this._document.createElement("SPAN");
            return s.id = this.HUSKY_BOOMARK_START_ID_PREFIX + i,
            t.insertBefore(s, e),
        ...
        moveToStringBookmark: function(e, t) {
            var i = this.getStringBookmark(e)
              , n = this.getStringBookmark(e, !0);
            return !(!i || !n) && (this.reset(this._window),
            t ? (this.setEndAfter(n),
            this.setStartBefore(i)) : (this.setEndBefore(n),
            this.setStartAfter(i)),
            !0)
        },
        removeStringBookmark: function(e) {
            this._removeAll(this.HUSKY_BOOMARK_START_ID_PREFIX + e),
            this._removeAll(this.HUSKY_BOOMARK_END_ID_PREFIX + e)
        },
        _removeAll: function(e) {
            for (var t; t = this._document.getElementById(e); )
        ...
        createAndInsertNode: function(e) {
            ...
            return this.insertNode(t),
            t
        },
        getNodes: function(e, t) {
            e && this._splitTextEndNodesOfTheRange();
            var i = this._getNodesInRange()
              , n = [];
            if (!t)
                return i;
            for (var o = 0; o < i.length; o++)
                t(i[o]) && (n[n.length] = i[o]);
            return n
        },
        ...
        surroundContentsWithNewNode: function(e) {
            var t = this._document.createElement(e);
            return this.surroundContents(t),
            t
        },
        ...
        isNodeInRange: function(e, t, i) {
            ...
            return i && e.firstChild ? (n.setStartBefore(e.firstChild),
            n.setEndAfter(e.lastChild)) : n.selectNode(e),
            this.isRangeInRange(n, t)
        },
        ...
        pasteHTML: function(e, t) {
            ...
            i.firstChild) {
                var n = this.cloneRange()
                  , o = n.placeStringBookmark()
                  , s = n.getLineInfo()
                  , r = s.oStart
                  , a = s.oEnd;
                if (r.oLineBreaker && "P" === r.oLineBreaker.nodeName && (t || n.rxHasBlock.test(e))) {
                    var l = r.oLineBreaker.parentNode
                      , h = r.oLineBreaker.nextSibling;
                    if (n.deleteContents(),
                    r.oLineBreaker === a.oLineBreaker) {
                        var d = n.getStringBookmark(o);
                        n.setEndNodes(d, a.oLineBreaker);
                        var c = n.extractContents()
                          , _ = c.firstChild;
                        h ? l.insertBefore(c, h) : l.appendChild(c),
                        h = _
                    }
                    i.style.cssText = r.oLineBreaker.style.cssText.replace(this._rxTextAlign, ""),
                    i.align = r.oLineBreaker.align,
                    h ? l.insertBefore(i, h) : l.appendChild(i),
                    n.removeStringBookmark(o),
                    this._removeEmptyP(this._getPrevElement(i));
                    var p = this._getNextElement(i);
                    if (p) {
                        var E = this._getNextElement(p);
                        E && this._removeEmptyP(p) && (p = E)
                    } else
                        (p = this._document.createElement("P")).style.cssText = r.oLineBreaker.style.cssText,
                        p.align = r.oLineBreaker.align,
                        l.appendChild(p);
                    "" === p.innerHTML && (p.innerHTML = jindo.$Agent().navigator().ie && 8 < jindo.$Agent().navigator().version ? "​" : "\ufeff"),
                    this.selectNodeContents(p),
                    this.collapseToStart(),
                    jindo.$Agent().navigator().ie && jindo.$Agent().navigator().version < 9 && (o = this.placeStringBookmark(),
                    this.removeStringBookmark(o))
                } else {
                    var u = i.firstChild
                      , g = i.lastChild;
                    for (this.collapseToStart(); i.lastChild; )
                        this.insertNode(i.lastChild);
                    this.setEndNodes(u, g),
                    n.moveToBookmark(o),
                    n.deleteContents(),
                    n.removeStringBookmark(o)
                }
        ...
        _removeEmptyP: function(e) {
            if (e && "P" === e.nodeName) {
                var t = e.innerHTML;
                if ("" === t || this._rxCursorHolder.test(t))
        ...
        toString: function() {
            return this.toString = nhn.W3CDOMRange.prototype.toString,
            this.toString()
        },
        ...
        findAncestorByTagName: function(e) {
            for (var t = this.commonAncestorContainer; t && t.tagName != e; )
                t = nhn.DOMFix.parentNode(t);
            return t
        },
        selectNodeContents: function(e) {
            if (e) {
                var t = e.firstChild ? e.firstChild : e
                  , i = e.lastChild ? e.lastChild : e;
                this.reset(this._window),
                3 == t.nodeType ? this.setStart(t, 0, !0) : this.setStartBefore(t),
                3 == i.nodeType ? this.setEnd(i, i.nodeValue.length, !0) : this.setEndAfter(i)
            }
        },
        ...
        _checkTextDecoration: function(e) {
            if ("SPAN" === e.tagName) {
                for (var t = !1, i = !1, n = null, o = e.firstChild; o; ) {
                    if (1 === o.nodeType && (t = t || "U" === o.tagName,
                    i = i || "S" === o.tagName || "STRIKE" === o.tagName),
                    t && i)
                        return;
                    o = o.nextSibling
                }
                for (n = nhn.DOMFix.parentNode(e); n && "BODY" !== n.tagName; )
                    if (1 === n.nodeType) {
                        if (!t && this._hasTextDecoration(n, "underline") && (t = !0,
                        this._setTextDecoration(e, "underline")),
                        !i && this._hasTextDecoration(n, "line-through") && (i = !0,
        ...
        styleRange: function(e, t, i, n, o) {
            ...
            if (!(s.length < 1)) {
                for (var r, a, l, h = 0; h < s.length; h++) {
                    for (l in e)
                        "string" == typeof (a = e[r = l]) && (o && e.color && this._checkTextDecoration(s[h]),
                        s[h].style[r] = a);
                    if (t)
                        for (l in t)
                            "string" == typeof (a = t[r = l]) && ("class" == r ? jindo.$Element(s[h]).addClass(a) : s[h].setAttribute(r, a))
                }
                this.reset(this._window),
                this.setStartBefore(s[0]),
                this.setEndAfter(s[s.length - 1])
            }
        },
        ...
        _getStyleParentNodes: function(e, t) {
            this._splitTextEndNodesOfTheRange();
            var i, n, o = this.getStartNode(), s = this.getEndNode(), r = this._getNodesInRange(), a = [], l = 0, h = r.length, d = jindo.$A(r).filter(function(e) {
            ...
            for (var _ = 0; _ < h; _++)
                if (i = r[_])
                    if (t && "LI" == i.tagName && this._isFullyContained(i, d))
                        a[l++] = i;
                    else if (3 == i.nodeType && "" != i.nodeValue && !i.nodeValue.match(/^(\r|\n)+$/)) {
                        ...
                        n.appendChild(i),
                        a[l++] = n,
                        e && n.setAttribute(e, "true")
                    }
            return this.setStartBefore(o),
            this.setEndAfter(s),
            a
        },
        _findParentSingleSpan: function(e) {
            if (!e)
                return null;
            for (var t, i, n = 0, o = 0, s = e.childNodes; i = s[n]; n++)
                if (t = i.nodeValue,
                !this._rxCursorHolder.test(t) && 1 < ++o)
                    return null;
        ...
        _isFullyContained: function(e, t, i) {
            ...
            return -1 != (n = i && s == i ? 1 : t.indexOf(s)) && (s = this._getVeryLastRealChild(e),
            o = i && s == i ? 1 : t.indexOf(s)),
            -1 != n && -1 != o
        },
        ...
        _getFirstRealChild: function(e) {
            for (var t = e.firstChild; t && 3 == t.nodeType && "" == t.nodeValue; )
                t = t.nextSibling;
            return t
        },
        _getLastRealChild: function(e) {
            for (var t = e.lastChild; t && 3 == t.nodeType && "" == t.nodeValue; )
                t = t.previousSibling;
            return t
        },
                    ...
                    (function t(e) {
                        if (e && !i) {
                            if (r.test(e.tagName))
                                ...
                                void (s = !1);
                            n = e,
                            i || t(e.previousSibling)
                        }
                    }
                    )((n = e).previousSibling),
                    i || a(nhn.DOMFix.parentNode(e))
                }
            }(e),
            {
                oNode: i,
        ...
        getLineInfo: function(e) {
            e = e || !1;
            var t = this.getStartNode()
              , i = this.getEndNode();
            t = t || this.getNodeAroundRange(!e, !0),
            i = i || this.getNodeAroundRange(!e, !0);
            var n = this._getLineStartInfo(t)
              , o = n.oNode
              , s = this._getLineEndInfo(i)
              , r = s.oNode;
            if (t != o || i != r) {
                ...
                a <= 0 && 0 <= l || (t = this.getNodeAroundRange(!1, !0),
                i = this.getNodeAroundRange(!1, !0),
                n = this._getLineStartInfo(t),
                s = this._getLineEndInfo(i))
            }
            return {
                oStart: n,
        ...
        _findSingleChild: function(e) {
            if (!e)
                return null;
            for (var t, i, n = null, o = 0, s = 0, r = e.childNodes; i = r[o]; o++)
                if (t = i.nodeValue,
                !this._rxCursorHolder.test(t) && (n = i,
                1 < ++s))
                    return null;
            return n
        },
    ...
    nhn.BrowserSelection = function(e) {
        ...
        ,
        this.init(e),
        this._document.createRange ? nhn.BrowserSelectionImpl_FF.apply(this) : nhn.BrowserSelectionImpl_IE.apply(this),
        this.selectRange = function(e) {
            this.selectNone(),
            this.addRange(e)
        }
        ,
        this.selectionLoaded = !0,
        this._oSelection || (this.selectionLoaded = !1)
    }
    ,
    nhn.BrowserSelectionImpl_FF = function() {
        ...
        this._FFRange2W3CRange = function(e) {
            ...
            return t.setStart(e.startContainer, e.startOffset, !0),
    ...
    nhn.BrowserSelectionImpl_IE = function() {
        ...
        this._updateLastRange = function(e, t) {
            this.oLastRange.oBrowserRange = e,
            this.oLastRange.elStartContainer = t.startContainer,
            this.oLastRange.nStartOffset = t.startOffset,
            this.oLastRange.elEndContainer = t.endContainer,
            this.oLastRange.nEndOffset = t.endOffset
        }
        ,
        this.getRangeAt = function(e) {
            var t, i, n;
            return e = e || 0,
            "Control" == this._oSelection.type ? (t = new nhn.W3CDOMRange(this._window),
            (n = this._oSelection.createRange().item(e)) && n.ownerDocument == this._document && t.selectNode(n),
            t) : t = (n = (i = this._oSelection.createRange()).parentElement()) && n.ownerDocument == this._document ? this._IERange2W3CRange(i) : new nhn.W3CDOMRange(this._window)
        }
        ,
        this.addRange = function(e) {
        ...
        ,
        this.isCollapsed = function(e) {
            var t = this._W3CRange2IERange(e)
              , i = t.duplicate();
            return i.collapse(),
            t.isEqual(i)
        }
        ...
        this.compareEndPoints = function(e, t, i, n) {
            var o, s;
            return e === this.oLastRange.elStartContainer && t === this.oLastRange.nStartOffset ? (o = this.oLastRange.oBrowserRange.duplicate()).collapse(!0) : e === this.oLastRange.elEndContainer && t === this.oLastRange.nEndOffset ? (o = this.oLastRange.oBrowserRange.duplicate()).collapse(!1) : o = this._getIERangeAt(e, t),
            i === this.oLastRange.elStartContainer && n === this.oLastRange.nStartOffset ? (s = this.oLastRange.oBrowserRange.duplicate()).collapse(!0) : i === this.oLastRange.elEndContainer && n === this.oLastRange.nEndOffset ? (s = this.oLastRange.oBrowserRange.duplicate()).collapse(!1) : s = this._getIERangeAt(i, n),
            o.compareEndPoints("StartToStart", s)
        }
        ,
        this._W3CRange2IERange = function(e) {
            if (this.oLastRange.elStartContainer === e.startContainer && this.oLastRange.nStartOffset === e.startOffset && this.oLastRange.elEndContainer === e.endContainer && this.oLastRange.nEndOffset === e.endOffset)
            ...
            return t.setEndPoint("EndToEnd", i),
            this._updateLastRange(t, e),
            t
        }
        ,
        this._getIERangeAt = function(e, t) {
            var i = this._document.body.createTextRange()
              , n = this._getSelectableNodeAndOffsetForIE(e, t)
              , o = n.oSelectableNodeForIE
              , s = n.iOffsetForIE;
        ...
        this._getSelectableNodeAndOffsetForIE = function(e, t) {
            var i = null
              , n = null
              , o = 0;
            o = 3 == e.nodeType ? (i = nhn.DOMFix.parentNode(e),
            (n = nhn.DOMFix.childNodes(i)).length) : (i = e,
            t < (n = nhn.DOMFix.childNodes(i)).length ? t : n.length);
            for (var s = null, r = 0, a = !0, l = 0; l < o; l++)
                if (3 == (s = n[l]).nodeType) {
                    if (s == e)
                        break;
                    ...
                    r = 0,
                    a = !1;
            return 3 == e.nodeType && (r += t),
            {
                oSelectableNodeForIE: i,
                iOffsetForIE: r,
                bCollapseToStart: a
            }
        }
        ...
        this._IERange2W3CRange = function(e) {
            var t = new nhn.W3CDOMRange(this._window)
              , i = null
              , n = null;
            (i = e.duplicate()).collapse(!0),
            n = this._getW3CContainerAndOffset(i, !0),
            t.setStart(n.oContainer, n.iOffset, !0, !0);
            var o = e.duplicate();
            return o.collapse(!0),
            o.isEqual(e) ? t.collapse(!0) : ((i = e.duplicate()).collapse(!1),
            n = this._getW3CContainerAndOffset(i),
            t.setEnd(n.oContainer, n.iOffset, !0)),
            this._updateLastRange(e, t),
            t
        }
        ,
        this._getW3CContainerAndOffset = function(e, t) {
            for (var i, n = e, o = n.parentElement(), s = -1, r = this._document.body.createTextRange(), a = nhn.DOMFix.childNodes(o), l = null, h = 0; h < a.length; h++)
                if (3 != a[h].nodeType) {
                    if (r.moveToElementText(a[h]),
                    0 <= r.compareEndPoints("StartToStart", e))
                        break;
                    l = a[h]
                }
            if (0 !== (i = h) && 3 == a[i - 1].nodeType) {
                var d = this._document.body.createTextRange()
                  , c = null;
                c = l ? (d.moveToElementText(l),
                d.collapse(!1),
                l.nextSibling) : (d.moveToElementText(o),
                d.collapse(!0),
                o.firstChild);
                var _ = n.duplicate();
                _.setEndPoint("StartToStart", d);
                for (var p = _.text.replace(/[\r\n]/g, "").length; p > c.nodeValue.length && c.nextSibling; )
                    p -= c.nodeValue.length,
                    c = c.nextSibling;
                c.nodeValue,
                t && c.nextSibling && 3 == c.nextSibling.nodeType && p == c.nodeValue.length && (p -= c.nodeValue.length,
                c = c.nextSibling),
                o = c,
                s = p
            } else
    ...
    nhn.DOMFix = new (jindo.$Class({
        $init: function() {
            jindo.$Agent().navigator().ie || jindo.$Agent().navigator().opera ? (this.childNodes = this._childNodes_Fix,
            this.parentNode = this._parentNode_Fix) : (this.childNodes = this._childNodes_Native,
    ...
    nhn.husky.CorePlugin = jindo.$Class({
        ...
        _loadFullPlugin: function(e, t, i, n, o, s) {
            jindo.LazyLoading.load(nhn.husky.SE2M_Configuration.LazyLoad.sJsBaseURI + "/" + e[s], jindo.$Fn(function(e, t, i, n, o, s) {
                var r = e[0];
                if (s == e.length - 1)
                    return this.htLazyLoadRequest_plugins[r].nStatus = 2,
                    void this.oApp.exec("MSG_FULL_PLUGIN_LOADED", [e, t, i, n, o]);
        ...
        $ON_MSG_FULL_PLUGIN_LOADED: function(aFilenames, sClassName, sMsgName, oThisRef, oArguments) {
            ...
            for (var x in "function" != typeof oPluginRef.$LOCAL_BEFORE_FIRST && this.oApp.acceptLocalBeforeFirstAgain(oPluginRef, !0),
            oPlugin)
                oThisRef.$this && (!oThisRef[x] || "function" == typeof oPlugin[x] && "constructor" != x) && (oThisRef[x] = jindo.$Fn(oPlugin[x], oPluginRef).bind()),
                oPlugin[x] && (!oPluginRef[x] || "function" == typeof oPlugin[x] && "constructor" != x) && (oPluginRef[x] = oPlugin[x],
                x.match(/^\$(LOCAL|BEFORE|ON|AFTER)_/) && this.oApp.addToMessageMap(x, oPluginRef));
            bAcceptLocalBeforeFirstAgain && this.oApp.acceptLocalBeforeFirstAgain(oPluginRef, !0),
            oThisRef.$this || this.oApp.exec(sMsgName, oArguments)
        },
        $ON_LOAD_HTML: function(e) {
            if (!this.htHTMLLoaded[e]) {
                ...
                if (t) {
                    ...
                    for (i.innerHTML = t.value; i.firstChild; )
                        t.parentNode.insertBefore(i.firstChild, t)
                }
            }
        },
...
, function(e, t) {
    nhn.husky.HuskyRangeManager = jindo.$Class({
        ...
        $BEFORE_MSG_APP_READY: function() {
            this.oWindow && "IFRAME" == this.oWindow.tagName && (this.oWindow = this.oWindow.contentWindow,
...
, function(e, t, i) {
    ...
    i(45),
    i(46),
    window.nSE2Version = "2.10.0.f24352b",
...
, function(e, t) {
    nhn.husky.SE2M_Toolbar = jindo.$Class({
        ...
        $ON_ALERT: function(e, t) {
            this._elAlertLayer && (t = t || {},
            this._elAlertTxts.innerHTML = e || "",
            this._elAlertOk.onclick = jindo.$Fn(this._hideAlert, this).bind(t.fOkCallback),
            this._elAlertClose.onclick = jindo.$Fn(this._hideAlert, this).bind(t.fCloseCallback),
            t.fCancelCallback ? (this._elAlertCancel.onclick = jindo.$Fn(this._hideAlert, this).bind(t.fCancelCallback),
            this._elAlertCancel.style.display = "") : this._elAlertCancel.style.display = "none",
            this.oApp.exec("SHOW_EDITING_AREA_COVER", [!0]),
        ...
        _assignHTMLElements: function(e) {
            ...
            this.toolbarArea = jindo.$$.getSingle(".se2_tool", e),
            ...
            this._elAlertLayer = jindo.$$.getSingle(".se2_alert_wrap", e),
            this._elAlertLayer && (this._elAlertTxts = jindo.$$.getSingle(".se2_alert_txts", this._elAlertLayer),
            ...
            for (var t = 0, i = this.aAllUI.length; t < i; t++)
                if (this.rxUI.test(this.aAllUI[t].className)) {
                    var n = RegExp.$1;
                    if (this.htUIList[n] !== undefined)
                        continue;
                    this.htUIList[n] = this.aAllUI[t],
                    this.htWrappedUIList[n] = jindo.$Element(this.htUIList[n])
                }
        ...
        $LOCAL_BEFORE_FIRST: function() {
            var e = jindo.$$(">ul>li[class*=" + this.sUIClassPrefix + "]>button", this.elTextTool)
              , t = e.length;
            this.elFirstToolbarItem = this.elFirstToolbarItem || e[0],
            this.elLastToolbarItem = e[t - 1],
        ...
        $ON_MSG_APP_READY: function() {
            this.oApp.bMobile ? this.oApp.registerBrowserEvent(this.toolbarArea, "touchstart", "EVENT_TOOLBAR_TOUCHSTART") : (this.oApp.registerBrowserEvent(this.toolbarArea, "mouseover", "EVENT_TOOLBAR_MOUSEOVER"),
        ...
        $ON_NAVIGATE_TOOLBAR: function(e) {
            e.element == this.elLastToolbarItem && 9 == e.key().keyCode && (e.key().shift || (this.elFirstToolbarItem.focus(),
            e.stopDefault())),
            e.element == this.elFirstToolbarItem && 9 == e.key().keyCode && e.key().shift && (e.stopDefault(),
        ...
        $ON_MSG_TOOLBAR_LAYER_SHOWN: function(e, t, i, n) {
            this.oApp.exec("POSITION_TOOLBAR_LAYER", [e, t]),
            i && this.oApp.exec(i, n)
        },
        $ON_SHOW_TOOLBAR_ACTIVE_LAYER: function(e, t, i, n) {
            this.oApp.exec("SHOW_ACTIVE_LAYER", [e, t, i]),
            this.oApp.exec("POSITION_TOOLBAR_LAYER", [e, n])
        },
        ...
        $ON_TOGGLE_UI_SELECTED: function(e) {
            var t = this.htWrappedUIList[e];
            t && (t.hasClass("active") ? t.removeClass("active") : (t.removeClass("hover"),
            t.addClass("active")))
        },
        $ON_ENABLE_ALL_UI: function(e) {
            if (1 !== this.nUIStatus) {
                ...
                for (t in this.htUIList)
                    t && !i.has(t) && this._enableUI(t);
                this.nUIStatus = 1
            }
        },
        $ON_DISABLE_ALL_UI: function(e) {
            if (2 !== this.nUIStatus) {
                ...
                for (t in n || this.oApp.exec("HIDE_ACTIVE_LAYER"),
                this.htUIList)
                    t && !i.has(t) && this._disableUI(t);
                this.nUIStatus = 2
            }
        },
        ...
        $ON_POSITION_TOOLBAR_LAYER: function(e, t) {
            ...
            if (e) {
                ...
                "right" != a ? (e.style.left = "0",
                n = (i = l.offset().left) + e.offsetWidth,
                (s = (o = this.welToolbarArea.offset().left) + this.toolbarArea.offsetWidth) < n && l.css("left", s - n - -1 + "px"),
                i < o && l.css("left", o - i - 1 + "px")) : (e.style.right = "0",
                n = (i = l.offset().left) + e.offsetWidth,
                (s = (o = this.welToolbarArea.offset().left) + this.toolbarArea.offsetWidth) < n && l.css("right", -1 * (s - n - -1) + "px"),
                i < o && l.css("right", -1 * (o - i - 1) + "px"))
            }
        },
        $ON_EVENT_TOOLBAR_MOUSEOVER: function(e) {
            if (2 !== this.nUIStatus)
                for (var t = this._getAffectedElements(e.element), i = 0; i < t.length; i++)
                    t[i].hasClass("active") || t[i].addClass("hover")
        },
        $ON_EVENT_TOOLBAR_MOUSEOUT: function(e) {
            if (2 !== this.nUIStatus)
                for (var t = this._getAffectedElements(e.element), i = 0; i < t.length; i++)
                    t[i].removeClass("hover")
        },
        $ON_EVENT_TOOLBAR_MOUSEDOWN: function(e) {
            for (var t = e.element; t; ) {
                if (t.className && t.className.match(/active/) && (2 < t.childNodes.length || t.parentNode.className.match(/se2_pair/)))
                    return;
                t = t.parentNode
            }
        ...
        _enableUI: function(e) {
            if (!(this._htOptions._sDisabled && -1 < this._htOptions._sDisabled.indexOf("," + e + ","))) {
                ...
                if (n) {
                    ...
                    var r = "";
                    if (this.aUICmdMap[e])
                        for (t = 0; t < this.aUICmdMap[e].length; t++)
                            r = this.aUICmdMap[e][t],
                            this.oApp.exec("ENABLE_MESSAGE", [r])
                }
            }
        },
        _disableUI: function(e) {
            ...
            if (n) {
                ...
                if (this.aUICmdMap[e])
                    for (t = 0; t < this.aUICmdMap[e].length; t++)
                        r = this.aUICmdMap[e][t],
                        this.oApp.exec("DISABLE_MESSAGE", [r])
            }
        },
        _getAffectedElements: function(e) {
            ...
            if (!e.bSE2_MDCancelled) {
                ...
                for (var n = e.getElementsByTagName("BUTTON"), o = 0, s = n.length; o < s; o++)
                    n[o].onmousedown = function() {
                        return !1
                    }
            }
            if (!e || !e.tagName)
                return [];
            if ("BUTTON" == (t = e).tagName)
                return (t = t.parentNode) && "LI" == t.tagName && this.rxUI.test(t.className) ? [jindo.$Element(t)] : (t = (t = e).parentNode.parentNode) && "LI" == t.tagName && (i = jindo.$Element(t)).hasClass("se2_pair") ? [i, jindo.$Element(e.parentNode)] : [];
            if ("SPAN" == (t = e).tagName) {
                if ((t = t.parentNode.parentNode) && "LI" == t.tagName && this.rxUI.test(t.className))
                    return [jindo.$Element(t)];
                if ((t = t.parentNode) && "LI" == t.tagName && this.rxUI.test(t.className))
                    return [jindo.$Element(t)]
            }
            return []
        },
        $ON_REGISTER_UI_EVENT: function(e, t, i, n) {
            var o;
            this.htUIList[e] && (this.aUICmdMap[e] || (this.aUICmdMap[e] = []),
            this.aUICmdMap[e][this.aUICmdMap[e].length] = i,
            (o = jindo.$$.getSingle("button", this.htUIList[e])) && this.oApp.registerBrowserEvent(o, t, i, n))
        },
...
, function(e, t) {
    nhn.husky.SE_EditingAreaManager = jindo.$Class({
        ...
        $init: function(e, t, i, n, o) {
            this.sDefaultEditingMode = e,
            this.elContentsField = jindo.$(t),
            this._assignHTMLElements(o),
            this.fOnBeforeUnload = n,
            this.oEditingMode = {},
            this.elContentsField.style.display = "none",
            this.nMinWidth = parseInt(i.nMinWidth || 60, 10),
            this.nMinHeight = parseInt(i.nMinHeight || 60, 10);
            ...
            this.elEditingAreaContainer.style.width = s.nSize + s.sUnit,
            this.elEditingAreaContainer.style.height = r.nSize + r.sUnit,
            "px" === s.sUnit ? o.style.width = s.nSize + 2 + "px" : "%" === s.sUnit && (o.style.minWidth = this.nMinWidth + "px")
        },
        ...
        _assignHTMLElements: function(e) {
            ...
            function t() {}
            this.elLoadingLayer = jindo.$$.getSingle(".se2_content_loading", e),
            this.elLoadingLayer || (this.$ON_SHOW_LOADING_LAYER = t,
            this.$ON_HIDE_LOADING_LAYER = t)
        },
        $BEFORE_MSG_APP_READY: function() {
        ...
        $ON_MSG_APP_READY: function() {
            ...
            this.oApp.exec("CHANGE_EDITING_MODE", [this.sDefaultEditingMode, !0]),
            this.oApp.exec("LOAD_CONTENTS_FIELD", [!1]),
            !1 !== this.fOnBeforeUnload && (this.fOnBeforeUnload ? window.onbeforeunload = this.fOnBeforeUnload : window.onbeforeunload = jindo.$Fn(function() {
        ...
        $AFTER_MSG_APP_READY: function() {
            ...
            this.oApp.htOptions[this.name] && this.oApp.htOptions[this.name].bAutoResize && (this.bAutoResize = this.oApp.htOptions[this.name].bAutoResize),
            this.oApp.oNavigator.msafari && (this.bAutoResize = !0),
            this.startAutoResize()
        },
        $ON_LOAD_CONTENTS_FIELD: function(e) {
            var t = this.elContentsField.value;
            t = t.replace(/^\s+/, ""),
            this.oApp.exec("SET_CONTENTS", [t, e])
        },
        ...
        $BEFORE_CHANGE_EDITING_MODE: function(e) {
            if (!this.oEditingMode[e])
                return !1;
            this.stopAutoResize(),
            this._oPrevActivePlugin = this.oActivePlugin,
            this.oActivePlugin = this.oEditingMode[e]
        },
        $AFTER_CHANGE_EDITING_MODE: function(e, t) {
            if (this._oPrevActivePlugin) {
                var i = this._oPrevActivePlugin.getIR();
                this.oApp.exec("SET_IR", [i]),
                this._setEditingAreaDimension()
            }
            this.startAutoResize(),
            t || this.oApp.delayedExec("FOCUS", [], 0)
        },
        $ON_SET_IS_DIRTY: function(e) {
            this.bIsDirty = e
        },
        $ON_FOCUS: function(e) {
            this.oActivePlugin && "function" == typeof this.oActivePlugin.setIR && (this.iframeWindow && this.iframeWindow.document.hasFocus && !this.iframeWindow.document.hasFocus() && "WYSIWYG" == this.oActivePlugin.sMode ? this.iframeWindow.focus() : this.oActivePlugin.focus(),
            e && this.oApp.bMobile || this.oActivePlugin.focus())
        },
        ...
        $ON_REGISTER_EDITING_AREA: function(e) {
            "WYSIWYG" == (this.oEditingMode[e.sMode] = e).sMode && this.attachDocumentEvents(e.oEditingArea),
            this._setEditingAreaDimension(e)
        },
        ...
        $ON_STOP_AUTORESIZE_EDITING_AREA: function() {
            this.bAutoResize && (this.stopAutoResize(),
            this.bAutoResize = !1)
        },
        ...
        $ON_RESIZE_EDITING_AREA: function(e, t) {
            null != e && this._resizeWidth(e, "px"),
            null != t && this._resizeHeight(t, "px"),
            this._setEditingAreaDimension()
        },
        _resizeWidth: function(e, t) {
            var i = parseInt(e, 10);
            i < this.nMinWidth && (i = this.nMinWidth),
            e && (this.elEditingAreaContainer.style.width = i + t)
        },
        _resizeHeight: function(e, t) {
            var i = parseInt(e, 10);
            i < this.nMinHeight && (i = this.nMinHeight),
            e && (this.elEditingAreaContainer.style.height = i + t)
        },
        $ON_RESIZE_EDITING_AREA_BY: function(e, t) {
            var i, n, o = parseInt(e, 10), s = parseInt(t, 10);
            0 !== e && -1 === this.elEditingAreaContainer.style.width.indexOf("%") && (i = this.elEditingAreaContainer.style.width ? parseInt(this.elEditingAreaContainer.style.width, 10) + o : null),
            0 !== s && (n = this.elEditingAreaContainer.style.height ? this.iStartingHeight + s : null),
            (e || s) && this.oApp.exec("RESIZE_EDITING_AREA", [i, n])
        },
        ...
        $ON_SHOW_EDITING_AREA_COVER: function(e) {
            this.elEditingAreaCover || (this.elEditingAreaCover = document.createElement("DIV"),
            ...
            e && jindo.$Element(this.elEditingAreaCover).opacity(.4),
            this.elEditingAreaCover.style.display = "block"
        },
        $ON_HIDE_EDITING_AREA_COVER: function() {
            this.elEditingAreaCover && (this.elEditingAreaCover.style.display = "none",
            jindo.$Element(this.elEditingAreaCover).opacity(0))
        },
        $ON_KEEP_WITHIN_EDITINGAREA: function(e, t) {
            var i = parseInt(e.style.top, 10);
            i + e.offsetHeight > this.oApp.elEditingAreaContainer.offsetHeight && (e.style.top = "number" == typeof t ? i - e.offsetHeight - t + "px" : this.oApp.elEditingAreaContainer.offsetHeight - e.offsetHeight + "px"),
            parseInt(e.style.left, 10) + e.offsetWidth > this.oApp.elEditingAreaContainer.offsetWidth && (e.style.left = this.oApp.elEditingAreaContainer.offsetWidth - e.offsetWidth + "px")
        },
        ...
        _setEditingAreaDimension: function(e) {
            e = e || this.oActivePlugin,
            this._fitElementInEditingArea(e.elEditingArea)
        },
        ...
        attachDocumentEvents: function(e) {
            this.oApp.registerBrowserEvent(e, "click", "EVENT_EDITING_AREA_CLICK"),
            this.oApp.registerBrowserEvent(e, "dblclick", "EVENT_EDITING_AREA_DBLCLICK"),
            this.oApp.registerBrowserEvent(e, "mousedown", "EVENT_EDITING_AREA_MOUSEDOWN"),
            this.oApp.registerBrowserEvent(e, "mousemove", "EVENT_EDITING_AREA_MOUSEMOVE"),
            this.oApp.registerBrowserEvent(e, "mouseup", "EVENT_EDITING_AREA_MOUSEUP"),
            this.oApp.registerBrowserEvent(e, "mouseout", "EVENT_EDITING_AREA_MOUSEOUT"),
            this.oApp.registerBrowserEvent(e, "mousewheel", "EVENT_EDITING_AREA_MOUSEWHEEL"),
            this.oApp.registerBrowserEvent(e, "keydown", "EVENT_EDITING_AREA_KEYDOWN"),
            this.oApp.registerBrowserEvent(e, "keypress", "EVENT_EDITING_AREA_KEYPRESS"),
            this.oApp.registerBrowserEvent(e, "keyup", "EVENT_EDITING_AREA_KEYUP"),
            this.oApp.registerBrowserEvent(e, "scroll", "EVENT_EDITING_AREA_SCROLL")
        },
        ...
        getContents: function() {
            ...
            return e = this.oApp.applyConverter ? this.oApp.applyConverter("IR_TO_DB", t, this.oApp.getWYSIWYGDocument()) : t,
            e = this._cleanContents(e)
        },
        _convertLastBrToNbsp: function() {
            for (var e, t, i, n, o, s, r, a, l, h, d, c = this.oApp.getWYSIWYGDocument().body, _ = document.createTextNode(" "), p = 0, E = (e = jindo.$$("br:last-child", c, {
                oneTimeOffCache: !0
            })).length; p < E; p++)
                if (d = s = null,
                t = e[p],
                (n = this._findNextSiblingRecursive(t, {
                    isReverse: !0
                })) && 1 === n.nodeType && (i = n.nextSibling,
                !this._findNextSiblingRecursive(i))) {
                    if ("IMG" === n.tagName.toUpperCase() ? s = n : 0 < (o = jindo.$$("img:last-child", n, {
                        oneTimeOffCache: !0
                    })).length && (s = o[o.length - 1]),
                    s)
                        if (this._findNextSiblingRecursive(s) == i) {
                            if (!(a = s.parentNode))
                                continue;
                            r = jindo.$Element(s).width(),
                            a = s.parentNode,
                            l = !(r === jindo.$Element(a).width())
                        } else
                            l = !0;
                    else
                        l = !0;
        ...
        _recursiveRemoveChild: function(e) {
            for (var t, i = e.parentNode, n = e; i.removeChild(n),
            (t = i.childNodes) && 0 == t.length && (n = i) && (i = i.parentNode); )
                ;
        },
        ...
        setContents: function(e, t) {
            var i;
            i = this.oApp.applyConverter ? this.oApp.applyConverter("DB_TO_IR", e, this.oApp.getWYSIWYGDocument()) : e,
            this.oApp.exec("SET_IR", [i, t])
        },
...
, function(e, t) {
    nhn.husky.SE_EditingArea_WYSIWYG = jindo.$Class({
        ...
        $init: function(e) {
            ...
            t.ie && (this.iframe.style.display = "none"),
            ...
            this.htOptions && (this.sBlankPageURL = this.htOptions.sBlankPageURL || this.sBlankPageURL,
            ...
            t.ie && jindo.$A(this.aAddtionalEmulateIE7).has(t.nativeVersion) && (this.sIFrameSrc = this.sBlankPageURL_EmulateIE7),
            e = this.iframe;
            ...
            !t.ie || 9 <= t.version && document.addEventListener ? (e.addEventListener("load", n, !1),
            e.addEventListener("error", o, !1)) : (e.attachEvent("onload", n),
            e.attachEvent("onerror", o)),
            e.src = i,
            this.elEditingArea = e
        },
        $BEFORE_MSG_APP_READY: function() {
            ...
            this.isWYSIWYGEnabled() && this.oApp.exec("ENABLE_WYSIWYG_RULER"),
        ...
        $ON_MSG_APP_READY: function() {
            ...
            this._bIERangeReset = !0,
            this.oApp.oNavigator.ie || -1 < navigator.userAgent.indexOf("Edge") ? (this._bIECursorHide = !0,
            jindo.$Fn(function(e) {
                var t = this.iframe.contentWindow.document.selection;
                t && "control" === t.type.toLowerCase() && 8 === e.key().keyCode && (this.oApp.exec("EXECCOMMAND", ["delete", !1, !1]),
                e.stop()),
            ...
            this._nContainerHeight = this.oApp.getEditingAreaHeight(),
        ...
        _dbToIrDOM: function(e) {
            nhn.husky.SE2M_Utils.removeInvalidFont(e),
            nhn.husky.SE2M_Utils.convertFontToSpan(e)
        },
        _setScrollbarWidth: function() {
            ...
            this.nScrollbarWidth = t.offsetWidth - t.clientWidth,
        ...
        _checkBodyChange: function() {
            if (this.bAutoResize) {
                ...
                e !== this.nBodyLength && (this.nBodyLength = e,
                this._setAutoResize())
            }
        },
        _setAutoResize: function() {
            var e, t, i, n, o = this.getDocument().body, s = jindo.$Element(o), r = !1, a = this.oApp.oNavigator;
            this.nTopBottomMargin = this.nTopBottomMargin || parseInt(s.css("marginTop"), 10) + parseInt(s.css("marginBottom"), 10),
            this.nBodyMinHeight = this.nBodyMinHeight || this.oApp.getEditingAreaHeight() - this.nTopBottomMargin,
            s.css("height", "0px"),
            this.iframe.style.height = "0px",
            (e = parseInt(o.scrollHeight, 10)) < this.nBodyMinHeight && (e = this.nBodyMinHeight),
            a.ie ? e > this.nBodyMinHeight ? (i = this.oApp.getCurrentStyle(),
            (n = this._getStyleSize(i)) < this.nTopBottomMargin && (n = this.nTopBottomMargin),
            t = e + n,
            t += 18,
            r = !0) : (e = this.nBodyMinHeight,
            t = this.nBodyMinHeight + this.nTopBottomMargin) : e > this.nBodyMinHeight ? (i = this.oApp.getCurrentStyle(),
            (n = this._getStyleSize(i)) < this.nTopBottomMargin && (n = this.nTopBottomMargin),
            t = e + n,
            r = !0) : (e = this.nBodyMinHeight,
            t = this.nBodyMinHeight + this.nTopBottomMargin),
            s.css("height", e + "px"),
            this.iframe.style.height = t + "px",
            this.oApp.welEditingAreaContainer.height(t),
            this._nContainerHeight !== t && (this._nContainerHeight = t,
            this.oApp.exec("MSG_EDITING_AREA_SIZE_CHANGED")),
            this.oApp.oNavigator.msafari || this.oApp.checkResizeGripPosition(r)
        },
            ...
            if (e) {
                ...
                if (i && /[^\d.]/.test(i))
                    if (/\d/.test(i) && /[A-Za-z]/.test(i)) {
                        ...
                        if (/pt$/.test(i))
                            return 4 * parseFloat(i, 10) / 3;
                        if (/em$/.test(i))
                            return 16 * parseFloat(i, 10);
                        if (/cm$/.test(i))
                            return 96 * parseFloat(i, 10) / 2.54
                    } else
                        /\d/.test(i) && /%/.test(i) ? i = 100 * parseFloat(i, 10) : /[^A-Za-z]/.test(i) || (i = 1.2);
                var n = e.fontSize;
                n && !/px$/.test(n) && (n = /pt$/.test(n) ? 4 * parseFloat(n, 10) / 3 + "px" : /em$/.test(n) ? 16 * parseFloat(n, 10) + "px" : /cm$/.test(n) ? 96 * parseFloat(n, 10) / 2.54 + "px" : "16px"),
                t = parseFloat(n, 10) * i
            } else
                t = 18;
            return t
        ...
        _setBodyHeight: function() {
            if (!this.bStopCheckingBodyHeight) {
                var e, t, i = this.getDocument().body, n = jindo.$Element(i), o = parseInt(n.css("marginTop"), 10) + parseInt(n.css("marginBottom"), 10), s = this.oApp.getEditingAreaHeight(), r = s - o, a = n.height();
                if (this.nTopBottomMargin = o,
                0 === a)
                    return n.css("height", r + "px"),
                    void setTimeout(this.fnSetBodyHeight, 500);
                var l = jindo.$Agent().navigator()
                  , h = l.ie && 11 === l.nativeVersion
                  , d = this.nBodyHeight_last === a;
                h && d || n.css("height", "0px"),
                t = s < (e = parseInt(i.scrollHeight, 10)) ? e - o : r,
                this._isHorizontalScrollbarVisible() && (t -= this.nScrollbarWidth),
                h && d || n.css("height", t + "px"),
                this.nBodyHeight_last = t,
        ...
        $ON_START_CHECKING_BODY_HEIGHT: function() {
            this.bStopCheckingBodyHeight && (this.bStopCheckingBodyHeight = !1,
            this.fnSetBodyHeight())
        },
        ...
        _onIEBeforeDeactivate: function() {
            ...
            this._oIERange || this._bIERangeReset || (this._oIERange = this.oApp.getSelection().cloneRange())
        },
        $ON_CHANGE_EDITING_MODE: function(e) {
            if (e === this.sMode) {
                ...
                "block" != this.iframe.style.display && (this.iframe.style.display = "block"),
        ...
        $ON_EVENT_EDITING_AREA_KEYDOWN: function(e) {
            if (this.oApp.getEditingMode() === this.sMode) {
                ...
                if (this.oApp.oNavigator.ie)
                    ...
                    this.oApp.oNavigator.firefox && 8 === t.keyCode && this._backspace(e);
                this._recordUndo(t)
            }
        },
        ...
        _delete: function(e) {
            ...
            if (t)
                if (this._removeUnremovable(t, !1))
                    e.stop();
                    ...
                    this._removeWrongSpan(t)
        },
        _prepareBackspaceDelete: function(e) {
            var t = this.oApp.getSelection();
            if (t.collapsed) {
                var i = t.getNodeAroundRange(e, !1);
                return this._isLineFeed(i) && (i = e ? t._getPrevNode(i) : t._getNextNode(i)),
                this._clearCursorHolderValue(i),
                i
            }
        },
        ...
        _removeUnremovable: function(e, t) {
            ...
            if ("TABLE" === e.nodeName)
                ...
                n ? "TABLE" === n.nodeName ? (e.removeChild(n),
                i = !0) : 1 === n.nodeType && "" == jindo.$S(n.innerHTML).trim() && (e.removeChild(n),
                i = !0) : (e.parentNode.removeChild(e),
                i = !0)
            }
            return i
        },
        ...
        $ON_PASTE_HTML: function(e, t, i) {
            var n, o, s, r, a, l, h;
            if (i = i || {},
            this.oApp.getEditingMode() === this.sMode) {
                if (this.focus(),
                i.bNoUndo || this.oApp.exec("RECORD_UNDO_BEFORE_ACTION", ["PASTE HTML"]),
                o = jindo.$Agent().navigator(),
                (n = t || this.oApp.getSelection()).pasteHTML(e, i.bBlock),
                o.ie ? (n.collapseToEnd(),
                n.select(),
                this._oIERange = null,
                this._bIERangeReset = !1) : (s = n.placeStringBookmark(),
                this.oApp.getWYSIWYGDocument().body.innerHTML = this.oApp.getWYSIWYGDocument().body.innerHTML,
                n.moveToBookmark(s),
                n.collapseToEnd(),
                n.select(),
                n.removeStringBookmark(s),
                n = this.oApp.getSelection(),
                t && t.setRange(n)),
                -1 < e.indexOf("<img") && 1 === (r = n.startContainer).nodeType && "P" === r.tagName && 0 < (a = jindo.$Element(r).child(function(e) {
                    return 1 === e.$value().nodeType && "IMG" === e.$value().tagName
                }, 1)).length)
                    for (l = a[a.length - 1].$value().nextSibling; l; )
                        h = l.nextSibling,
                        3 !== l.nodeType || "&nbsp;" !== l.nodeValue && l.nodeValue !== unescape("%u00A0") || r.removeChild(l),
                        l = h;
        ...
        $ON_FOCUS_N_CURSOR: function(e, t) {
            var i, n;
            if (t && (i = jindo.$(t, this.getDocument())))
                return clearTimeout(this._nTimerFocus),
                void (this._nTimerFocus = setTimeout(jindo.$Fn(function(e) {
                    this._scrollIntoView(e),
                    this.oApp.exec("FOCUS")
                }, this).bind(i), 300));
            (n = this.oApp.getSelection()).collapsed ? e ? (this.oApp.exec("FOCUS"),
            i = this.getDocument().body,
            n.selectNode(i),
            n.collapseToEnd(),
            n.select(),
            this._scrollIntoView(i)) : this.oApp.exec("FOCUS") : (e ? n.collapseToEnd() : n.collapseToStart(),
            n.select())
        },
        _getElementVerticalPosition: function(e) {
            ...
            return n.nTop = t,
            n.nBottom = t + jindo.$Element(e).height(),
            n
        },
        _getVisibleVerticalPosition: function() {
            ...
            t = this.getDocument(),
            i = e.innerHeight ? e.innerHeight : t.documentElement.clientHeight || t.body.clientHeight,
            n.nTop = e.pageYOffset || t.documentElement.scrollTop,
            n.nBottom = n.nTop + i,
            n
        },
        ...
        $BEFORE_MSG_EDITING_AREA_RESIZE_STARTED: function() {
            if (!jindo.$Agent().navigator().ie) {
                ...
                this.sBM = e.placeStringBookmark()
            }
        },
        $AFTER_MSG_EDITING_AREA_RESIZE_ENDED: function() {
            if (this.oApp.getEditingMode() === this.sMode && !jindo.$Agent().navigator().ie) {
                ...
                e.moveToBookmark(this.sBM),
                e.select(),
                e.removeStringBookmark(this.sBM)
            }
        },
        ...
        _pageUp: function(e) {
            ...
            t = n.top <= i ? 0 : n.top - i,
            this.oApp.getWYSIWYGWindow().scrollTo(0, t),
            e.stop()
        },
        _pageDown: function(e) {
            var t, i = this._getEditorHeight(), n = jindo.$Document(this.oApp.getWYSIWYGDocument()).scrollPosition(), o = this._getBodyHeight();
            t = n.top + i >= o ? o - i : n.top + i,
            this.oApp.getWYSIWYGWindow().scrollTo(0, t),
            e.stop()
        },
        ...
        initIframe: function() {
            try {
                if (!this.iframe.contentWindow.document || !this.iframe.contentWindow.document.body || "about:blank" === this.iframe.contentWindow.document.location.href)
                ...
                if (nhn.husky.SE2M_Configuration.SE_EditingAreaManager.sCSSBaseURI && (e = nhn.husky.SE2M_Configuration.SE_EditingAreaManager.sCSSBaseURI),
                e) {
                    var t = e
                      , i = this.oApp && this.oApp.htOptions.I18N_LOCALE;
                    i && (t += "/" + i),
                    t += "/smart_editor2_in.css";
                    ...
                    s.rel = "stylesheet",
                    s.href = t,
                    s.onload = jindo.$Fn(function() {
                        this.oApp && this.oApp.getEditingMode && this.oApp.getEditingMode() === this.sMode && this.oApp.exec("RESET_STYLE_STATUS"),
                        s.onload = null
                    }, this).bind(),
                    o.appendChild(s)
                }
        ...
        setIR: function(e) {
            ...
            if ("" === (t = this.oApp.applyConverter ? this.oApp.applyConverter("IR_TO_" + this.sMode, e, this.oApp.getWYSIWYGDocument()) : e).replace(/[\r\n\t\s]*/, "") && ("BR" !== this.oApp.sLineBreaker && (n = "<p>" + n + "</p>"),
            t = n),
            this.iframe.contentWindow.document.body.innerHTML = t,
            i && this.oApp.getEditingMode() === this.sMode)
                for (var o = this.oApp.getWYSIWYGDocument().body.getElementsByTagName("P"), s = 0, r = o.length; s < r; s++)
                    1 === o[s].childNodes.length && "&nbsp;" === o[s].innerHTML && (o[s].innerHTML = "")
        },
        getRawContents: function() {
        ...
        _recordUndo: function(e) {
            33 <= e.keyCode && e.keyCode <= 40 ? this.oApp.saveSnapShot() : e.alt || e.ctrl || 16 === e.keyCode || this.oApp.getLastKey() !== e.keyCode && (this.oApp.setLastKey(e.keyCode),
            !e.enter && 46 !== e.keyCode && 8 !== e.keyCode || this.oApp.exec("RECORD_UNDO_ACTION", ["KEYPRESS(" + e.keyCode + ")", {
                bMustBlockContainer: !0
            }]))
        },
        _enableWYSIWYG: function() {
            null !== this.iframe.contentWindow.document.body.contentEditable ? this.iframe.contentWindow.document.body.contentEditable = !0 : this.iframe.contentWindow.document.designMode = "on",
            this.bWYSIWYGEnabled = !0,
            jindo.$Agent().navigator().firefox && setTimeout(jindo.$Fn(function() {
                this.iframe.contentWindow.document.execCommand("enableInlineTableEditing", !1, !1)
            }, this).bind(), 0)
        },
        _disableWYSIWYG: function() {
            null !== this.iframe.contentWindow.document.body.contentEditable ? this.iframe.contentWindow.document.body.contentEditable = !1 : this.iframe.contentWindow.document.designMode = "off",
            this.bWYSIWYGEnabled = !1
        },
...
, function(e, t) {
    nhn.husky.SE_EditingArea_HTMLSrc = jindo.$Class({
        ...
        $ON_CHANGE_EDITING_MODE: function(e) {
            e == this.sMode ? (this.elEditingArea.style.display = "block",
            this.elEditingArea.style.position = "absolute",
            this.elEditingArea.style.top = "0px") : (this.elEditingArea.style.display = "none",
        ...
        startAutoResize: function() {
            ...
            this.bAutoResize = !0,
            this.AutoResizer = new nhn.husky.AutoResizer(this.elEditingArea,e),
        ...
        getIR: function() {
            ...
            return this.oApp.applyConverter && (e = this.oApp.applyConverter(this.sMode + "_TO_IR", e, this.oApp.getWYSIWYGDocument())),
            e
        },
        setIR: function(e) {
            ...
            var i = e;
            this.oApp.applyConverter && (i = this.oApp.applyConverter("IR_TO_" + this.sMode, i, this.oApp.getWYSIWYGDocument())),
            this.setRawContents(i)
        },
    ...
    "undefined" == typeof window.TextRange && (window.TextRange = {}),
    TextRange = function(e, t) {
        this._o = e,
        this._oDoc = t || document
    }
    ,
    TextRange.prototype.getSelection = function() {
        ...
        if (isNaN(this._o.selectionStart)) {
            ...
            var i = this._oDoc.body.createTextRange()
              , n = null;
            n = this._oDoc.selection.createRange().duplicate(),
...
, function(e, t) {
    nhn.husky.SE_EditingArea_TEXT = jindo.$Class({
        ...
        irToText: function(e) {
            ...
            return null !== n && (i = i.replace(new RegExp(this.sRxConverter), "")),
            -1 < (t = (i = (i = (i = (i = (i = (i = (i = (i = (i = (i = i.replace(/\r/g, "")).replace(/[\n|\t]/g, "")).replace(/[\v|\f]/g, "")).replace(/<p><br><\/p>/gi, "\n")).replace(/<P>&nbsp;<\/P>/gi, "\n")).replace(/<br(\s)*\/?>/gi, "\n")).replace(/<br(\s[^/]*)?>/gi, "\n")).replace(/<\/p(\s[^/]*)?>/gi, "\n")).replace(/<\/li(\s[^/]*)?>/gi, "\n")).replace(/<\/tr(\s[^/]*)?>/gi, "\n")).lastIndexOf("\n")) && "\n" == i.substring(t) && (i = i.substring(0, t)),
            i = jindo.$S(i).stripTags().toString(),
            i = this.unhtmlSpecialChars(i),
            null !== n && (i = n[0] + i),
            i
        },
        textToIr: function(e) {
            if (e) {
                var t, i = e;
                return null !== (t = i.match(new RegExp(this.sRxConverter))) && (i = i.replace(t[0], "")),
                i = this.htmlSpecialChars(i),
                i = this._addLineBreaker(i),
                null !== t && (i = t[0] + i),
                i
            }
        },
        _addLineBreaker: function(e) {
            if ("BR" === this.oApp.sLineBreaker)
                return e.replace(/\r?\n/g, "<BR>");
            for (var t = new StringBuffer, i = e.split("\n"), n = i.length, o = "", s = 0; s < n && (o = jindo.$S(i[s]).trim().$value(),
            s !== n - 1 || "" !== o); s++)
                null !== o && "" !== o ? (t.append("<P>"),
                t.append(i[s]),
                t.append("</P>")) : jindo.$Agent().navigator().ie ? t.append("<P>&nbsp;</P>") : t.append("<P><BR></P>");
            return t.toString()
        },
        startAutoResize: function() {
            var e = {
        ...
        setIR: function(e) {
            var t = e;
            this.oApp.applyConverter && (t = this.oApp.applyConverter("IR_TO_" + this.sMode, t, this.oApp.getWYSIWYGDocument())),
            this.setRawContents(t)
        },
        setRawContents: function(e) {
            void 0 !== e && (this.elEditingArea.value = e)
        },
...
, function(e, t) {
    nhn.husky.SE_EditingAreaVerticalResizer = jindo.$Class({
        ...
        $ON_MSG_APP_READY: function() {
            ...
            this.oResizeGrip.style.height = "0") : (this.oApp.exec("REGISTER_HOTKEY", ["shift+esc", "FOCUS_RESIZER"]),
            this.isUseVerticalResizer() ? (this.oResizeGrip.style.display = "block",
            this.welNoticeLayer && !Number(jindo.$Cookie().get(this.sCookieNotice)) && (this.welNoticeLayer.delegate("click", "BUTTON.bt_clse", jindo.$Fn(this._closeNotice, this).bind()),
        ...
        checkResizeGripPosition: function(e) {
            ...
            i <= 0 || (e && (this.nEditingAreaMinHeight > this.oApp.getEditingAreaHeight() - i && (i = -1 * (this.nEditingAreaMinHeight - this.oApp.getEditingAreaHeight())),
            this.oApp.exec("MSG_EDITING_AREA_RESIZE_STARTED"),
            this.oApp.exec("RESIZE_EDITING_AREA_BY", [0, -1 * i]),
        ...
        _assignHTMLElements: function(e) {
            this.oResizeGrip = jindo.$$.getSingle("BUTTON.husky_seditor_editingArea_verticalResizer", e),
            this.elModeToolbar = jindo.$$.getSingle("DIV.se2_conversion_mode", e),
            this.welNoticeLayer = jindo.$Element(jindo.$$.getSingle("DIV.husky_seditor_resize_notice", e)),
        ...
        _mousedown: function(e) {
            this.iStartHeight = e.pos().clientY,
            this.iStartHeightOffset = e.pos().layerY,
...
, function(e, t) {
    nhn.husky.SE_WYSIWYGEnterKey = jindo.$Class({
        ...
        $init: function(e) {
            this.sLineBreaker = "BR" == e ? "BR" : "P",
            this.htBrowser = jindo.$Agent().navigator(),
            this.htBrowser.opera && "P" == this.sLineBreaker && (this.$ON_MSG_APP_READY = function() {}
            ),
        ...
        _addBlankText: function(e) {
            ...
            for (t = 0,
            i = r.length; t < i; t++)
                1 === (n = r[t]).nodeType && "SPAN" === n.tagName && (-1 < n.id.indexOf(e.HUSKY_BOOMARK_START_ID_PREFIX) || -1 < n.id.indexOf(e.HUSKY_BOOMARK_END_ID_PREFIX) || (!(o = n.firstChild) || 3 == o.nodeType && nhn.husky.SE2M_Utils.isBlankTextNode(o) || 1 == o.nodeType && 1 == n.childNodes.length && (-1 < o.id.indexOf(e.HUSKY_BOOMARK_START_ID_PREFIX) || -1 < o.id.indexOf(e.HUSKY_BOOMARK_END_ID_PREFIX))) && (s = e._document.createTextNode(unescape("%uFEFF")),
                n.appendChild(s)))
        },
        _addCursorHolder: function(e) {
            var t = e;
            return "" != e.innerHTML && !(t = this._getStyleOnlyNode(e)) || (t.innerHTML = "<br>"),
            t = t || this._getStyleNode(e)
        },
        _addCursorHolderSpace: function(e) {
            var t;
            if (this._addSpace(e),
            "" == (t = this._getStyleNode(e)).innerHTML && "param" != t.nodeName.toLowerCase())
                try {
        ...
        _convertHeadSpace: function(e) {
            if (e && 3 === e.nodeType) {
                for (var t, i = e.nodeValue, n = "", o = 0; (t = i[o]) && " " === t; o++)
                    n += " ";
        ...
        _wrapBlock: function(e) {
            var t, i, n, o = this.oApp.getSelection(), s = o.placeStringBookmark(), r = o.getLineInfo(), a = r.oStart, l = r.oEnd;
            if ((!a.bParentBreak || o.rxBlockContainer.test(a.oLineBreaker.tagName)) && (e.stop(),
            o.deleteContents(),
            a.oNode.parentNode && 11 !== a.oNode.parentNode.nodeType)) {
                t = this.oApp.getWYSIWYGDocument().createElement(this.sLineBreaker),
                o.moveToBookmark(s),
                o.setStartBefore(a.oNode),
                o.surroundContents(t),
                o.collapseToEnd(),
                i = this.oApp.getWYSIWYGDocument().createElement(this.sLineBreaker);
                var h = this._getBlockEndNode(a.oNode, l.oNode);
                return h === a.oNode && (h = l.oNode),
                o.setEndAfter(h),
                this._addBlankText(o),
                o.surroundContents(i),
                o.moveToStringBookmark(s, !0),
                o.collapseToEnd(),
                o.removeStringBookmark(s),
                o.select(),
                this._addCursorHolder(t),
                null !== i.lastChild && "BR" == i.lastChild.tagName && i.removeChild(i.lastChild),
                n = this._addCursorHolder(i),
                i.nextSibling && "BR" == i.nextSibling.tagName && i.parentNode.removeChild(i.nextSibling),
                o.selectNodeContents(n),
                o.collapseToStart(),
                o.select(),
                this.oApp.exec("CHECK_STYLE_CHANGE"),
                s = o.placeStringBookmark(),
                void setTimeout(jindo.$Fn(function(e) {
                    o.getStringBookmark(e) && (o.moveToStringBookmark(e),
                    o.select(),
                    o.removeStringBookmark(e))
                }, this).bind(s), 0)
            }
            var d = o.getStringBookmark(s, !0);
            if (this.htBrowser.firefox)
                d && d.nextSibling && "IFRAME" == d.nextSibling.tagName ? setTimeout(jindo.$Fn(function(e) {
                    o.getStringBookmark(e) && (o.moveToStringBookmark(e),
                    o.select(),
                    o.removeStringBookmark(e))
                }, this).bind(s), 0) : (setTimeout(jindo.$Fn(function(e) {
                    this._convertHeadSpace(e)
                }, this).bind(d.nextSibling), 0),
                o.removeStringBookmark(s));
            else if (this.htBrowser.ie) {
                var c, _, p = d.parentNode;
                if (this._firstBR2Line(p, o, l.oLineBreaker),
                !d || !p)
                    return void o.removeStringBookmark(s);
                if (setTimeout(jindo.$Fn(function() {
                    this.oApp.getSelection().removeStringBookmark(s)
                }, this).bind(s), 0),
                c = "U" === p.tagName || null !== nhn.husky.SE2M_Utils.findAncestorByTagName("U", p),
                _ = "S" === p.tagName || "STRIKE" === p.tagName || null !== nhn.husky.SE2M_Utils.findAncestorByTagName("S", p) && null !== nhn.husky.SE2M_Utils.findAncestorByTagName("STRIKE", p),
                c || _)
                    return void setTimeout(jindo.$Fn(this._addTextDecorationTag, this).bind(c, _), 0);
                ...
                if ("SPAN" == p.tagName && E && "BR" == E.nodeName && E.nextSibling) {
                    o.deleteContents(),
                    o.setEndNodes(d, l.oLineBreaker);
                    var u = o.extractContents()
                      , g = u.firstChild;
                    p = a.oLineBreaker.parentNode,
                    (E = a.oLineBreaker.nextSibling) ? p.insertBefore(u, E) : p.appendChild(u),
                    ...
                    this._convertHeadSpace(d.nextSibling),
                    o.removeStringBookmark(s)
            }
        },
        _firstBR2Line: function(e, t, i) {
            for (; e.firstChild && "BR" === e.firstChild.nodeName; ) {
                ...
                t.setStartBefore(i),
                t.setEndAfter(n),
                i.parentNode.insertBefore(t.extractContents(), i)
            }
        },
        _addExtraCursorHolder: function(e) {
            ...
            if ((e = this._getStyleOnlyNode(e)) && "SPAN" === e.tagName) {
                for (t = e.lastChild; t; )
                    i = t.previousSibling,
                    t = (3 === t.nodeType && nhn.husky.SE2M_Utils.isBlankTextNode(t) && t.parentNode.removeChild(t),
                    i);
                "" === e.innerHTML.replace("​", "").replace("\ufeff", "") && (e.innerHTML = "​")
            }
            var n, o = this.oApp.getSelection();
            o.collapsed && (o.fixCommonAncestorContainer(),
            (n = o.commonAncestorContainer) && (3 === (n = o._getVeryFirstRealChild(n)).nodeType && (n = n.parentNode),
            n && "SPAN" === n.tagName && ("" === n.innerHTML.replace("​", "").replace("\ufeff", "") && (n.innerHTML = "​"),
            o.selectNodeContents(n),
            o.collapseToStart(),
            o.select())))
        },
        _addSpace: function(e) {
            ...
            if (e) {
                ...
                if (0 < (s = jindo.$Element(e).child(function(e) {
                    ...
                    for (i = s[s.length - 1].$value().nextSibling; i; )
                        n = i.nextSibling,
                        3 !== i.nodeType || "&nbsp;" !== i.nodeValue && i.nodeValue !== unescape("%u00A0") && "​" !== i.nodeValue || e.removeChild(i),
                        i = n;
                    return e
                }
                for (n = i = e.firstChild,
                o = !1; i; )
                    n = i.nextSibling,
                    3 === i.nodeType && (i.nodeValue === unescape("%uFEFF") && e.removeChild(i),
                    o || "&nbsp;" !== i.nodeValue && i.nodeValue !== unescape("%u00A0") && "​" !== i.nodeValue || (o = !0)),
                    i = n;
                return o || (t = this.tmpTextNode.cloneNode(),
                e.appendChild(t)),
                e
            }
        },
        _addTextDecorationTag: function(e, t) {
            ...
            if (o.collapsed) {
                ...
                i && "U" !== i.tagName && "S" !== i.tagName && "STRIKE" !== i.tagName && (e && (n = o._document.createElement("U"),
                i.appendChild(n),
                i = n),
                t && (n = o._document.createElement("STRIKE"),
                i.appendChild(n)),
                n.innerHTML = "​",
                o.selectNodeContents(n),
                o.collapseToEnd(),
        ...
        _getStyleNode: function(e) {
            for (; e.firstChild && this.oSelection._isBlankTextNode(e.firstChild); )
        ...
        _getStyleOnlyNode: function(e) {
            ...
            if (!e.insertBefore)
                return null;
            if ("IMG" == e.tagName || "BR" == e.tagName || "HR" == e.tagName || "IFRAME" == e.tagName)
                return null;
            for (; e.firstChild && this.oSelection._isBlankTextNode(e.firstChild); )
                e.removeChild(e.firstChild);
        ...
        _insertBR: function(e) {
            ...
            !this.htBrowser.ie) {
                ...
                if (n.bParentBreak) {
                    for (; n.oNode && 3 == n.oNode.nodeType && "" == n.oNode.nodeValue; )
                        n.oNode = n.oNode.previousSibling;
                    var o = 1;
                    n.oNode != i && n.oNode.nextSibling != i || (o = 0),
                    0 === o && (t.pasteHTML("<br type='_moz'/>"),
                    t.collapseToEnd())
                }
            }
            t.insertNode(this.oApp.getWYSIWYGDocument().createTextNode("")),
            t.select()
        }
    })
}
, function(e, t) {
    nhn.husky.SE2M_EditingModeChanger = jindo.$Class({
        ...
        _assignHTMLElements: function(e) {
            e = jindo.$(e) || document,
            this.elWYSIWYGButton = jindo.$$.getSingle("BUTTON.se2_to_editor", e),
            this.elHTMLSrcButton = jindo.$$.getSingle("BUTTON.se2_to_html", e),
            this.elTEXTButton = jindo.$$.getSingle("BUTTON.se2_to_text", e),
            this.elModeToolbar = jindo.$$.getSingle("DIV.se2_conversion_mode", e),
        ...
        $ON_MSG_APP_READY: function() {
            this.oApp.htOptions.bOnlyTextMode ? (this.elWYSIWYGButton.style.display = "none",
            this.elHTMLSrcButton.style.display = "none",
            this.elTEXTButton.style.display = "block",
            this.oApp.exec("CHANGE_EDITING_MODE", ["TEXT"])) : (this.oApp.registerBrowserEvent(this.elWYSIWYGButton, "click", "EVENT_CHANGE_EDITING_MODE_CLICKED", ["WYSIWYG"]),
            ...
            !1 === this.isUseModeChanger() && !1 === this.oApp.isUseVerticalResizer() && (this.elModeToolbar.style.display = "none"))
        },
        showModeChanger: function() {
            this.isUseModeChanger() ? (this.elWYSIWYGButton.style.display = "block",
            this.elHTMLSrcButton.style.display = "block",
            this.elTEXTButton.style.display = "block") : (this.elWYSIWYGButton.style.display = "none",
            this.elHTMLSrcButton.style.display = "none",
        ...
        $ON_EVENT_CHANGE_EDITING_MODE_CLICKED: function(e, t) {
            if ("TEXT" == e) {
                if (0 < this.oApp.getIR().length && !t && !confirm(this.oApp.$MSG("SE2M_EditingModeChanger.confirmTextMode")))
                    return !1;
        ...
        $ON_DISABLE_ALL_UI: function(e) {
            e = e || {},
            jindo.$A(e.aExceptions || []).has("mode_switcher") || ("WYSIWYG" == this.oApp.getEditingMode() ? (this.welWYSIWYGButtonLi.removeClass("active"),
            this.elHTMLSrcButton.disabled = !0,
            this.elTEXTButton.disabled = !0) : "TEXT" == this.oApp.getEditingMode() ? (this.welTEXTButtonLi.removeClass("active"),
            this.elWYSIWYGButton.disabled = !0,
            this.elHTMLSrcButton.disabled = !0) : (this.welHTMLSrcButtonLi.removeClass("active"),
            this.elWYSIWYGButton.disabled = !0,
            this.elTEXTButton.disabled = !0))
        },
        $ON_ENABLE_ALL_UI: function() {
            "WYSIWYG" == this.oApp.getEditingMode() ? (this.welWYSIWYGButtonLi.addClass("active"),
            this.elHTMLSrcButton.disabled = !1,
            this.elTEXTButton.disabled = !1) : "TEXT" == this.oApp.getEditingMode() ? (this.welTEXTButtonLi.addClass("active"),
            this.elWYSIWYGButton.disabled = !1,
            this.elHTMLSrcButton.disabled = !1) : (this.welHTMLSrcButtonLi.addClass("active"),
            this.elWYSIWYGButton.disabled = !1,
            this.elTEXTButton.disabled = !1)
        },
        $ON_CHANGE_EDITING_MODE: function(e) {
            "HTMLSrc" == e ? (this.welWYSIWYGButtonLi.removeClass("active"),
            ...
            }])) : "TEXT" == e ? (this.welWYSIWYGButtonLi.removeClass("active"),
    ...
    nhn.husky.SE_PasteHandler = jindo.$Class({
        ...
        _getCSSStyleRule: function(e) {
            for (var t, i = {}, n = 0; t = e[n]; n++)
                t.type === CSSRule.STYLE_RULE && (i[t.selectorText] = t.style);
            return i
        },
        _extractStyle: function(e) {
            if (e) {
                ...
                o.innerHTML = t,
                n.appendChild(o),
                this._htStyleRule = this._getCSSStyleRule(o.sheet.cssRules),
        ...
        _applyInlineStyle: function(e, t, i) {
            for (var n, o = 0, s = t.length; o < s; o++)
                n = t[o],
                !i && e.style[n] || (e.style[n] = t[n])
        },
        _applyStyleRuleToInline: function(e, t, i) {
            var n = e.match(this._rxClassSelector) || [];
            if (!(n.length < 1))
                for (var o, s = n.join(" ").replace(this._rxClassSelectorStart, ""), r = jindo.$$(e, i), a = 0; o = r[a]; a++)
                    this._applyInlineStyle(o, t),
                    s && jindo.$Element(o).removeClass(s)
        },
        _applyStyle: function(e) {
            var t = this._htStyleRule || {};
            for (var i in t)
                this._applyStyleRuleToInline(i, t[i], e);
            this._htStyleRule = null
        },
        _revertFontAfterPaste: function(e) {
            nhn.husky.SE2M_Utils.removeInvalidFont(e),
            document.documentMode < 11 ? nhn.husky.SE2M_Utils.stripTags(e, "FONT") : nhn.husky.SE2M_Utils.convertFontToSpan(e)
        },
        _removeLineHeightInSpan: function(e) {
            for (var t, i = jindo.$$('span[style*="line-height:"]', e), n = 0; t = i[n]; n++)
                t.style.lineHeight = null
        },
        $ON_EVENT_EDITING_AREA_PASTE: function(e) {
        ...
        $ON_EVENT_EDITING_AREA_PASTE_DELAY: function() {
            ...
            this._revertFontAfterPaste(e),
            this._applyStyle(e),
            this._removeLineHeightInSpan(e)
        }
    })
}
, function(e, t) {
    nhn.husky.SE2M_ExecCommand = jindo.$Class({
        ...
        $ON_MSG_APP_READY: function() {
            jindo.$Agent().os().mac ? (this.oApp.exec("REGISTER_HOTKEY", ["meta+b", "EXECCOMMAND", ["bold", !1, !1]]),
            this.oApp.exec("REGISTER_HOTKEY", ["meta+u", "EXECCOMMAND", ["underline", !1, !1]]),
            this.oApp.exec("REGISTER_HOTKEY", ["meta+i", "EXECCOMMAND", ["italic", !1, !1]]),
            ...
            this.oApp.exec("REGISTER_HOTKEY", ["ctrl+u", "EXECCOMMAND", ["underline", !1, !1]]),
            this.oApp.exec("REGISTER_HOTKEY", ["ctrl+i", "EXECCOMMAND", ["italic", !1, !1]]),
            this.oApp.exec("REGISTER_HOTKEY", ["ctrl+d", "EXECCOMMAND", ["strikethrough", !1, !1]])),
            this.oApp.exec("REGISTER_HOTKEY", ["tab", "INDENT"]),
            this.oApp.exec("REGISTER_HOTKEY", ["shift+tab", "OUTDENT"]),
            this.oApp.exec("REGISTER_UI_EVENT", ["bold", "click", "EXECCOMMAND", ["bold", !1, !1]]),
            this.oApp.exec("REGISTER_UI_EVENT", ["underline", "click", "EXECCOMMAND", ["underline", !1, !1]]),
            this.oApp.exec("REGISTER_UI_EVENT", ["italic", "click", "EXECCOMMAND", ["italic", !1, !1]]),
            this.oApp.exec("REGISTER_UI_EVENT", ["lineThrough", "click", "EXECCOMMAND", ["strikethrough", !1, !1]]),
            this.oApp.exec("REGISTER_UI_EVENT", ["superscript", "click", "EXECCOMMAND", ["superscript", !1, !1]]),
            this.oApp.exec("REGISTER_UI_EVENT", ["subscript", "click", "EXECCOMMAND", ["subscript", !1, !1]]),
            this.oApp.exec("REGISTER_UI_EVENT", ["justifyleft", "click", "EXECCOMMAND", ["justifyleft", !1, !1]]),
            this.oApp.exec("REGISTER_UI_EVENT", ["justifycenter", "click", "EXECCOMMAND", ["justifycenter", !1, !1]]),
            this.oApp.exec("REGISTER_UI_EVENT", ["justifyright", "click", "EXECCOMMAND", ["justifyright", !1, !1]]),
            this.oApp.exec("REGISTER_UI_EVENT", ["justifyfull", "click", "EXECCOMMAND", ["justifyfull", !1, !1]]),
            this.oApp.exec("REGISTER_UI_EVENT", ["orderedlist", "click", "EXECCOMMAND", ["insertorderedlist", !1, !1]]),
            this.oApp.exec("REGISTER_UI_EVENT", ["unorderedlist", "click", "EXECCOMMAND", ["insertunorderedlist", !1, !1]]),
            this.oApp.exec("REGISTER_UI_EVENT", ["outdent", "click", "EXECCOMMAND", ["outdent", !1, !1]]),
            this.oApp.exec("REGISTER_UI_EVENT", ["indent", "click", "EXECCOMMAND", ["indent", !1, !1]]),
            this.oNavigator = jindo.$Agent().navigator(),
            this.oNavigator.safari || this.oNavigator.chrome || (this._getDocumentBR = function() {}
            ,
        ...
        $BEFORE_EXECCOMMAND: function(e, t, i, n) {
            this.oApp.exec("FOCUS"),
            this._bOnlyCursorChanged = !1;
            for (var o, s = 0, r = this.oApp.getSelection().getNodes(); o = r[s]; s++)
                nhn.husky.SE2M_Utils.removeInvalidNodeInTable(o);
            /^insertorderedlist|insertunorderedlist$/i.test(e) && (this._getDocumentBR(),
            this._checkBlockQuoteCondition_IE()),
            /^justify*/i.test(e) && this._removeElementAlign("span"),
            this._rxCmdInline.test(e) && (this.oUndoOption = {
                bMustBlockElement: !0
            },
            nhn.CurrentSelection.isCollapsed() && (this._bOnlyCursorChanged = !0)),
            "indent" != e && "outdent" != e || ((n = n || {}).bDontAddUndoHistory = !0),
            n && n.bDontAddUndoHistory || this._bOnlyCursorChanged || (/^justify*/i.test(e) ? this.oUndoOption = {
                sSaveTarget: "BODY"
            } : "insertorderedlist" !== e && "insertunorderedlist" !== e || (this.oUndoOption = {
                bMustBlockContainer: !0
            }),
            this.oApp.exec("RECORD_UNDO_BEFORE_ACTION", [e, this.oUndoOption])),
            this.oNavigator.ie && this.oApp.getWYSIWYGDocument().selection && "Control" === this.oApp.getWYSIWYGDocument().selection.type && this.oApp.getSelection().select(),
            "insertorderedlist" != e && "insertunorderedlist" != e || this._insertBlankLine()
        },
        ...
        _insertDummyParagraph_IE: function(e) {
            ...
            e.appendChild(this._elDummyParagraph)
        },
        ...
        $ON_EXECCOMMAND: function(e, t, i) {
            ...
            if (t = !("" != t && !t) && t,
            i = !("" != i && !i) && i,
            this.oApp.exec("IS_SELECTED_TD_BLOCK", ["bIsSelectedTd", n]),
            n.bIsSelectedTd)
                "indent" == e ? this.oApp.exec("SET_LINE_BLOCK_STYLE", [null, jindo.$Fn(this._indentMargin, this).bind()]) : "outdent" == e ? this.oApp.exec("SET_LINE_BLOCK_STYLE", [null, jindo.$Fn(this._outdentMargin, this).bind()]) : this._setBlockExecCommand(e, t, i);
            else
                switch (e) {
                case "indent":
                case "outdent":
                ...
                case "justifyfull":
                    ...
                    r && r.select(),
                    this.oNavigator.ie && this._removeElementAlign("table");
                    break;
                default:
                    if (o.collapsed && this._rxCmdInline.test(e)) {
                        var a = o.placeStringBookmark()
                          , l = o.getStringBookmark(a).previousSibling;
                        l && "​" === l.nodeValue || (l = this.oApp.getWYSIWYGDocument().createTextNode("​"),
                        o.insertNode(l)),
                        o.removeStringBookmark(a),
        ...
        $AFTER_EXECCOMMAND: function(e, t, i, n) {
            this.elP1 && this.elP1.parentNode && this.elP1.parentNode.removeChild(this.elP1),
            this.elP2 && this.elP2.parentNode && this.elP2.parentNode.removeChild(this.elP2),
            /^insertorderedlist|insertunorderedlist$/i.test(e) && (this._removeDummyParagraph_IE(),
            this._fixCorruptedBlockQuote("insertorderedlist" === e ? "OL" : "UL"),
            this.oNavigator.bGalaxyBrowser && this._removeBlockQuote()),
            /^justify*/i.test(e) && this._fixAlign("justifyfull" === e ? "justify" : e.substring(7)),
            "indent" != e && "outdent" != e || ((n = n || {}).bDontAddUndoHistory = !0),
            n && n.bDontAddUndoHistory || this._bOnlyCursorChanged || this.oApp.exec("RECORD_UNDO_AFTER_ACTION", [e, this.oUndoOption]),
            this.oApp.exec("CHECK_STYLE_CHANGE", [])
        },
        _removeElementAlign: function(e) {
            for (var t = this.oApp.getSelection().getNodes(), i = null, n = new RegExp("^" + e + "$","i"), o = 0, s = t.length; o < s; o++)
                (i = t[o]).tagName && n.test(i.tagName) && (i.style.textAlign = "",
                i.removeAttribute("align"))
        },
        _getAlignNode: function(e) {
            if (e.tagName && ("P" === e.tagName || "DIV" === e.tagName))
                return e;
        ...
        _fixAlign: function(e) {
            ...
            for (var s = 0, r = i.length; s < r; s++)
                3 === (n = i[s]).nodeType && (n = n.parentNode),
                o && (n === o || jindo.$Element(n).isChildOf(o)) || (o = this._getAlignNode(n)) && o.align !== o.style.textAlign && (o.style.textAlign = e,
                o.setAttribute("align", e))
        },
        _getDocumentBR: function() {
            var e, t;
            for (this.aBRs = this.oApp.getWYSIWYGDocument().getElementsByTagName("BR"),
            this.aBeforeBRs = [],
            e = 0,
            t = this.aBRs.length; e < t; e++)
                this.aBeforeBRs[e] = this.aBRs[e]
        },
        _fixDocumentBR: function() {
            if (this.aBeforeBRs.length !== this.aBRs.length) {
                var e, t = jindo.$A(this.aBeforeBRs);
                for (e = this.aBRs.length - 1; 0 <= e; e--)
                    t.indexOf(this.aBRs[e]) < 0 && this.aBRs[e].parentNode.removeChild(this.aBRs[e])
            }
        },
        _setBlockExecCommand: function(e, t, i) {
            var n, o, s = {};
            this.oSelection = this.oApp.getSelection(),
            this.oApp.exec("GET_SELECTED_TD_BLOCK", ["aTdCells", s]),
            n = s.aTdCells;
            for (var r = 0; r < n.length; r++) {
                this.oSelection.selectNodeContents(n[r]),
                this.oSelection.select(),
                this.oNavigator.firefox && this.oEditingArea.execCommand("styleWithCSS", t, !1),
                o = this.oSelection.getNodes();
                for (var a = 0; a < o.length; a++)
                    "UL" != o[a].tagName && "OL" != o[a].tagName || jindo.$Element(o[a]).css("color", i);
                this.oEditingArea.execCommand(e, t, i)
            }
        },
            ...
            if ("LI" === e.tagName) {
                if (e.previousSibling && e.previousSibling.tagName && e.previousSibling.tagName === e.parentNode.tagName) {
                    if (e.nextSibling && e.nextSibling.tagName && e.nextSibling.tagName === e.parentNode.tagName) {
                        for (t = [e],
                        i = 0,
                        n = e.nextSibling.childNodes.length; i < n; i++)
                            t.push(e.nextSibling.childNodes[i]);
                        for (o = e.previousSibling,
                        s = e.nextSibling,
                        i = 0,
                        n = t.length; i < n; i++)
                            o.insertBefore(t[i], null);
                        s.parentNode.removeChild(s)
                    } else
                        e.previousSibling.insertBefore(e, null);
                    return
                }
                return e.nextSibling && e.nextSibling.tagName && e.nextSibling.tagName === e.parentNode.tagName ? void e.nextSibling.insertBefore(e, e.nextSibling.firstChild) : (a = e.parentNode.cloneNode(!1),
                e.parentNode.insertBefore(a, e),
                void a.appendChild(e))
            }
            r = (r = parseInt(e.style.marginLeft, 10)) || 0,
            r += this.nIndentSpacing,
        ...
        _outdentMargin: function(e) {
            ...
            if ("LI" !== e.tagName)
                s = (s = parseInt(e.style.marginLeft, 10)) || 0,
                (s -= this.nIndentSpacing) < 0 && (s = 0),
                e.style.marginLeft = s + "px";
            else {
                if (t = e.parentNode,
                i = e.parentNode,
                e.previousSibling && e.previousSibling.tagName && e.previousSibling.tagName.match(/LI|UL|OL/))
                    if (e.nextSibling && e.nextSibling.tagName && e.nextSibling.tagName.match(/LI|UL|OL/)) {
                        for (n = t.cloneNode(!1); e.nextSibling; )
                            n.insertBefore(e.nextSibling, null);
                        t.parentNode.insertBefore(n, t.nextSibling),
                        i = n
                    } else
                        i = t.nextSibling;
                if (t.parentNode.insertBefore(e, i),
                t.innerHTML.match(/LI/i) || t.parentNode.removeChild(t),
                !e.parentNode.tagName.match(/OL|UL/)) {
                    for (o = e.parentNode,
                    i = e,
                    o = this.oApp.getWYSIWYGDocument().createElement("P"),
                    i = null,
                    e.parentNode.insertBefore(o, e); e.firstChild; )
                        o.insertBefore(e.firstChild, i);
                    e.parentNode.removeChild(e)
                }
            }
        },
        _insertBlankLine: function() {
            ...
            this.elP2 = null; t; ) {
                if ("BLOCKQUOTE" == t.tagName) {
                    ...
                    t.parentNode.insertBefore(this.elP1, t),
                    this.elP2 = jindo.$("<p>&nbsp;</p>", this.oApp.getWYSIWYGDocument()),
                    t.parentNode.insertBefore(this.elP2, t.nextSibling);
                    break
                }
                t = t.parentNode
            }
            if (!this.elP1 && !this.elP2) {
                var i = (t = 1 !== (t = e.commonAncestorContainer).nodeType ? t.parentNode : t).previousSibling
                  , n = t.nextSibling;
                i && "BLOCKQUOTE" === i.tagName && (this.elP1 = jindo.$("<p>&nbsp;</p>", this.oApp.getWYSIWYGDocument()),
                i.parentNode.insertBefore(this.elP1, i.nextSibling)),
                n && "BLOCKQUOTE" === n.tagName && (this.elP1 = jindo.$("<p>&nbsp;</p>", this.oApp.getWYSIWYGDocument()),
                n.parentNode.insertBefore(this.elP1, n))
            }
        },
        _fixCorruptedBlockQuote: function(e) {
            ...
            if (t) {
                for (i = t.parentNode,
                a = this._getPosIdx(t),
                (l = this.oApp.getWYSIWYGDocument().createElement("DIV")).innerHTML = t.outerHTML.replace("<" + e, "<BLOCKQUOTE"),
                t.parentNode.insertBefore(l.firstChild, t),
                t.parentNode.removeChild(t),
                s = 0,
                r = (o = (n = i.childNodes[a]).getElementsByTagName(e)).length; s < r; s++)
                    o[s].childNodes.length < 1 && o[s].parentNode.removeChild(o[s]);
                (h = this.oApp.getEmptySelection()).selectNodeContents(n),
                h.collapseToEnd(),
                h.select()
            }
        },
        _removeBlockQuote: function() {
            for (var e, t, i, n = "Apple-style-span", o = this.oApp.getSelection(), s = o.commonAncestorContainer, r = s; s; )
                s = "LI" === s.tagName ? "display: inline !important; " === (i = s).style.cssText ? s.parentNode : null : "SPAN" === s.tagName && s.className === n ? (e = s,
                i ? null : s.parentNode) : s.parentNode;
            for (i && e && ((s = e.parentNode).replaceChild(r, e),
        ...
        _extendBlock: function() {
            ...
            t = jindo.$A(i.getNodes()).filter(function(e) {
                return 1 === e.nodeType && "IMG" === e.tagName
            }).$value(),
            !(e.length <= t.length)))
...
, function(e, t) {
    nhn.husky.SE_WYSIWYGStyler = jindo.$Class({
        ...
        $init: function() {
            ...
            e.ie && 8 < e.version && (this._sCursorHolder = "⁠",
        ...
        $ON_SET_WYSIWYG_STYLE: function(e) {
            ...
            if (t.collapsed && !n) {
                ...
                for (var l in 3 == a.nodeType && (a = a.parentNode),
                a && t._rxCursorHolder.test(a.innerHTML) && (o = t._findParentSingleSpan(a)),
                o ? "" == o.innerHTML && (o.innerHTML = this._sCursorHolder) : ((o = this.oApp.getWYSIWYGDocument().createElement("SPAN")).innerHTML = this._sCursorHolder,
                r = !0),
                e)
                    "string" == typeof (s = e[l]) && (o.style[l] = s);
                if (r)
                    if ("BODY" == t.startContainer.tagName && 0 === t.startOffset) {
                        ...
                        d && 1 == c.nodeType && "BR" == c.tagName ? (t.selectNode(h),
                        t.collapseToStart(),
                        t.insertNode(o)) : d && "IFRAME" != h.tagName && h.appendChild && "string" == typeof h.innerHTML ? h.appendChild(o) : (t.selectNode(h),
                        t.collapseToStart(),
                        t.insertNode(o))
                    } else
                        t.collapseToStart(),
                    ...
                    t = this.oApp.getEmptySelection();
                return e.color && t._checkTextDecoration(o),
                t.selectNodeContents(r ? o : a),
                t.collapseToEnd(),
                t._window.focus(),
                t._window.document.body.focus(),
                void t.select()
            }
            ...
            n) {
                var _;
                this.oApp.exec("GET_SELECTED_TD_BLOCK", ["aTdCells", i]),
                _ = i.aTdCells;
                for (var p = 0; p < _.length; p++)
                    t.selectNodeContents(_[p]),
                    t.styleRange(e),
                    t.select()
            } else {
                var E = !!e.color
                  , u = e.fontSize || e.fontFamily;
                _ = t.getNodes();
                for (var g, f = 0; g = _[f]; f++)
                    nhn.husky.SE2M_Utils.removeInvalidNodeInTable(g);
                if (t.styleRange(e, null, null, u, E),
...
, function(e, t) {
    nhn.husky.SE_WYSIWYGStyleGetter = jindo.$Class({
        ...
        $ON_EVENT_EDITING_AREA_KEYDOWN: function(e) {
            var t = e.key();
            if ((this.oApp.oNavigator.ie || this.oApp.oNavigator.firefox) && t.ctrl && 65 == t.keyCode)
                return this.oApp.exec("RESET_STYLE_STATUS"),
                void (this.bAllSelected = !0);
            if (8 == t.keyCode || 33 <= t.keyCode && t.keyCode <= 40 || 45 == t.keyCode || 46 == t.keyCode) {
                if (t.shift && 35 === t.keyCode)
                    return this.oApp.exec("RESET_STYLE_STATUS"),
                    void (this.bAllSelected = !0);
        ...
        $ON_RESET_STYLE_STATUS: function() {
            ...
            for (var t in this.oStyle.fontFamily = e.fontFamily,
            this.oStyle.fontSize = e.fontSize,
            this.oStyle.justifyleft = "@^",
            this.oStyle)
                this.oApp.exec("MSG_STYLE_CHANGED", [t, this.oStyle[t]])
        },
        ...
        _getBlankStyle: function() {
            var e = {};
            for (var t in this.oStyleMap)
                "Value" == this.oStyleMap[t].type ? e[t] = "" : e[t] = 0;
            return e
        },
        _getStyle: function() {
            var e;
            if (nhn.CurrentSelection.isCollapsed())
                e = this._getStyleOf(nhn.CurrentSelection.getCommonAncestorContainer());
            else {
                var t = this.oApp.getSelection()
            ...
            for (var n in e)
                if (this.oStyleMap[n].converter && (e[n] = this.oStyleMap[n].converter(e[n], e)),
                this.oStyle[n] != e[n]) {
                    if ("object" != typeof document.body.currentStyle && "function" == typeof getComputedStyle && "fontSize" == n && this.oStyle.fontFamily != e.fontFamily)
                        continue;
        ...
        _getStyleOf: function(e) {
            ...
            for (var o in this.oStyle)
                if ((i = this.oStyleMap[o]).type && "Value" == i.type)
                    try {
                        if (i.css) {
                            var s = n.css(i.css);
                            "fontFamily" == o && (s = s.split(/,/)[0]),
                            t[o] = s
                        } else
                            i.command && (t[o] = this.oDocument.queryCommandState(i.command))
                    } catch (r) {}
                else if (i.command)
                    try {
            ...
            return "@-" == t.justifyleft && "@-" == t.justifycenter && "@-" == t.justifyright && "@-" == t.justifyfull && (t.justifyleft = "@^"),
            t
        }
    })
}
, function(e, t) {
    nhn.husky.SE2M_FontSizeWithLayerUI = jindo.$Class({
        ...
        _assignHTMLElements: function(e) {
            this.oDropdownLayer = jindo.$$.getSingle("DIV.husky_se_fontSize_layer", e),
            this.elFontSizeLabel = jindo.$$.getSingle("SPAN.husky_se2m_current_fontSize", e),
            this.aLIFontSizes = jindo.$A(jindo.$$("LI", this.oDropdownLayer)).filter(function(e) {
        ...
        $ON_MSG_APP_READY: function() {
            ...
            for (var e = 0; e < this.aLIFontSizes.length; e++)
                this.oApp.registerBrowserEvent(this.aLIFontSizes[e], "click", "SET_FONTSIZE", [this._getFontSizeFromLI(this.aLIFontSizes[e])])
        },
        ...
        $ON_MSG_STYLE_CHANGED: function(e, t) {
            if ("fontSize" == e) {
                ...
                s ? (this.elFontSizeLabel.innerHTML = t,
                jindo.$Element(s).addClass("active")) : this.elFontSizeLabel.innerHTML = t
            }
        },
        ...
        _getMatchingLI: function(e) {
            ...
            for (var i = 0; i < this.aLIFontSizes.length; i++)
                if (t = this.aLIFontSizes[i],
                this._getFontSizeFromLI(t).toLowerCase() == e)
                    return t;
            return null
        },
        ...
        _clearFontSizeSelection: function() {
            for (var e = 0; e < this.aLIFontSizes.length; e++)
                jindo.$Element(this.aLIFontSizes[e]).removeClass("active")
        }
    })
}
, function(e, t) {
    nhn.husky.SE2M_LineStyler = jindo.$Class({
        ...
        $ON_SET_LINE_STYLE: function(e, t, i) {
            ...
            this.setLineStyle(e, t, i, n),
            this.oApp.exec("CHECK_STYLE_CHANGE", [])
        },
        $ON_SET_LINE_BLOCK_STYLE: function(e, t, i) {
            this.oSelection = this.oApp.getSelection(),
            this.setLineBlockStyle(e, t, i),
            this.oApp.exec("CHECK_STYLE_CHANGE", [])
        },
        _getSelectedTDs: function() {
            var e = {};
            return this.oApp.exec("GET_SELECTED_TD_BLOCK", ["aTdCells", e]),
            e.aTdCells || []
        },
        getLineStyle: function(e) {
            ...
            if (0 === o.length)
                return null;
            var s = o.length;
            n = 0 === s ? null : (i = this._getLineWrapper(o[0]),
            this._getWrapperLineStyle(e, i));
            ...
            return setTimeout(jindo.$Fn(function(e, t) {
                ...
                if (0 < i.length) {
                    ...
                    e = n || !e ? i[0].firstChild : e,
                    t = o || !t ? i[i.length - 1].lastChild : t
                }
                this.oSelection.setEndNodes(e, t),
                this.oSelection.select(),
                this.oApp.exec("CHECK_STYLE_CHANGE", [])
            }, this).bind(r, l), 0),
            n
        ...
        setLineStyle: function(e, t, i, n) {
            ...
            function r(e, t, i) {
                ...
                return "function" == typeof i ? i(e) : e.style[t] = i,
                0 === e.childNodes.length && (e.innerHTML = "&nbsp;"),
                e
            }
            function a(e) {
            ...
            if (0 !== n.length) {
                ...
                for (var c, _ = h = r(h = this._getLineWrapper(n[0]), e, t), p = 1; p < d; p++) {
                    try {
                        if (!a(nhn.DOMFix.parentNode(n[p])))
                            continue
                    } catch (E) {
                        continue
                    }
                ...
                c = l || _,
                !s || i && i.bDoNotSelect || setTimeout(jindo.$Fn(function(e, t, i) {
                    e == t ? (this.oSelection.selectNodeContents(e),
                    1 == e.childNodes.length && "BR" == e.firstChild.tagName && this.oSelection.collapseToStart()) : this.oSelection.setEndNodes(e, t),
                    this.oSelection.select(),
                    i && i.bDontAddUndoHistory || this.oApp.exec("RECORD_UNDO_AFTER_ACTION", ["LINE STYLE"])
                }, this).bind(_, c, i), 0)
            }
        },
        setLineBlockStyle: function(e, t, i) {
            for (var n = [], o = [], s = this._getSelectedTDs(), r = 0; r < s.length; r++) {
                this.oSelection.selectNode(s[r]),
                n = this.oSelection.getNodes();
                for (var a = 0, l = 0; a < n.length; a++)
                    (3 == n[a].nodeType || "BR" == n[a].tagName && 0 == a) && (o[l] = n[a],
                    l++);
                this.setLineStyle(e, t, i, o),
                n = o = []
            }
        },
        ...
        _getSelectedNodes: function(e) {
            if (e || (this.oSelection = this.oApp.getSelection()),
            ...
            this.oSelection.collapsed) {
                ...
                if (0 < t.length)
                    return [t[0].firstChild, t[t.length - 1].lastChild];
        ...
        _getLineWrapper: function(e) {
            ...
            n = l.oNode,
            s = l.oLineBreaker,
            this.oSelection.setEndNodes(i, n),
            o == s && ("P" == o.tagName || "DIV" == o.tagName || "LI" == o.tagName ? h = o : this.oSelection.setEndNodes(o.firstChild, o.lastChild)),
            h
        }
    })
}
    ...
    nhn.husky.SE2M_ColorPalette = jindo.$Class({
        ...
        _assignHTMLElements: function(e) {
            ...
            if (t) {
                ...
                this.bUseRecentColor = t.bUseRecentColor || !1,
                this.URL_COLOR_ADD = t.addColorURL || i + "/1/colortable/TextAdd.nhn",
                this.URL_COLOR_UPDATE = t.updateColorURL || i + "/1/colortable/TextUpdate.nhn",
                this.URL_COLOR_LIST = t.colorListURL || i + "/1/colortable/TextList.nhn"
            }
            this.elColorPaletteLayer = jindo.$$.getSingle("DIV.husky_se2m_color_palette", e),
            ...
            this.elBackgroundColor = jindo.$$.getSingle("ul.husky_se2m_bgcolor_list", e),
        ...
        $LOCAL_BEFORE_FIRST: function() {
            ...
            this.bUseRecentColor && this._ajaxRecentColor(this._ajaxRecentColorCallback),
        ...
        $ON_EVENT_MOUSEOVER_COLOR_PALETTE: function(e) {
            for (var t = e.element; t && t.tagName && "li" != t.tagName.toLowerCase(); )
                t = t.parentNode;
        ...
        $ON_EVENT_CLICK_COLOR_PALETTE: function(e) {
            for (var t = e.element; "SPAN" == t.tagName; )
                t = t.parentNode;
            if (t.tagName && "BUTTON" == t.tagName) {
                if (t == this.elMoreBtn)
                    return void this.oApp.exec("TOGGLE_COLOR_PICKER");
        ...
        $ON_APPLY_COLOR: function(e) {
            var t = this.elInputColorCode.value
              , i = null;
            if (-1 == t.indexOf("#") && (t = "#" + t,
            this.elInputColorCode.value = t),
            e == this.elOkBtn)
                return this._verifyColorCode(t) ? void this.oApp.exec("COLOR_PALETTE_APPLY_COLOR", [t, !0]) : (this.elInputColorCode.value = "",
                alert(this.oApp.$MSG("SE_Color.invalidColorCode")),
                void this.elInputColorCode.focus());
            i = jindo.$Element(e.parentNode.parentNode.parentNode),
            t = e.title,
            i.hasClass("husky_se2m_color_palette") ? this.oApp.exec("COLOR_PALETTE_APPLY_COLOR", [t, !1]) : i.hasClass("husky_se2m_color_palette_recent") && this.oApp.exec("COLOR_PALETTE_APPLY_COLOR", [t, !0])
        },
        ...
        $ON_SHOW_COLOR_PICKER: function() {
            ...
            var e = jindo.$Fn(function(e) {
                this.elPreview.style.backgroundColor = e.hexColor,
                this.elInputColorCode.value = e.hexColor
            }, this).bind();
            this.cpp.attach("colorchange", e),
        ...
        $ON_COLOR_PALETTE_APPLY_COLOR: function(e, t) {
            t = t || !1,
            e = this._getHexColorCode(e),
            this.bUseRecentColor && t && this.oApp.exec("ADD_RECENT_COLOR", [e]),
            this.oApp.exec(this.sCallbackCmd, [e])
        },
        ...
        $ON_ADD_RECENT_COLOR: function(e) {
            ...
            this._addRecentColor(e),
            t ? this._ajaxAddColor() : this._ajaxUpdateColor(),
        ...
        _addRecentColor: function(e) {
            ...
            (t = t.refuse(e)).unshift(e),
            t.length() > this.nLimitRecentColor && t.length(this.nLimitRecentColor),
            this.aRecentColor = t.$value()
        },
        _redrawRecentColorElement: function() {
            var e, t = [], i = this.aRecentColor.length;
            if (0 !== i) {
                for (e = 0; e < i; e++)
                    t.push(this.sRecentColorTemp.replace(/\{RGB_CODE\}/gi, this.aRecentColor[e]));
                this.elRecentColor.innerHTML = t.join(""),
        ...
        _ajaxRecentColorCallback: function(e) {
            ...
            if (o && !o.error) {
                for ((t = jindo.$A(o).filter(this._verifyColorCode, this)).length() > this.nLimitRecentColor && t.length(this.nLimitRecentColor),
                i = 0,
                n = (o = t.reverse().$value()).length; i < n; i++)
                    this._addRecentColor(this._getHexColorCode(o[i]));
                this._redrawRecentColorElement()
            }
        }
...
, function(e, t) {
    nhn.husky.SE2M_FontColor = jindo.$Class({
        ...
        _assignHTMLElements: function(e) {
            this.elLastUsed = jindo.$$.getSingle("SPAN.husky_se2m_fontColor_lastUsed", e),
            this.elDropdownLayer = jindo.$$.getSingle("DIV.husky_se2m_fontcolor_layer", e),
...
, function(e, t) {
    nhn.husky.SE2M_BGColor = jindo.$Class({
        ...
        _assignHTMLElements: function(e) {
            this.elLastUsed = jindo.$$.getSingle("SPAN.husky_se2m_BGColor_lastUsed", e),
            this.elDropdownLayer = jindo.$$.getSingle("DIV.husky_se2m_BGColor_layer", e),
            this.elBGColorList = jindo.$$.getSingle("UL.husky_se2m_bgcolor_list", e),
...
, function(e, t) {
    nhn.husky.SE2M_Hyperlink = jindo.$Class({
        ...
        _assignHTMLElements: function(e) {
            this.oHyperlinkButton = jindo.$$.getSingle("li.husky_seditor_ui_hyperlink", e),
        ...
        $LOCAL_BEFORE_FIRST: function(e) {
            if (e.match(/(REGISTER_CONVERTERS)/))
                return this.oApp.acceptLocalBeforeFirstAgain(this, !0),
                !0;
        ...
        $ON_EVENT_HYPERLINK_KEYDOWN: function(e) {
            e.key().enter && (this.oApp.exec("APPLY_HYPERLINK"),
            e.stop())
        },
        $ON_DISABLE_MESSAGE: function(e) {
            ...
            if (!this._bDisabled) {
                ...
                for (var i, n, o = this.oApp.getEmptySelection(), s = o._getFirstRealChild(t), r = o._getLastRealChild(t), a = jindo.$A(o._getNodesBetween(s, r)), l = a.filter(function(e) {
                    ...
                    if (!n) {
                        d.innerHTML = "";
                        try {
                            d.appendChild(h[p].cloneNode(!0)),
                            d.innerHTML = (c + d.innerHTML).replace(/(&nbsp|\s)?(((?!http[s]?:\/\/)www\.(?:(?!&nbsp;|\s|"|').)+)|(http[s]?:\/\/(?:(?!&nbsp;|\s|"|').)+))/gi, this._generateAutoLink),
                            h[p].parentNode.insertBefore(d, h[p]),
                            h[p].parentNode.removeChild(h[p])
                        } catch (g) {}
                        for (; d.firstChild; )
                ...
                d = o = s = r = a = l = h = i = null,
                t.innerHTML = t.innerHTML.replace(_, ""),
...
, function(e, t) {
    function c(e, t, i, n, o) {
        ...
        "" != this.fontCSSURL ? (this.displayName += "" + i,
        this.fontFamily += "_" + i,
        this.isLoaded = !1,
        this.loadCSS = function(e) {
            this.isLoaded || (this._importCSS(e),
            this.isLoaded = !0)
        }
        ,
        ...
        this._importCSS = function(e) {
            var t = e.styleSheets.length
              , i = e.styleSheets[t - 1];
            (0 === t || 30 < i.imports.length) && (i = e.createElement("style"),
            e.documentElement.firstChild.appendChild(i),
            i = i.sheet || i.styleSheet),
            i.addImport(this.fontCSSURL)
        }
    ...
    nhn.husky.SE2M_FontNameWithLayerUI = jindo.$Class({
        ...
        $init: function(e, t) {
            ...
            this._assignHTMLElements(e),
            this.htBrowser = jindo.$Agent().navigator(),
            this.aAdditionalFontList = t || []
        },
        addAllFonts: function() {
            var e, t, i, n, o, s;
            if (this.htFamilyName2DisplayName = {},
            this.htAllFonts = {},
            this.aBaseFontList = [],
            ...
            this.htOptions) {
                if (e = this.htOptions.aDefaultFontList || [],
                t = this.htOptions.aFontList,
                i = this.htOptions.htMainFont,
                n = this.htOptions.aFontInUse,
                this.htBrowser.ie && t)
                    for (o = 0; o < t.length; o++)
                        this.addFont(t[o].id, t[o].name, t[o].size, t[o].url, t[o].cssUrl);
                for (o = 0; o < e.length; o++)
                    this.addFont(e[o][0], e[o][1], 0, "", "", 1);
                if (i && i.id && this.setMainFont(i.id, i.name, i.size, i.url, i.cssUrl),
                this.htBrowser.ie && n)
                    for (o = 0; o < n.length; o++)
                        this.addFontInUse(n[o].id, n[o].name, n[o].size, n[o].url, n[o].cssUrl)
            }
            ...
            this.addFont("돋움체,DotumChe,AppleGothic", "돋움체", 0, "", "", 1, null, !0),
            this.addFont("굴림,Gulim", "굴림", 0, "", "", 1, null, !0),
            this.addFont("굴림체,GulimChe", "굴림체", 0, "", "", 1, null, !0),
            this.addFont("바탕,Batang,AppleMyungjo", "바탕", 0, "", "", 1, null, !0),
            this.addFont("바탕체,BatangChe", "바탕체", 0, "", "", 1, null, !0),
            this.addFont("궁서,Gungsuh,GungSeo", "궁서", 0, "", "", 1, null, !0),
            this.addFont("Arial", "Arial", 0, "", "", 1, "abcd", !0),
            this.addFont("Tahoma", "Tahoma", 0, "", "", 1, "abcd", !0),
            this.addFont("Times New Roman", "Times New Roman", 0, "", "", 1, "abcd", !0),
            this.addFont("Verdana", "Verdana", 0, "", "", 1, "abcd", !0),
            this.addFont("Courier New", "Courier New", 0, "", "", 1, "abcd", !0)),
            this.aAdditionalFontList && 0 < this.aAdditionalFontList.length)
                for (o = 0,
                s = this.aAdditionalFontList.length; o < s; o++)
                    this.addFont(this.aAdditionalFontList[o][0], this.aAdditionalFontList[o][1], 0, "", "", 1)
        },
        $ON_MSG_APP_READY: function() {
            this.bDoNotRecordUndo = !1,
        ...
        _assignHTMLElements: function(e) {
            this.oDropdownLayer = jindo.$$.getSingle("DIV.husky_se_fontName_layer", e),
            this.elFontNameLabel = jindo.$$.getSingle("SPAN.husky_se2m_current_fontName", e),
            ...
            this.aLIFontNames = jindo.$A(jindo.$$("LI", this.oDropdownLayer)).filter(function(e) {
                return null !== e.firstChild
            })._array,
        ...
        _initFontName: function() {
            ...
            this.addAllFonts(),
            this.oApp.getCurrentStyle && (e = this.oApp.getCurrentStyle()) && this.$ON_MSG_STYLE_CHANGED("fontFamily", e.fontFamily),
        ...
        _checkFontLI: function(e, t) {
            ...
            return e.style.display = i ? "block" : "none",
            i
        },
        _addFontInMarkup: function() {
            for (var e, t, i, n, o = 0; e = this.aelFontInMarkup[o]; o++)
                e.firstChild ? (t = this._getFontFamilyFromLI(e).replace(this._rxQuote, "").replace(this._rxComma, ","),
                n |= this._checkFontLI(e, t)) : -1 < e.className.indexOf(this.FONT_SEPARATOR) ? (i && (i.style.display = n ? "block" : "none"),
                i = e,
        ...
        _attachIEEvent: function() {
            if (this.htBrowser.ie) {
                if (this.htBrowser.nativeVersion < 9)
                    return this._wfOnPasteWYSIWYGBody = jindo.$Fn(this._onPasteWYSIWYGBody, this),
                    void this._wfOnPasteWYSIWYGBody.attach(this.oApp.getWYSIWYGDocument().body, "paste");
                if (document.documentMode < 9)
                    return this._wfOnFocusWYSIWYGBody = jindo.$Fn(this._onFocusWYSIWYGBody, this),
                    void this._wfOnFocusWYSIWYGBody.attach(this.oApp.getWYSIWYGDocument().body, "focus");
        ...
        _onMouseupCover: function(e) {
            e.stop(),
            this.welEditingAreaCover && this.welEditingAreaCover.leave();
            var t = e.mouse()
            ...
            this.oApp.oNavigator.ie && document.documentMode < 11 && "WYSIWYG" === this.oApp.getEditingMode())
                "<p></p>" == this.oApp.getWYSIWYGDocument().body.innerHTML && (this.oApp.getWYSIWYGDocument().body.innerHTML = '<p><span id="husky_bookmark_start_INIT"></span><span id="husky_bookmark_end_INIT"></span></p>',
                (o = this.oApp.getSelection()).moveToStringBookmark("INIT"),
                o.select(),
        ...
        _loadAllBaseFont: function() {
            ...
            if (this.htBrowser.ie) {
                if (this.htBrowser.nativeVersion < 9)
                    for (e = 0,
                    t = this.aBaseFontList.length; e < t; e++)
                        this.aBaseFontList[e].loadCSS(this.oApp.getWYSIWYGDocument());
                else if (document.documentMode < 9)
                    for (e = 0,
                    t = this.aBaseFontList.length; e < t; e++)
                        this.aBaseFontList[e].loadCSSToMenu();
                this._loadAllBaseFont = function() {}
            }
        },
        _addFontToMenu: function(e, t, i) {
            var n = document.createElement("LI");
            n.innerHTML = this.elFontItemTemplate.innerHTML.replace("@DisplayName@", e).replace("FontFamily", t).replace("@SampleText@", i),
            this.elFontNameList.insertBefore(n, this.elFontItemTemplate),
            this.aLIFontNames[this.aLIFontNames.length] = n,
            20 < this.aLIFontNames.length && (this.oDropdownLayer.style.overflowX = "hidden",
        ...
        $ON_EVENT_FONTNAME_LAYER_CLICKED: function(e) {
            var t = this._findLI(e.element);
            if (t) {
                var i, n = this._getFontFamilyFromLI(t), o = this.htAllFonts[n.replace(/"/g, nhn.husky.SE2M_FontNameWithLayerUI.CUSTOM_FONT_MARKS)];
                i = o ? o.defaultSize + "pt" : 0,
                this.oApp.exec("SET_FONTFAMILY", [n, i])
            }
        },
        _findLI: function(e) {
            for (; "LI" != e.tagName; ) {
                if (!e || e === this.oDropdownLayer)
                    return null;
                e = e.parentNode
            }
        ...
        $ON_MSG_STYLE_CHANGED: function(e, t) {
            if ("fontFamily" == e) {
                ...
                if (this._clearFontNameSelection(),
                i)
                    this.elFontNameLabel.innerHTML = this._getFontNameLabelFromLI(i),
                    jindo.$Element(i).addClass("active");
                else {
        ...
        $ON_SET_FONTFAMILY: function(e, t) {
            if (e) {
                ...
                i && i.loadCSS(this.oApp.getWYSIWYGDocument()),
                this.oApp.exec("RECORD_UNDO_BEFORE_ACTION", ["SET FONTFAMILY", {
                    bMustBlockElement: !0
                }]),
                this.bDoNotRecordUndo = !0,
                0 < parseInt(t, 10) && this.oApp.exec("SET_WYSIWYG_STYLE", [{
                    fontSize: t
                }]),
        ...
        _getMatchingLI: function(e) {
            ...
            for (var n = 0; n < this.aLIFontNames.length; n++) {
                t = this.aLIFontNames[n],
                i = this._getFontFamilyFromLI(t).toLowerCase().split(",");
                for (var o = 0; o < i.length; o++)
                    if (i[o] && jindo.$S(i[o].replace(/['"]/gi, "")).trim().$value() == e)
                        return t
            }
            return null
        },
        ...
        _clearFontNameSelection: function() {
            for (var e = 0; e < this.aLIFontNames.length; e++)
                jindo.$Element(this.aLIFontNames[e]).removeClass("active")
        },
        addFont: function(e, t, i, n, o, s, r, a) {
            if (!this.htBrowser.ie && o)
                return null;
            if (a && !window.IsInstalledFont(e))
                return null;
            var l, h, d = new c(e,t,i,n,o);
            return h = 0 < i ? (l = e + "_" + i,
            t + "_" + i) : (l = e,
            t),
            s || (l = nhn.husky.SE2M_FontNameWithLayerUI.CUSTOM_FONT_MARKS + l + nhn.husky.SE2M_FontNameWithLayerUI.CUSTOM_FONT_MARKS),
            this.htAllFonts[l] ? this.htAllFonts[l] : (this.htAllFonts[l] = d,
            this.htBrowser.ie && 9 <= this.htBrowser.nativeVersion && 9 <= document.documentMode && d.loadCSSToMenu(),
            this.htFamilyName2DisplayName[l] = t,
            r = r || this.oApp.$MSG("SE2M_FontNameWithLayerUI.sSampleText"),
            this._addFontToMenu(h, l, r),
            s ? 1 == s ? this.aDefaultFontList[this.aDefaultFontList.length] = d : this.aTempSavedFontList[this.aTempSavedFontList.length] = d : this.aBaseFontList[this.aBaseFontList.length] = d,
            d)
        },
        addFontInUse: function(e, t, i, n, o, s) {
            var r = this.addFont(e, t, i, n, o, s);
            return r ? (r.loadCSS(this.oApp.getWYSIWYGDocument()),
            r) : null
        },
        setMainFont: function(e, t, i, n, o, s) {
            var r = this.addFontInUse(e, t, i, n, o, s);
            return r ? (this.setDefaultFont(r.fontFamily, i),
            r) : null
        },
        setDefaultFont: function(e, t) {
            var i = this.oApp.getWYSIWYGDocument().body;
            i.style.fontFamily = e,
            0 < t && (i.style.fontSize = t + "pt")
        }
    }),
...
, function(e, t) {
    nhn.ColorPicker = jindo.$Class({
        ...
        _hsvColor: null,
        $init: function(e, t) {
            if (this.elem = jindo.$Element(e).empty(),
            this.huePanel = null,
            this.cursor = jindo.$Element("<div>").css("overflow", "hidden"),
            this.canvasType = jindo.$(e).filters ? "Filter" : jindo.$("<canvas>").getContext ? "Canvas" : null,
            !this.canvasType)
                return !1;
            ...
            this.option(t),
            this.option("huePanel") && (this.huePanel = jindo.$Element(this.option("huePanel")).empty()),
            this._hsvColor = this._hsv(0, 100, 100),
            this)
                /^_on[A-Z][a-z]+[A-Z][a-z]+$/.test(i) && (this[i + "Fn"] = jindo.$Fn(this[i], this));
            this._onDownColorFn.attach(this.elem, "mousedown"),
            this.huePanel && this._onDownHueFn.attach(this.huePanel, "mousedown"),
            this.paint()
        },
        rgb: function(e) {
        ...
        hsv: function(e) {
            ...
            var t = null
              ...
              , a = 0;
            if (this.huePanel)
                t = this._hsv2rgb(e.h, 100, 100),
                this.elem.css("background", "#" + this._rgb2hex(t.r, t.g, t.b)),
                r = e.s / 100 * i,
                a = (100 - e.v) / 100 * n;
            else {
                var l = i / 2;
                r = e.v > e.s ? (e.v = 100,
                e.s / 100 * l) : ((e.s = 100) - e.v) / 100 * l + l,
                a = e.h / 360 * n
            }
            r = Math.max(Math.min(r - 1, i - o), 1),
            a = Math.max(Math.min(a - 1, n - s), 1),
            this.cursor.css({
                left: r + "px",
                top: a + "px"
            }),
            this._hsvColor = e,
            t = this._hsv2rgb(e.h, e.s, e.v),
        ...
        paint: function() {
            this.huePanel ? (this["_paintColWith" + this.canvasType](),
            this["_paintHueWith" + this.canvasType]()) : this["_paintOneWith" + this.canvasType](),
        ...
        _paintColWithCanvas: function() {
            ...
            var t = e.attr("width", e.width()).attr("height", e.height()).$value().getContext("2d")
              ...
              , n = e.width()
              , o = e.height();
            (i = t.createLinearGradient(0, 0, n, 0)).addColorStop(0, "rgba(255,255,255,1)"),
            i.addColorStop(1, "rgba(255,255,255,0)"),
            t.fillStyle = i,
            t.fillRect(0, 0, n, o),
            (i = t.createLinearGradient(0, 0, 0, o)).addColorStop(0, "rgba(0,0,0,0)"),
            i.addColorStop(1, "rgba(0,0,0,1)"),
            t.fillStyle = i,
            t.fillRect(0, 0, n, o)
        },
        _paintOneWithFilter: function() {
            for (var e, t, i, n, o, s, r = this.elem.height(), a = 1; a < 7; a++)
                e = Math.floor((a - 1) / 6 * r),
                t = Math.floor(a / 6 * r),
                i = this._hsv2rgb((a - 1) / 6 * 360, 100, 100),
                n = this._hsv2rgb(a / 6 * 360, 100, 100),
                o = "#FF" + this._rgb2hex(i.r, i.g, i.b),
                s = "#FF" + this._rgb2hex(n.r, n.g, n.b),
                jindo.$Element("<div>").css({
                    position: "absolute",
                    left: 0,
                    width: "100%",
        ...
        _paintOneWithCanvas: function() {
            ...
            for (var i = t.attr("width", t.width()).attr("height", t.height()).$value().getContext("2d"), n = t.width(), o = t.height(), s = i.createLinearGradient(0, 0, 0, o), r = 0; r < 7; r++)
                e = this._hsv2rgb(r / 6 * 360, 100, 100),
                s.addColorStop(r / 6, "rgb(" + e.join(",") + ")");
            i.fillStyle = s,
            i.fillRect(0, 0, n, o),
            (s = i.createLinearGradient(0, 0, n, 0)).addColorStop(0, "rgba(255,255,255,1)"),
            s.addColorStop(.5, "rgba(255,255,255,0)"),
            s.addColorStop(.5, "rgba(0,0,0,0)"),
            s.addColorStop(1, "rgba(0,0,0,1)"),
            i.fillStyle = s,
            i.fillRect(0, 0, n, o)
        },
        _paintHueWithFilter: function() {
            var e, t, i, n, o, s, r = "vertical" == this.option().huePanelType, a = this.huePanel.width(), l = this.huePanel.height(), h = null, d = parseInt(this.huePanel.css("borderWidth"), 10);
            isNaN(d) && (d = 0),
            a -= 2 * d;
            for (var c = 1; c < 7; c++) {
                e = Math.floor((c - 1) / 6 * (r ? l : a)),
                t = Math.floor(c / 6 * (r ? l : a)),
                i = this._hsv2rgb((c - 1) / 6 * 360, 100, 100),
                n = this._hsv2rgb(c / 6 * 360, 100, 100),
                o = "#FF" + this._rgb2hex(i.r, i.g, i.b),
                s = "#FF" + this._rgb2hex(n.r, n.g, n.b);
                var _ = t - e + 1;
                ...
                })).appendTo(this.huePanel),
                h.css(r ? "left" : "top", 0).css(r ? "width" : "height", "100%"),
                h.css(r ? "top" : "left", e + "px").css(r ? "height" : "width", _ + "px")
            }
        },
        _paintHueWithCanvas: function() {
            var e, t = "vertical" == this.option().huePanelType, i = jindo.$Element("<canvas>").css({
                width: "100%",
                height: "100%"
            });
            i.appendTo(this.huePanel.empty());
            for (var n = i.attr("width", i.width()).attr("height", i.height()).$value().getContext("2d"), o = n.createLinearGradient(0, 0, t ? 0 : i.width(), t ? i.height() : 0), s = 0; s < 7; s++)
                e = this._hsv2rgb(s / 6 * 360, 100, 100),
                o.addColorStop(s / 6, "rgb(" + e.join(",") + ")");
            n.fillStyle = o,
        ...
        _rgb2hsv: function(e, t, i) {
            var n = 0
              ...
              , s = Math.max(e, t, i)
              , r = s - Math.min(e, t, i);
            return (o = s ? r / s : 0) && (e == s ? n = 60 * (t - i) / r : t == s ? n = 120 + 60 * (i - e) / r : i == s && (n = 240 + 60 * (e - t) / r),
            n < 0 && (n += 360)),
            n = Math.floor(n),
            o = Math.floor(100 * o),
            s = Math.floor(s / 255 * 100),
            this._hsv(n, o, s)
        },
        ...
        _rgb2hex: function(e, t, i) {
            ...
            1 == (t = t.toString(16)).length && (t = "0" + t),
            1 == (i = i.toString(16)).length && (i = "0" + i),
            e + t + i
        },
        _hex2rgb: function(e) {
        ...
        _onDownColor: function(e) {
            if (!e.mouse().left)
                return !1;
            var t = e.pos();
            this._colPagePos = [t.pageX, t.pageY],
            this._colLayerPos = [t.layerX, t.layerY],
        ...
        _onDownHue: function(e) {
            if (!e.mouse().left)
                return !1;
            var t = e.pos();
            this._huePagePos = [t.pageX, t.pageY],
            this._hueLayerPos = [t.layerX, t.layerY],
        ...
        _onMoveHue: function(e) {
            ...
            o = "vertical" == this.option().huePanelType ? (n = r,
            this.huePanel.height()) : (n = s,
            this.huePanel.width()),
            t.h = t[0] = Math.min(Math.max(n, 0), o) / o * 360 % 360,
            this.hsv(t),
            e.stop()
        }
    }).extend(jindo.Component)
...
, function(e, t) {
    nhn.husky.SE2M_Accessibility = jindo.$Class({
        ...
        _assignHTMLElements: function(e) {
            this.elHelpPopupLayer = jindo.$$.getSingle("DIV.se2_accessibility", e),
        ...
        $ON_MSG_APP_READY: function() {
            ...
            this.sLang && "ko_KR" !== this.sLang || (this.oApp.exec("REGISTER_HOTKEY", ["alt+0", "OPEN_HELP_POPUP", []]),
            this.oApp.exec("REGISTER_HOTKEY", ["esc", "CLOSE_HELP_POPUP", [], document]),
            this.htAccessOption.sTitleElementId && this.oApp.registerBrowserEvent(document.getElementById(this.htAccessOption.sTitleElementId), "keydown", "MOVE_TO_EDITAREA", []))
        },
        ...
        $LOCAL_BEFORE_FIRST: function() {
            ...
            this.htOffsetPos = jindo.$Element(e).offset(),
            this.nEditorWidth = e.offsetWidth,
        ...
        $ON_FOCUS_NEXT_ELEMENT: function() {
            ...
            this.htAccessOption.sNextElementId ? this._currentNextFocusElement = document.getElementById(this.htAccessOption.sNextElementId) : this._currentNextFocusElement = this._findNextFocusElement(this.elAppContainer),
            this._currentNextFocusElement ? (window.focus(),
            this._currentNextFocusElement.focus()) : parent && parent.nhn && parent.nhn.husky && parent.nhn.husky.EZCreator && parent.nhn.husky.EZCreator.elIFrame && (parent.focus(),
        ...
        _findNextFocusElement: function(e) {
            for (var t = null, i = e.nextSibling; i; ) {
                if (1 !== i.nodeType) {
                    if (i = this._switchToSiblingOrNothing(i))
                        continue;
                    break
                }
                if (this._recursivePreorderTraversalFilter(i, this._isFocusTag),
                this._nextFocusElement) {
                    t = this._nextFocusElement,
                    this._bStopFindingNextElement = !1,
        ...
        _switchToSiblingOrNothing: function(e, t) {
            ...
            if (t)
                if (i.previousSibling)
                    ...
                    for (; "BODY" != i.nodeName.toUpperCase() && !i.previousSibling; )
                        i = i.parentNode;
                ...
                for (; "BODY" != i.nodeName.toUpperCase() && !i.nextSibling; )
                    i = i.parentNode;
        ...
        _recursivePreorderTraversalFilter: function(e, t, i) {
            var n = this;
            if (t.apply(e))
                return n._bStopFindingNextElement = !0,
                void (i ? n._previousFocusElement = e : n._nextFocusElement = e);
            if (i)
                for (var o = e.childNodes.length, s = o - 1; 0 <= s && (n._recursivePreorderTraversalFilter(e.childNodes[s], t, !0),
                !this._bStopFindingNextElement); s--)
                    ;
            else
                for (s = 0,
                o = e.childNodes.length; s < o && (n._recursivePreorderTraversalFilter(e.childNodes[s], t),
                !this._bStopFindingNextElement); s++)
                    ;
        },
        ...
        $ON_FOCUS_BEFORE_ELEMENT: function() {
            ...
            this.htAccessOption.sBeforeElementId ? this._currentPreviousFocusElement = document.getElementById(this.htAccessOption.sBeforeElementId) : this._currentPreviousFocusElement = this._findPreviousFocusElement(this.elAppContainer),
            this._currentPreviousFocusElement ? (window.focus(),
            this._currentPreviousFocusElement.focus()) : parent && parent.nhn && parent.nhn.husky && parent.nhn.husky.EZCreator && parent.nhn.husky.EZCreator.elIFrame && (parent.focus(),
        ...
        _findPreviousFocusElement: function(e) {
            for (var t = null, i = e.previousSibling; i; ) {
                if (1 !== i.nodeType) {
                    if (i = this._switchToSiblingOrNothing(i, !0))
                        continue;
                    break
                }
                if (this._recursivePreorderTraversalFilter(i, this._isFocusTag, !0),
                this._previousFocusElement) {
                    t = this._previousFocusElement,
                    this._bStopFindingNextElement = !1,
        ...
        $ON_FOCUS_TOOLBAR_AREA: function() {
            ...
            this.oButton && !this.oButton.disabled && (window.focus(),
            this.oButton.focus())
        },
        $ON_OPEN_HELP_POPUP: function() {
            ...
            jindo.$Agent().navigator().ie && window.focus();
            var t = this;
            setTimeout(function() {
                try {
...
, function(e, t) {
    nhn.husky.SE2M_FindReplacePlugin = jindo.$Class({
        ...
        $ON_MSG_APP_READY: function() {
            ...
            jindo.$Agent().os().mac ? (this.oApp.exec("REGISTER_HOTKEY", ["meta+f", "SHOW_FIND_LAYER", []]),
...
, function(e, t) {
    nhn.husky.SE2M_Quote = jindo.$Class({
        ...
        $init: function() {
            ...
            this.htQuoteStyles_view.se2_quote2 = "_zoom:1;margin:0 0 30px 13px;padding:0 8px 0 16px;background:url(" + t + "/bg_quote2.gif) 0 3px no-repeat;color:#888888;",
            ...
            this.htQuoteStyles_view.se2_quote5 = "_zoom:1;margin:0 0 30px 0;padding:10px;border:1px dashed #cccccc;background:url(" + t + "/bg_b1.png) repeat;_background:none;_filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='" + t + "/bg_b1.png',sizingMethod='scale');color:#888888;",
            ...
            this.htQuoteStyles_view.se2_quote8 = "_zoom:1;margin:0 0 30px 0;padding:10px;border:1px solid #e5e5e5;background:url(" + t + "/bg_b1.png) repeat;_background:none;_filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='" + t + "/bg_b1.png',sizingMethod='scale');color:#888888;",
            this.htQuoteStyles_view.se2_quote9 = "_zoom:1;margin:0 0 30px 0;padding:10px;border:2px solid #e5e5e5;color:#888888;",
            this.htQuoteStyles_view.se2_quote10 = "_zoom:1;margin:0 0 30px 0;padding:10px;border:2px solid #e5e5e5;background:url(" + t + "/bg_b1.png) repeat;_background:none;_filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='" + t + "/bg_b1.png',sizingMethod='scale');color:#888888;"
        },
        ...
        $ON_REGISTER_CONVERTERS: function() {
            ...
            this.oApp.exec("ADD_CONVERTER", ["IR_TO_DB", jindo.$Fn(function(e) {
        ...
        $ON_EVENT_EDITING_AREA_KEYDOWN: function(e) {
            var t, i;
            "WYSIWYG" === this.oApp.getEditingMode() && 8 === e.key().keyCode && ((t = this.oApp.getSelection()).fixCommonAncestorContainer(),
            (i = this._findParentQuote(t.commonAncestorContainer)) && this._isBlankQuote(i) && (e.stop(jindo.$Event.CANCEL_DEFAULT),
            t.selectNode(i),
            t.collapseToStart(),
            jindo.$Element(i).leave(),
            t.select()))
        },
        $ON_EVENT_EDITING_AREA_KEYUP: function(e) {
            var t, i, n;
            if ("WYSIWYG" === this.oApp.getEditingMode() && 46 === e.key().keyCode) {
                if ((t = this.oApp.getSelection()).fixCommonAncestorContainer(),
                !(i = this._findParentQuote(t.commonAncestorContainer)))
                    return !1;
                i.nextSibling || (e.stop(jindo.$Event.CANCEL_DEFAULT),
                (n = t._document.createElement("P")).innerHTML = "&nbsp;",
                jindo.$Element(i).after(n),
                setTimeout(jindo.$Fn(function(e) {
                    var t = e.placeStringBookmark();
                    e.select(),
                    e.removeStringBookmark(t)
                }, this).bind(t), 0))
            }
        },
        _isBlankQuote: function(e) {
            ...
            if (t(e.innerHTML) || "<br>" === e.innerHTML)
                return !0;
            if (l || h) {
                ...
                for (o = 0; o < _; o++)
                    d = c[o],
                    r = d,
                    0 === jindo.$$("tr", r).length && jindo.$Element(d).leave()
            }
            for (o = 0,
            s = (n = e.childNodes).length; o < s; o++)
                if (i = n[o],
                (3 !== (a = i).nodeType || !t(a.nodeValue)) && ("P" !== a.tagName && "SPAN" !== a.tagName || !t(a.innerHTML) && "<br>" !== a.innerHTML))
                    return !1;
            return !0
        },
        ...
        irToDbDOM: function(e) {
            ...
            !(t.length < 1))
                for (var n, o = [], s = 0, r = t.length; s < r; s++)
                    ...
                    o = jindo.$$("tbody>tr>td", n),
                    jindo.$A(o).forEach(function(e) {
                        jindo.$Element(e).css({
                            border: "",
                            borderTop: "",
                            borderRight: ""
...
, function(e, t) {
    nhn.husky.SE2M_TableBlockStyler = jindo.$Class({
        ...
        $ON_IS_SELECTED_TD_BLOCK: function(e, t) {
            return 0 < this.nSelectedTD ? t[e] = !0 : t[e] = !1,
            t[e]
        },
        ...
        $ON_DELETE_BLOCK_CONTENTS: function() {
            var t, i, n, o = this;
            this.setTdBlock();
            for (var e = 0; e < this.nSelectedTD; e++)
                jindo.$Element(this.htSelectedTD.aTdCells[e]).child(function(e) {
                    (t = jindo.$Element(e._element.parentNode)).remove(e),
                    i = o.oDocument.createElement("P"),
                    n = jindo.$Agent().navigator().firefox ? o.oDocument.createElement("BR") : o.oDocument.createTextNode(" "),
                    i.appendChild(n),
                    t.append(i)
                }, 1)
        }
...
, function(e, t) {
    nhn.husky.SE2M_StyleRemover = jindo.$Class({
        ...
        $ON_CHOOSE_REMOVE_STYLE: function() {
            var e, t = {};
            this.oApp.exec("IS_SELECTED_TD_BLOCK", ["bIsSelectedTd", t]),
            e = t.bIsSelectedTd,
            this.oApp.exec("RECORD_UNDO_BEFORE_ACTION", ["REMOVE STYLE", {
                bMustBlockElement: !0
            }]),
            e ? this.oApp.exec("REMOVE_STYLE_IN_BLOCK", []) : this.oApp.exec("REMOVE_STYLE", []),
        ...
        $ON_REMOVE_STYLE_IN_BLOCK: function() {
            var e = {};
            this.oSelection = this.oApp.getSelection(),
            this.oApp.exec("GET_SELECTED_TD_BLOCK", ["aTdCells", e]);
            for (var t = e.aTdCells, i = 0; i < t.length; i++)
                this.oSelection.selectNodeContents(t[i]),
                this.oSelection.select(),
                this.oApp.exec("REMOVE_STYLE", [])
        },
        $ON_REMOVE_STYLE: function(e) {
            if (e && e.commonAncestorContainer || (e = this.oApp.getSelection()),
            !e.collapsed) {
                e.expandBothEnds();
                ...
                for (var r = 0; r < s.length; r++) {
                    var a = s[r];
                    a.style && "BR" != a.tagName && "TD" != a.tagName && "TR" != a.tagName && "TBODY" != a.tagName && "TABLE" != a.tagName && (a.removeAttribute("align"),
                    a.removeAttribute("style"),
                    "inline" != jindo.$Element(a).css("display") || "IMG" == a.tagName || "IFRAME" == a.tagName || a.firstChild && !e._isBlankTextNode(a.firstChild) || a.parentNode.removeChild(a))
                }
                for (e.moveToBookmark(o),
                "TBODY" === e.commonAncestorContainer.tagName && (e = this.oApp.getSelection()),
                e.select(),
                t = this._document.getElementById(e.HUSKY_BOOMARK_START_ID_PREFIX + o); t; ) {
                    for ((i = nhn.DOMFix.parentNode(t)).removeChild(t); i && (!i.firstChild || !i.firstChild.nextSibling && e._isBlankTextNode(i.firstChild)); )
                        n = i.parentNode,
        ...
        $ON_REMOVE_STYLE_AND_PASTE_HTML: function(e, t) {
            var i, n, o, s, r;
            if (i = jindo.$Agent().navigator(),
            !e)
                return !1;
            "WYSIWYG" != this.oApp.getEditingMode() && this.oApp.exec("CHANGE_EDITING_MODE", ["WYSIWYG"]),
            t || this.oApp.exec("RECORD_UNDO_BEFORE_ACTION", ["REMOVE STYLE AND PASTE HTML"]),
            (r = this.oApp.getSelection()).deleteContents(),
            n = this.oApp.getWYSIWYGDocument().createElement("DIV"),
            r.insertNode(n),
            i.webkit && (n.innerHTML = "&nbsp;"),
            r.selectNode(n),
            this.oApp.exec("REMOVE_STYLE", [r]),
            i.ie ? e += "<p>&nbsp;</p>" : i.firefox && (e += "<p>\ufeff<br></p>"),
            r.selectNode(n),
            r.pasteHTML(e),
            s = r.getNodes() || [];
            for (var a = 0; a < s.length; a++)
                if (s[a].tagName && "td" == s[a].tagName.toLowerCase()) {
                    o = s[a],
                    r.selectNodeContents(o.firstChild || o),
                    r.collapseToStart(),
                    r.select();
                    break
                }
            ...
            t || this.oApp.exec("RECORD_UNDO_AFTER_ACTION", ["REMOVE STYLE AND PASTE HTML"])
        },
            ...
            for (var t = jindo.$A(e), i = 0; i < e.length; i++) {
                ...
                if (n && n.parentNode && n.parentNode.tagName) {
                    if ("inline" == jindo.$Element(n.parentNode).css("display")) {
                        var o = n.parentNode;
                        if (n.firstChild) {
                            if (-1 == t.indexOf(this.oHuskyRange._getVeryLastRealChild(n)))
                                continue;
                            if (-1 == t.indexOf(this.oHuskyRange._getVeryFirstRealChild(n)))
                                continue
                        }
                        if (n.nextSibling) {
                            if (-1 == t.indexOf(this._getVeryLast(n.nextSibling)))
                                if (i--,
                                -1 != t.indexOf(this._getVeryFirst(n.parentNode))) {
                                    a = n;
                                    for (var s = o; a && (l = a.previousSibling,
                                    ...
                                    for (a = n,
                                    o.insertBefore(r, a.nextSibling); a && (l = a.previousSibling,
                                    r.insertBefore(a, r.firstChild),
                                    l) && -1 != t.indexOf(this._getVeryFirst(l)); )
                                        a = l;
                                    for (this._splitAndAppendAtTop(r); r.firstChild; )
                                        r.parentNode.insertBefore(r.firstChild, r);
                            ...
                            for (var a = n; a; ) {
                                ...
                                if (o.parentNode.insertBefore(a, o.nextSibling),
                                !l)
                                    break;
                                if (-1 == t.indexOf(this._getVeryFirst(l)))
                                    break;
                                a = l
                            }
                            0 === o.childNodes.length && o.parentNode.removeChild(o)
        ...
        _splitAndAppendAtTop: function(e) {
            for (var t = e, i = t, n = i; "inline" == jindo.$Element(i.parentNode).css("display"); ) {
                for (var o = i.parentNode.cloneNode(!1); i.nextSibling; )
                    o.appendChild(i.nextSibling);
                i = i.parentNode,
            ...
            this.oApp.exec("ADD_CONVERTER_DOM", ["WYSIWYG_TO_IR", jindo.$Fn(function(e) {
                if (!(this.aSelectedCells.length < 1))
                    for (var t, i = ["TD", "TH"], n = 0; n < i.length; n++)
                        for (var o = 0, s = (t = e.getElementsByTagName(i[n])).length; o < s; o++)
                            t[o].className && (t[o].className = t[o].className.replace(this.CELL_SELECTION_CLASS, ""),
                            t[o].getAttribute(this.TMP_BGC_ATTR) ? (t[o].style.backgroundColor = t[o].getAttribute(this.TMP_BGC_ATTR),
                            t[o].removeAttribute(this.TMP_BGC_ATTR)) : t[o].getAttribute(this.TMP_BGIMG_ATTR) && (jindo.$Element(this.aCells[o]).css("backgroundImage", t[o].getAttribute(this.TMP_BGIMG_ATTR)),
...
, function(module, exports) {
    nhn.husky.SE2M_QuickEditor_Common = jindo.$Class({
        ...
        $ON_MSG_APP_READY: function() {
            ...
            e && (this._bUseConfig = !e.common || "undefined" == typeof e.common.bUseConfig || e.common.bUseConfig),
            this._bUseConfig ? (this._sBaseAjaxUrl = e.common.sBaseAjaxUrl,
            this._sAddTextAjaxUrl = e.common.sAddTextAjaxUrl,
            this.getData()) : this.setData("{table:'full',img:'full',review:'full'}"),
...
, function(e, t) {
    function a(e, t) {
        ...
        var i = a.Store
          , n = a.Action;
        if (void 0 === t && e.constructor == String)
            return i.set("document", e, document),
            n.init(i.get("document"), e);
        if (t.constructor == String && e.constructor == String)
            return i.set(t, e, jindo.$(t)),
            n.init(i.get(t), e);
        if (t.constructor != String && e.constructor == String) {
            var o = "nonID" + (new Date).getTime();
            return o = a.Store.searchId(o, t),
            i.set(o, e, t),
            n.init(i.get(o), e)
        }
    ...
    a.Store = {
        ...
        searchId: function(i, n) {
            ...
            !o && i in this.datas) {
                for (var e = i; e in this.datas; )
                    e = "nonID" + (new Date).getTime();
                return e
            }
            return i
        },
        ...
        reset: function(e) {
            var t = this.datas[e];
            a.Helper.bind(t.func, t.element, "detach"),
            delete this.datas[e]
        },
        allReset: function() {
    ...
    a.Data = jindo.$Class({
        $init: function(e, t, i) {
            ...
            a.Helper.bind(this.func, i, "attach"),
            this.keys = {},
            this.keyStemp = {},
            this.createKey(t)
        },
        createKey: function(e) {
            this.keyStemp[a.Helper.keyInterpretor(e)] = e,
            this.keys[e] = {};
            var t = this.keys[e];
            return t.key = e,
            t.events = [],
            t.commonExceptions = [],
            t.stopDefalutBehavior = !0,
            this
        },
        getKeyStamp: function(e) {
            var t = e.keyCode || e.charCode
              , i = "";
            return i += e.altKey ? "1" : "0",
            i += e.ctrlKey ? "1" : "0",
            i += e.metaKey ? "1" : "0",
            i += e.shiftKey ? "1" : "0",
            i += t
            ...
            t.notCommonException(o, r.commonExceptions) && jindo.$A(r.events).forEach(function(e) {
                ...
                if (r.stopDefalutBehavior) {
                    ...
                    if (i) {
                        ...
                        s ? (e.event(o),
                        jindo.$Agent().navigator().ie && ((t = o._event).keyCode = "",
                        t.charCode = ""),
                        o.stop()) : jindo.$A.Break()
                    } else
                        e.event(o),
                        jindo.$Agent().navigator().ie && ((t = o._event).keyCode = "",
                        t.charCode = ""),
        ...
        unRegister: function(e) {
            ...
            t && (a.Helper.bind(this.func, this.element, "detach"),
            delete a.Store.datas[this.id])
        },
    ...
    a.Helper = {
        keyInterpretor: function(e) {
            ...
            return o && (n += e = a.Store.anthorKeyHash[o.toUpperCase()] || o.toUpperCase().charCodeAt(0)),
            n
        },
    ...
    a.Action = {
        init: function(e, t) {
            return this.dataInstance = e,
            this.rawKey = t,
            this
        },
        addEvent: function(e) {
            return this.dataInstance.addEvent(e, this.rawKey),
            this
        },
        removeEvent: function(e) {
            return this.dataInstance.removeEvent(e, this.rawKey),
            this
        },
        addException: function(e) {
            return this.dataInstance.addException(e, this.rawKey),
            this
        },
        removeException: function(e) {
            return this.dataInstance.removeException(e, this.rawKey),
            this
        },
        startDefalutBehavior: function() {
            return this.dataInstance.startDefalutBehavior(this.rawKey),
            this
        },
        stopDefalutBehavior: function() {
            return this.dataInstance.stopDefalutBehavior(this.rawKey),
            this
        },
        resetElement: function() {
            return a.Store.reset(this.dataInstance.id),
            this
        },
        resetAll: function() {
            return a.Store.allReset(),
            this
        }
    },
    function() {
        ...
        for (var e = a.Store.anthorKeyHash, t = 1; t < 13; t++)
            a.Store.anthorKeyHash["F" + t] = t + 111;
        var i = jindo.$Agent().navigator();
        i.ie || i.safari || i.chrome ? (e.HYPHEN = 189,
        e.EQUAL = 187) : (e.HYPHEN = 109,
        e.EQUAL = 61)
    }(),
    window.shortcut = a
}
...
, function(e, t) {
    nhn.husky.SE_UndoRedo = jindo.$Class({
        ...
        $LOCAL_BEFORE_ALL: function(e) {
            if (e.match(/_DO_RECORD_UNDO_HISTORY_AT$/))
                return !0;
            try {
        ...
        $ON_MSG_APP_READY: function() {
            ...
            jindo.$Agent().os().mac ? (this.oApp.exec("REGISTER_HOTKEY", ["meta+z", "UNDO"]),
            this.oApp.exec("REGISTER_HOTKEY", ["meta+y", "REDO"])) : (this.oApp.exec("REGISTER_HOTKEY", ["ctrl+z", "UNDO"]),
        ...
        $ON_UNDO: function() {
            ...
            !(this.oCurStateIdx.nIdx <= 0)) {
                ...
                if (e && this.oApp.exec(e.sMsg, e.aParams),
                0 < this.oCurStateIdx.nStep)
                    this.oCurStateIdx.nStep--;
                else {
                    var i = this.aUndoHistory[this.oCurStateIdx.nIdx];
                    this.oCurStateIdx.nIdx--,
                    1 < i.nTotalSteps ? this.oCurStateIdx.nStep = 0 : (i = this.aUndoHistory[this.oCurStateIdx.nIdx],
                    this.oCurStateIdx.nStep = i.nTotalSteps - 1)
                }
                var n = this.aUndoHistory[this.oCurStateIdx.nIdx].sParentXPath[this.oCurStateIdx.nStep]
                  , o = !1;
                n !== t && 0 === n.indexOf(t) && (o = !0),
                this.oApp.exec("RESTORE_UNDO_HISTORY", [this.oCurStateIdx.nIdx, this.oCurStateIdx.nStep, o]),
                this.oApp.exec("CHECK_STYLE_CHANGE", []),
                this.sLastKey = null
            }
        },
        $ON_REDO: function() {
            if (!(this.oCurStateIdx.nIdx >= this.aUndoHistory.length)) {
                ...
                if (!(this.oCurStateIdx.nIdx == this.aUndoHistory.length - 1 && this.oCurStateIdx.nStep >= e.nTotalSteps - 1)) {
                    this.oCurStateIdx.nStep < e.nTotalSteps - 1 ? this.oCurStateIdx.nStep++ : (this.oCurStateIdx.nIdx++,
                    e = this.aUndoHistory[this.oCurStateIdx.nIdx],
                    this.oCurStateIdx.nStep = e.nTotalSteps - 1);
                    var t = this.aUndoHistory[this.oCurStateIdx.nIdx].oRedoCallback[this.oCurStateIdx.nStep];
                    t && this.oApp.exec(t.sMsg, t.aParams),
        ...
        $ON_RESTORE_UNDO_HISTORY: function(e, t, i) {
            this.oApp.exec("HIDE_ACTIVE_LAYER"),
            this.oCurStateIdx.nIdx = e,
            this.oCurStateIdx.nStep = t;
            ...
            if (this.oApp.exec("RESTORE_IE_SELECTION"),
            i)
                this.oApp.getWYSIWYGDocument().body.innerHTML = s,
                h = s = this.oApp.getWYSIWYGDocument().body.innerHTML,
                a = this.sDefaultXPath;
            else {
            ...
            this.bFF && h == this.sBlankContentsForFF && (h = ""),
            n.sFullContents[this.oCurStateIdx.nStep] = s,
            n.sContent[this.oCurStateIdx.nStep] = h,
            n.sParentXPath[this.oCurStateIdx.nStep] = a,
            r && "scroll" == r.sType ? setTimeout(jindo.$Fn(function() {
                this.oApp.getWYSIWYGDocument().documentElement.scrollTop = r.nScrollTop
            }, this).bind(), 0) : (d = this.oApp.getEmptySelection()).selectionLoaded && (r ? d.moveToXPathBookmark(r) : d = this.oApp.getEmptySelection(),
            d.select())
        },
        _doRecordUndoHistory: function(e, t) {
            ...
            this.oCurStateIdx.nIdx !== this._historyLength - 1 && (n = !0);
            var _ = this.aUndoHistory[this.oCurStateIdx.nIdx]
              , p = _.sFullContents[this.oCurStateIdx.nStep]
              , E = ""
              , u = ""
              , g = ""
              , f = null
            ...
            if ((A = this.oApp.getSelection()).selectionLoaded && (f = A.getXPathBookmark()),
            g = r ? A._getXPath(r) : s ? this._getTargetXPath(f, s) : this._getParentXPath(f, l, h),
            u = this.oApp.getWYSIWYGDocument().body.innerHTML,
            E = g === this.sDefaultXPath ? u : A._evaluateXPath(g, A._document).innerHTML,
            this.bFF && E == this.sBlankContentsForFF && (E = ""),
            !o && n) {
            ...
            S.nStep = i,
            0 === S.nStep && this.oCurStateIdx.nStep === _.nTotalSteps - 1 && (S.nIdx = this.oCurStateIdx.nIdx + 1),
            this._doRecordUndoHistoryAt(S, e, E, u, f, g, d, c)
        },
        ...
        _doRecordUndoHistoryAt: function(e, t, i, n, o, s, r, a) {
            if (0 !== e.nStep)
                this.aUndoHistory[e.nIdx].nTotalSteps = e.nStep + 1,
                this.aUndoHistory[e.nIdx].sContent[e.nStep] = i,
                this.aUndoHistory[e.nIdx].sFullContents[e.nStep] = n,
                this.aUndoHistory[e.nIdx].oBookmark[e.nStep] = o,
                this.aUndoHistory[e.nIdx].sParentXPath[e.nStep] = s,
                this.aUndoHistory[e.nIdx].oUndoCallback[e.nStep] = r,
                this.aUndoHistory[e.nIdx].oRedoCallback[e.nStep] = a;
            else {
                var l = {
                    sAction: t,
                    nTotalSteps: 1,
                ...
                l.oRedoCallback = [],
                l.oRedoCallback[0] = a,
                this.aUndoHistory.splice(e.nIdx, this._historyLength - e.nIdx, l),
                this._historyLength = this.aUndoHistory.length
            }
            this._historyLength > this.nHardLimit && (this.aUndoHistory.splice(0, this.nAfterMaxDeleteBuffer),
            e.nIdx -= this.nAfterMaxDeleteBuffer),
            this.oCurStateIdx.nIdx = e.nIdx,
            this.oCurStateIdx.nStep = e.nStep
        },
        ...
        _getTargetXPath: function(e, t) {
            ...
            if ("BODY" === t)
                return i;
            for (a = 0; a < r && n[a] === o[a]; a++)
                s.push(n[a]),
                "" !== n[a] && "HTML" !== n[a] && "BODY" !== n[a] && -1 < n[a].indexOf(t) && (l = a);
            return -1 < l && (s.length = l),
            (i = s.join("/")).length < this.sDefaultXPath.length && (i = this.sDefaultXPath),
            i
        },
        _getParentXPath: function(e, t, i) {
            ...
            if (!e)
                return c;
            if (e[0].sXPath === c || e[1].sXPath === c)
                return c;
            if (n = e[0].sXPath.split("/"),
            o = e[1].sXPath.split("/"),
            s = this.oSnapShot.oBookmark[0].sXPath.split("/"),
            r = this.oSnapShot.oBookmark[1].sXPath.split("/"),
            a = s.length < r.length ? s.length : r.length,
            (l = (l = n.length < o.length ? n.length : o.length) < a ? l : a) < 3)
                return c;
            for (t = t || !1,
            i = i || !1,
            p = 3; p < l && ((h = n[p]) === o[p] && h === s[p] && h === r[p] && o[p] === s[p] && o[p] === r[p] && s[p] === r[p]); p++)
                _.push(h),
                d = h.substring(0, h.indexOf("[")),
                (!t || "P" !== d && "LI" !== d && "DIV" !== d) && "UL" !== d && "OL" !== d && "TD" !== d && "TR" !== d && "TABLE" !== d && "BLOCKQUOTE" !== d || (E = p);
            if (-1 < E)
                _.length = E + 1;
            else if (t || i)
                return c;
...
, function(e, t) {
    nhn.husky.ActiveLayerManager = jindo.$Class({
        ...
        $ON_TOGGLE_ACTIVE_LAYER: function(e, t, i, n, o) {
            e == this.oCurrentLayer ? this.oApp.exec("HIDE_ACTIVE_LAYER", []) : (this.oApp.exec("SHOW_ACTIVE_LAYER", [e, n, o]),
            t && this.oApp.exec(t, i))
        },
        $ON_SHOW_ACTIVE_LAYER: function(e, t, i) {
            (e = jindo.$(e)) != this.oCurrentLayer && (this.oApp.exec("HIDE_ACTIVE_LAYER", []),
            this.sOnCloseCmd = t,
            this.aOnCloseParam = i,
            e.style.display = "block",
            this.oCurrentLayer = e,
        ...
        $ON_HIDE_ACTIVE_LAYER: function() {
            ...
            this.sOnCloseCmd && this.oApp.exec(this.sOnCloseCmd, this.aOnCloseParam))
        },
        $ON_HIDE_ACTIVE_LAYER_IF_NOT_CHILD: function(e) {
            for (var t = e; t; ) {
                if (t == this.oCurrentLayer)
                    return;
                t = t.parentNode
            }
            this.oApp.exec("HIDE_ACTIVE_LAYER")
...
, function(e, t) {
    nhn.husky.StringConverterManager = jindo.$Class({
        ...
        applyConverter: function(e, t, i) {
            var n, o = "@" + (new Date).getTime() + "@", s = new RegExp(o,"g"), r = {
                sContents: o + t
            };
            if (i = i || document,
            this.oApp.exec("MSG_STRING_CONVERTER_STARTED", [e, r]),
            t = r.sContents,
            n = this.oConverters_DOM[e]) {
            ...
            this.oApp.exec("MSG_STRING_CONVERTER_ENDED", [e, r]),
            r.sContents = r.sContents.replace(s, ""),
            r.sContents
        },
        $ON_ADD_CONVERTER: function(e, t) {
            var i = this.oApp.aCallerStack;
            t.sPluginName = i[i.length - 2].name,
            this.addConverter(e, t)
        },
        $ON_ADD_CONVERTER_DOM: function(e, t) {
            var i = this.oApp.aCallerStack;
            t.sPluginName = i[i.length - 2].name,
            this.addConverter_DOM(e, t)
        },
        addConverter: function(e, t) {
            this.oConverters[e] || (this.oConverters[e] = []),
            this.oConverters[e][this.oConverters[e].length] = t
        },
        addConverter_DOM: function(e, t) {
            this.oConverters_DOM[e] || (this.oConverters_DOM[e] = []),
            this.oConverters_DOM[e][this.oConverters_DOM[e].length] = t
        }
    })
}
, function(e, t) {
    nhn.husky.MessageManager = jindo.$Class({
        ...
        $init: function(e, t) {
            ...
            i = i || e,
            this._sDefaultLocale = t || this._sDefaultLocale,
            this._setMessageMap(i, this._sDefaultLocale)
        },
        _setMessageMap: function(e, t) {
            t = t || this._sDefaultLocale,
            e && (this._oMessageMapSet[t] = e)
        },
    ...
    nhn.husky.LazyLoader = jindo.$Class({
        ...
        $LOCAL_BEFORE_ALL: function(e, t) {
            ...
            return 1 == n.nLoadingStatus || (2 == n.nLoadingStatus ? this[e] = function() {
                return this._removeHandler(e),
                this.oApp.delayedExec(i, t, 0),
                !1
            }
            : (n.bLoadingStatus = 1,
            new jindo.$Ajax(n.sURL,{
                onload: jindo.$Fn(this._onload, this).bind(i, t)
            }).request())),
            !0
        },
        _onload: function(e, t, i) {
            4 == i._response.readyState ? (this.htMsgInfo[e].elTarget.innerHTML = i.text(),
            this.htMsgInfo[e].nLoadingStatus = 2,
            this._removeHandler("$BEFORE_" + e),
            this.oApp.exec("sMsg", t)) : this.oApp.exec(this.htMsgInfo[e].sFailureCallback, [])
        },
        _removeHandler: function(e) {
            delete this[e],
            this.oApp.createMessageMap(e)
        },
        _createBeforeHandlersAndSaveURLInfo: function(e, t, i, n) {
            ...
            if (this.aLoadingInfo[this.aLoadingInfo.legnth] = o,
            !(e instanceof Array)) {
                var s = e;
                e = [];
                var r = {};
            ...
            for (var h = 0; h < e.length; h++) {
                ...
                ,
                this.oApp.createMessageMap(d),
                this.htMsgInfo[e[h]] = o
            }
        }
    })
}
, function(e, t) {
    ...
    nhn.husky.PopUpManager.getInstance = function(e) {
        return null == this._instance && (this._instance = new function() {
            ...
            this.openWindow = function(e) {
                ...
                this.removePluginWin(r),
                this._whtPluginWin.add(this.getCorrectKey(this._whtPlugin, t.oApp), r),
                r
            }
            ,
            ...
            this.removePluginWin = function(e) {
                ...
                t && (this._whtPluginWin.remove(t),
                this.removePluginWin(e))
            }
        }
        ),
        this._instance.addPlugin("plugin_" + this._pluginKeyCnt++, e),
        nhn.husky.PopUpManager._instance
    }
    ,
    ...
    nhn.husky.PopUpManager.getFunc = function(e, t) {
        if (this._instance.getPluginWin().hasValue(e)) {
            ...
            if (i)
                return this._instance.getPlugin().$(i)[t]()
        }
    }
}
, function(e, t) {
    ...
    o = n.navigator(),
    s = n.os(),
    2 === (r = i.match(/(SHW-|Chrome|Safari)/gi) || "").length && "SHW-" === r[0] && "Safari" === r[1] ? o.bGalaxyBrowser = !0 : -1 < i.indexOf("LG-V500") && -1 < i.indexOf("Version/4.0") && (o.bGPadBrowser = !0),
    "undefined" == typeof s.ios && (s.ios = -1 < i.indexOf("iPad") || -1 < i.indexOf("iPhone"),
    s.ios && null != (r = i.match(/(iPhone )?OS ([\d|_]+)/)) && r[2] != undefined && (s.version = String(r[2]).split("_").join("."))),
    nhn.husky.SE2M_UtilPlugin = jindo.$Class({
        ...
        getScrollXY: function() {
            ...
            return t = "undefined" == typeof i.scrollX ? (e = i.document.documentElement.scrollLeft,
            i.document.documentElement.scrollTop) : (e = i.scrollX,
            i.scrollY),
            {
                x: e,
                y: t
    ...
    nhn.husky.SE2M_Utils = {
        ...
        isInvalidNodeInTable: function(e) {
            if (e && !this._rxTable.test(e.nodeName)) {
                var t;
                if ((t = e.previousSibling) && this._rxTable.test(t.nodeName))
                    return !0;
                if ((t = e.nextSibling) && this._rxTable.test(t.nodeName))
                    return !0
            }
            return !1
        },
        ...
        removeInvalidFont: function(e) {
            e && (this._removeInvalidFontInTable(e),
            this._removeEmptyFont(e))
        },
        _removeInvalidFontInTable: function(e) {
            for (var t, i = jindo.$$("table font", e), n = 0; t = i[n]; n++)
                this.removeInvalidNodeInTable(t)
        },
        _removeEmptyFont: function(e) {
            for (var t, i = jindo.$$("font", e), n = 0; t = i[n]; n++)
                (t.innerHTML || "").replace(this._rxSpaceOnly, "") || t.parentNode.removeChild(t)
        },
        convertFontToSpan: function(e) {
            if (e) {
                for (var t, i, n, o = e.ownerDocument || document, s = jindo.$$("font", e), r = 0; t = s[r]; r++)
                    ("SPAN" !== (i = t.parentNode).tagName || 1 < i.childNodes.length) && (i = o.createElement("SPAN"),
                    t.parentNode.insertBefore(i, t)),
                    (n = t.getAttribute("face")) && (i.style.fontFamily = n),
                    (n = this._htFontSize[t.getAttribute("size")]) && (i.style.fontSize = n),
                    (n = t.getAttribute("color")) && (i.style.color = n),
                    this._switchFontInnerToSpan(t, i),
        ...
        stripTags: function(e, t) {
            for (var i, n = jindo.$$(t, e), o = 0; i = n[o]; o++)
                this.stripTag(i)
        },
        reviseDateFormat: function(e) {
            return e && e.replace && (e = e.replace(this.rxDateFormat, "$&.")),
            e
        },
        getCustomCSS: function(e, t, i) {
            ...
            if (void 0 === e || void 0 === t || !e || !t)
                return n;
            var o = e.match(t);
            return o && o[0] && o[1] && (i ? n = o[1].split(i) : n[0] = o[1]),
            n
        },
        ...
        ellipsis: function(e, t, i, n) {
            ...
            if (l < d * (n + .5))
                return o.html(r);
            for (l = d; l < d * (n + .5); )
                h += Math.max(Math.ceil((a - h) / 2), 1),
                o.html(r.substring(0, h) + i),
                l = s.height();
            for (; d * (n + .5) < l; )
                h--,
                o.html(r.substring(0, h) + i),
        ...
        ellipsisByPixel: function(e, t, i, n) {
            ...
            if (!(s < i)) {
                var r = o.html()
                  ...
                  , l = 0;
                if (void 0 === n) {
                    for (s = o.html("A").width(); s < i; )
                        l += Math.max(Math.ceil((a - l) / 2), 1),
                        o.html(r.substring(0, l) + t),
                        s = o.width();
                    n = function() {
                        return !0
                    }
                }
                for (l = o.html().length - t.length; i < s && n(); )
                    l--,
                    o.html(r.substring(0, l) + t),
                    s = o.width()
            }
        ...
        ellipsisElementsToDesinatedWidth: function(e, i, n, o) {
            jindo.$A(e).forEach(function(e, t) {
                e || jindo.$A.Continue(),
                nhn.husky.SE2M_Utils.ellipsisByPixel(e, i, n[t], o)
            })
        },
        paddingZero: function(e, t) {
            for (var i = e.toString(); i.length < t; )
                i = "0" + i;
            return i
        },
        cutStringToByte: function(e, t, i) {
            ...
            for (var n = t, o = 0, s = (e = e.replace(/  +/g, " ")).length, r = 0; r < s; r++) {
                if ((o += this.getCharByte(e.charAt(r))) == n)
                    return r == s - 1 ? e : e.substring(0, r) + i;
                if (n < o)
                    return e.substring(0, r) + i
            }
            return e
        },
        getCharByte: function(e) {
            ...
            var t = 0
              , i = escape(e);
            return 1 == i.length ? t++ : -1 != i.indexOf("%u") ? t += 2 : -1 != i.indexOf("%") && (t += i.length / 3),
            t
        },
        getFilteredHashTable: function(e, t) {
            if (!(t instanceof Array))
                return arguments.callee.call(this, e, [t]);
            var i = jindo.$A(t);
            ...
            function t(e) {
                ...
                if ("P" == e.tagName) {
                    ...
                    if (1 == e.childNodes.length) {
                        if ("IMG" == e.firstChild.tagName || "IFRAME" == e.firstChild.tagName)
                            return !1;
                        if (n(e.firstChild))
                            return !0
                    }
        ...
        findClosestAncestorAmongTagNames: function(e, t) {
            for (var i = new RegExp("^(" + e.join("|") + ")$","i"); t && !i.test(t.tagName); )
                t = t.parentNode;
            return t
        },
        findClosestAncestorAmongTagNamesWithCount: function(e, t) {
            for (var i = 0, n = new RegExp("^(" + e.join("|") + ")$","i"); t && !n.test(t.tagName); )
                t = t.parentNode,
                i += 1;
            return {
                elNode: t,
        ...
        loadCSS: function(e, t) {
            ...
            t && ("onload"in o ? o.onload = function() {
                t(),
                this.onload = null
            }
            : o.onreadystatechange = function() {
                "complete" == o.readyState && (o.getAttribute("_complete") || (o.setAttribute("_complete", !0),
                t()))
            }
            ),
            n.appendChild(o)
        ...
        clone: function(e, t) {
            if (void 0 === e || !e || e.constructor != Array && e.constructor != Object)
                return e;
            var i = e.constructor == Array ? [] : {};
            for (var n in e)
                void 0 !== t && t[n] ? i[n] = arguments.callee(t[n]) : i[n] = arguments.callee(e[n]);
            return i
        },
                ...
                if ("string" == typeof t && t)
                    if ("/" != t.substr(0, 1)) {
                        var h = "string" == typeof i && i
                          , d = "string" == typeof n && n
                          , c = !h && d ? "" : {};
                        if ("undefined" == typeof (r = T.stack[l])[t])
                            r[t] = c,
                            r = T.stack[1 + l] = r[t];
                    ...
                    "string" == typeof o && o ? a = o : "string" == typeof s && s.replace(S, "") && (a = g(s));
                if (0 < a.length) {
                    var p = T.stack[l - 1]
                      , E = T.tags[l];
                    if (A.test(a) || "true" != a && "false" != a || (a = new Boolean(a)),
                    void 0 === p)
                        return;
                    if (p[E]instanceof Array) {
                        var u = p[E];
                        "object" != typeof u[u.length - 1] || f(u[u.length - 1]) ? u[u.length - 1] = a : (u[u.length - 1].$cdata = a,
                        u[u.length - 1].toString = function() {
                            return a
                        }
                        )
                    } else
                        "object" != typeof p[E] || f(p[E]) ? p[E] = a : (p[E].$cdata = a,
    ...
    nhn.husky.AutoResizer = jindo.$Class({
        ...
        $init: function(e, t) {
            ...
            for (this.nMinHeight = t.nMinHeight,
            this.wfnCallback = t.wfnCallback,
            this.elContainer = e.parentNode,
            this.welTextArea = jindo.$Element(e),
            this.welHiddenDiv = jindo.$Element("<div>"),
            this.wfnResize = jindo.$Fn(this._resize, this),
            this.sOverflow = this.welTextArea.css("overflow"),
            this.welTextArea.css("overflow", "hidden"); n--; )
                o[i[n]] = this.welTextArea.css(i[n]);
            this.welHiddenDiv.css(o),
            this.nLastHeight = this.welTextArea.height()
        },
        bind: function() {
            this.welCloneDiv = jindo.$Element(this.welHiddenDiv.$value().cloneNode(!1)),
        ...
        unbind: function() {
            ...
            this.welCloneDiv && this.welCloneDiv.leave()
        },
        _resize: function() {
            ...
            (e = this.welCloneDiv.height()) < this.nMinHeight && (e = this.nMinHeight),
            this.welTextArea.css("height", e + "px"),
            this.elContainer.style.height = e + "px",
            this.nLastHeight < e && (i = !0),
            this.wfnCallback(i))
        }
    }),
    "undefined" == typeof window.StringBuffer && (window.StringBuffer = {}),
    StringBuffer = function(e) {
        this._aString = [],
        void 0 !== e && this.append(e)
    }
    ,
    StringBuffer.prototype.append = function(e) {
        return this._aString.push(e),
        this
    }
    ,
    ...
    a = null,
    l = /,/gi,
    window.IsInstalledFont = function(e) {
        ...
        (a = a || document.createElement("div")).innerHTML = "mmmmiiiii" + unescape("%uD55C%uAE00"),
        a.style.cssText = i + 'font-family:"' + t + '" !important';
...
, function(e, t) {
    nhn.husky.SE2B_CSSLoader = jindo.$Class({
        ...
        $init: function() {
            if (this.htOptions = nhn.husky.SE2M_Configuration.SE2B_CSSLoader,
            jindo.$Agent().navigator().ie) {
                for (var e = 0, t = this.aInstantLoadTrigger.length; e < t; e++)
                    this["$BEFORE_" + this.aInstantLoadTrigger[e]] = jindo.$Fn(function() {
                        this.loadSE2CSS()
                    }, this).bind();
                for (e = 0,
                t = this.aDelayedLoadTrigger.length; e < t; e++) {
                    var i = this.aDelayedLoadTrigger[e];
                    this["$BEFORE_" + this.aDelayedLoadTrigger[e]] = jindo.$Fn(function(e) {
                        var t = jindo.$A(arguments).$value();
                        return t = t.splice(1, t.length - 1),
                        this.loadSE2CSS(e, t)
                    }, this).bind(i)
                }
            } else
        ...
        loadSE2CSS: function(e, t) {
            ...
            var n = this.htOptions.sCSSBaseURI
              , o = this.oApp && this.oApp.htOptions.I18N_LOCALE;
            return o && (n += "/" + o),
            n += "/smart_editor2_items.css",
            nhn.husky.SE2M_Utils.loadCSS(n, i),
            !1
        }
    })
}
...
, function(e, t) {
    nhn.husky.SE_OuterIFrameControl = jindo.$Class({
        ...
        $init: function(e) {
            ...
            this._assignHTMLObjects(e),
            this.$FnKeyDown = jindo.$Fn(this._keydown, this),
            this.oResizeGrip && this.$FnKeyDown.attach(this.oResizeGrip, "keydown"),
            jindo.$Agent().navigator().ie && (this.$FnMouseDown = jindo.$Fn(this._mousedown, this),
            this.$FnMouseMove = jindo.$Fn(this._mousemove, this),
            this.$FnMouseMove_Parent = jindo.$Fn(this._mousemove_parent, this),
            this.$FnMouseUp = jindo.$Fn(this._mouseup, this),
            this.oResizeGrip && this.$FnMouseDown.attach(this.oResizeGrip, "mousedown"))
        },
        _assignHTMLObjects: function(e) {
            e = jindo.$(e) || document,
            this.oResizeGrip = jindo.cssquery.getSingle(".husky_seditor_editingArea_verticalResizer", e),
        ...
        _keydown: function(e) {
            var t = e.key();
            33 <= t.keyCode && t.keyCode <= 40 && (this.oApp.exec("MSG_EDITING_AREA_RESIZE_STARTED", []),
            this.oApp.exec("RESIZE_EDITING_AREA_BY", [0, this.aHeightChangeKeyMap[t.keyCode - 33]]),
            this.oApp.exec("MSG_EDITING_AREA_RESIZE_ENDED", []),
            e.stop())
        },
        _mousedown: function(e) {
...
, function(e, t) {
    nhn.husky.SE_ToolbarToggler = jindo.$Class({
        ...
        _assignHTMLObjects: function(e, t) {
            e = jindo.$(e) || document,
            this.toolbarArea = jindo.cssquery.getSingle(".se2_tool", e),
            this.toolbarArea.style.display = void 0 === t || !0 === t ? "block" : "none"
        },
        $ON_MSG_APP_READY: function() {
            this.oApp.exec("REGISTER_HOTKEY", ["ctrl+t", "SE_TOGGLE_TOOLBAR", []])
        },
        $ON_SE_TOGGLE_TOOLBAR: function() {
            this.toolbarArea.style.display = "none" == this.toolbarArea.style.display ? "block" : "none",
            this.oApp.exec("MSG_EDITING_AREA_SIZE_CHANGED", [])
        }
    })
}
...
, function(e, t) {
    ...
    nhn.husky.HuskyCore.mixin(nhn.husky.SE2M_FindReplacePlugin, {
        _assignHTMLElements: function() {
            ...
            this.elDropdownLayer = jindo.$$.getSingle("DIV.husky_se2m_findAndReplace_layer", e),
            this.welDropdownLayer = jindo.$Element(this.elDropdownLayer);
            var t = jindo.$$("LI", this.elDropdownLayer);
            this.oFindTab = t[0],
            this.oReplaceTab = t[1],
            t = jindo.$$(".container > .bx", this.elDropdownLayer),
            ...
            t = jindo.$$("INPUT", this.oReplaceInputSet),
            this.oReplaceInput_Original = t[0],
            this.oReplaceInput_Replacement = t[1],
        ...
        $LOCAL_BEFORE_FIRST: function() {
            ...
            this.htOffsetPos = jindo.$Element(i).offset(),
            this.nEditorWidth = i.offsetWidth,
        ...
        $ON_FIND_REPLACE_LAYER_SHOWN: function() {
            ...
            this.bFindMode ? (this.oFindInput_Keyword.value = "_clear_",
            this.oFindInput_Keyword.value = "",
            this.oFindInput_Keyword.focus()) : (this.oReplaceInput_Original.value = "_clear_",
            this.oReplaceInput_Original.value = "",
            this.oReplaceInput_Replacement.value = "",
        ...
        $ON_REPLACE: function() {
            ...
            switch (this.oApp.exec("RECORD_UNDO_AFTER_ACTION", ["REPLACE"]),
            n) {
            case 1:
            case 3:
                alert(this.oApp.$MSG("SE_FindReplace.keywordNotFound")),
        ...
        $ON_REPLACE_ALL: function() {
            ...
            0 === n ? (alert(this.oApp.$MSG("SE_FindReplace.replaceKeywordNotFound")),
            i.select(),
            this.oApp.exec("FOCUS")) : n < 0 ? (alert(this.oApp.$MSG("SE_FindReplace.keywordMissing")),
            i.select()) : (alert(this.oApp.$MSG("SE_FindReplace.replaceAllResultP1") + n + this.oApp.$MSG("SE_FindReplace.replaceAllResultP2")),
            (i = this.oApp.getEmptySelection()).select(),
            this.oApp.exec("FOCUS"))
        }
    })
}
, function(e, t) {
    ...
    nhn.husky.HuskyCore.mixin(nhn.husky.SE2M_Quote, {
        ...
        $ON_APPLY_BLOCKQUOTE: function(e) {
            e.match(/(se2_quote[0-9]+)/) ? this._wrapBlock("BLOCKQUOTE", RegExp.$1) : this._unwrapBlock("BLOCKQUOTE"),
            this.oApp.exec("HIDE_ACTIVE_LAYER", [])
        },
        _isExceedMaxDepth: function(e) {
            var o = function(e) {
                var t = e.firstChild
                  ...
                  , n = 0;
                if (!t)
                    return e.tagName && "BLOCKQUOTE" === e.tagName ? 1 : 0;
                for (; t; ) {
                    if (1 === t.nodeType && (i = o(t),
                    "BLOCKQUOTE" === t.tagName && (i += 1),
                    n < i && (n = i),
                    n >= this.nMaxLevel))
                        return n;
                    t = t.nextSibling
        ...
        _unwrapBlock: function(e) {
            for (var t = this.oApp.getSelection(), i = t.commonAncestorContainer; i && i.tagName != e; )
                i = i.parentNode;
            if (i) {
        ...
        _wrapBlock: function(e, t) {
            ...
            o = (n = (i = this.oApp.getSelection()).startContainer === i.endContainer && 1 === i.startContainer.nodeType && "P" === i.startContainer.tagName && (nhn.husky.SE2M_Utils.isBlankNode(i.startContainer) || nhn.husky.SE2M_Utils.isFirstChildOfNode("IMG", i.startContainer.tagName, i.startContainer) || nhn.husky.SE2M_Utils.isFirstChildOfNode("IFRAME", i.startContainer.tagName, i.startContainer)) ? i.getLineInfo(!0) : i.getLineInfo(!1)).oStart,
            s = n.oEnd,
            r = o.bParentBreak && !m.test(o.oLineBreaker.tagName) ? o.oNode.parentNode : o.oNode,
            a = s.bParentBreak && !m.test(s.oLineBreaker.tagName) ? s.oNode.parentNode : s.oNode,
            i.setStartBefore(r),
            i.setEndAfter(a),
            (l = this._expandToTableStart(i, a)) && (a = l,
            i.setEndAfter(l)),
            (l = this._expandToTableStart(i, r)) && (r = l,
            i.setStartBefore(l)),
            l = r,
            i.fixCommonAncestorContainer(),
            h = i.commonAncestorContainer,
            d = i.startContainer == i.endContainer && i.endOffset - i.startOffset == 1 ? i.startContainer.childNodes[i.startOffset] : i.commonAncestorContainer,
            c = this._findParentQuote(d))
                return c.className = t,
                void this._setStyle(c, this.htQuoteStyles_view[t]);
            for (; !h.tagName || h.tagName && h.tagName.match(/UL|OL|LI|IMG|IFRAME/); )
                h = h.parentNode;
            for (; l && l != h && l.parentNode != h; )
                l = l.parentNode;
            if (_ = l == h ? h.firstChild : l,
            p = i._document.createElement(e),
            t && (p.className = t,
            this._setStyle(p, this.htQuoteStyles_view[t])),
            h.insertBefore(p, _),
            i.setStartAfter(p),
            i.setEndAfter(a),
            i.surroundContents(p),
            !this._isExceedMaxDepth(p))
                return i.selectNodeContents(p),
                p && p.parentNode && "BODY" == p.parentNode.tagName && !p.nextSibling && ((T = i._document.createElement("P")).innerHTML = "&nbsp;",
                p.parentNode.insertBefore(T, p.nextSibling)),
                nhn.husky.SE2M_Utils.isBlankNode(p) && (p.innerHTML = "&nbsp;",
                i.selectNodeContents(p.firstChild),
                i.collapseToStart(),
                i.select()),
                setTimeout(jindo.$Fn(function(e) {
                    C = e.placeStringBookmark(),
                    e.select(),
                    e.removeStringBookmark(C),
                    this.oApp.exec("FOCUS")
                }, this).bind(i), 0),
                ...
                p;
            for (alert(this.oApp.$MSG("SE2M_Quote.exceedMaxCount").replace("#MaxCount#", this.nMaxLevel + 1)),
            this.oApp.exec("HIDE_ACTIVE_LAYER", []),
            E = p.nextSibling,
            u = p.parentNode,
            g = p.childNodes,
            f = [],
            jindo.$Element(p).leave(),
            A = 0,
            S = g.length; A < S; A++)
                f[A] = g[A];
            for (A = 0,
            S = f.length; A < S; A++)
                E ? jindo.$Element(E).before(f[A]) : jindo.$Element(u).append(f[A])
        },
        _expandToTableStart: function(e, t) {
            for (var i = e.commonAncestorContainer, n = null, o = !1; t && !o; ) {
                if (t == i && (o = !0),
                /TBODY|TFOOT|THEAD|TR/i.test(t.tagName)) {
...
, function(e, t) {
    ...
    nhn.husky.HuskyCore.mixin(nhn.husky.SE2M_SCharacter, {
        _assignHTMLObjects: function(e) {
            e = jindo.$(e) || document,
            this.elDropdownLayer = jindo.$$.getSingle("DIV.husky_seditor_sCharacter_layer", e),
        ...
        $LOCAL_BEFORE_FIRST: function() {
            ...
            jindo.$Fn(e, this).attach(this.oInsertButton, "click"),
            ...
            for (t = 0; t < this.aCloseButton.length; t++)
                this.oApp.registerBrowserEvent(this.aCloseButton[t], "click", "HIDE_ACTIVE_LAYER", []);
        ...
        $ON_EVENT_SCHARACTER_KEYDOWN: function(e) {
            e.key().enter && (this.oApp.exec("INSERT_SCHARACTERS"),
            e.stop())
        },
        ...
        $ON_EVENT_SCHARACTER_CLICKED: function(e) {
            ...
            if (t && "BUTTON" == t.tagName && "LI" == t.parentNode.tagName) {
                ...
                1 < i.length || (this.oApp.exec("SELECT_SCHARACTER", [i]),
                e.stop())
            }
        },
        $ON_SELECT_SCHARACTER: function(e) {
            if (this.oTextField.value += e,
            this.oTextField.createTextRange) {
                var t = this.oTextField.createTextRange();
                t.collapse(!1),
                t.select()
            } else
                this.oTextField.selectionEnd && (this.oTextField.selectionEnd = this.oTextField.value.length,
                this.oTextField.focus())
        },
        ...
        $ON_CHANGE_SCHARACTER_SET: function(e) {
            ...
            this._drawSCharList(e),
            jindo.$Element(this.aLabel[e]).addClass("active")
        },
        ...
        _drawSCharList: function(e) {
            if (!this.bSCharSetDrawn[e]) {
                ...
                for (var s = 0; s < n; s++)
                    o[s] = jindo.$("<LI>"),
                    this.bIE ? (t = jindo.$("<BUTTON>")).setAttribute("type", "button") : (t = jindo.$("<BUTTON>")).type = "button",
                    (i = jindo.$("<SPAN>")).innerHTML = unescape(this.charSet[e][s]),
                    t.appendChild(i),
                    o[s].appendChild(t),
                    o[s].onmouseover = function() {
...
, function(e, t) {
    ...
    nhn.husky.HuskyCore.mixin(nhn.husky.SE2M_TableCreator, {
        _assignHTMLObjects: function(e) {
            ...
            var t = null;
            this.elDropdownLayer = jindo.$$.getSingle("DIV.husky_se2m_table_layer", e),
            this.welDropdownLayer = jindo.$Element(this.elDropdownLayer),
            t = jindo.$$("INPUT", this.elDropdownLayer),
            this.elText_row = t[0],
            this.elText_col = t[1],
            this.elRadio_manualStyle = t[2],
            this.elText_borderSize = t[3],
            this.elText_borderColor = t[4],
            this.elText_BGColor = t[5],
            this.elRadio_templateStyle = t[6],
            t = jindo.$$("BUTTON", this.elDropdownLayer),
            this.elBtn_rowInc = t[0],
            this.elBtn_rowDec = t[1],
            this.elBtn_colInc = t[2],
            this.elBtn_colDec = t[3],
            this.elBtn_borderStyle = t[4],
            ...
            t = jindo.$$("SPAN.se2_pre_color>BUTTON", this.elDropdownLayer),
            this.elBtn_borderColor = t[0],
            this.elBtn_BGColor = t[1],
            this.elBtn_tableStyle = jindo.$$.getSingle("DIV.se2_select_ty2>BUTTON", this.elDropdownLayer),
            t = jindo.$$("P.se2_btn_area>BUTTON", this.elDropdownLayer),
            this.elBtn_apply = t[0],
            this.elBtn_cancel = t[1],
        ...
        $LOCAL_BEFORE_FIRST: function() {
            ...
            e = 0; e < this.aElBtn_borderStyle.length; e++)
                this.oApp.registerBrowserEvent(this.aElBtn_borderStyle[e], "click", "TABLE_SELECT_BORDER_STYLE");
            for (e = 0; e < this.aElBtn_tableStyle.length; e++)
                this.oApp.registerBrowserEvent(this.aElBtn_tableStyle[e], "click", "TABLE_SELECT_STYLE");
        ...
        $ON_TABLE_SET_ROW_NUM: function(e, t) {
            e = e || parseInt(this.elText_row.value, 10) || 0,
            (e += t = t || 0) < this.nMinRows && (e = this.nMinRows),
            e > this.nMaxRows && (e = this.nMaxRows),
            this.elText_row.value = e,
            this._showNewTable()
        },
        $ON_TABLE_SET_COLUMN_NUM: function(e, t) {
            e = e || parseInt(this.elText_col.value, 10) || 0,
            (e += t = t || 0) < this.nMinColumns && (e = this.nMinColumns),
            e > this.nMaxColumns && (e = this.nMaxColumns),
            this.elText_col.value = e,
            this._showNewTable()
        },
        ...
        $ON_TABLE_INSERT: function() {
            ...
            i = this.oApp.getWYSIWYGDocument().body,
            l = jindo.$Agent().navigator(),
            this.nTableWidth = i.offsetWidth,
            e = this._getTableString(),
            (n = this.oApp.getWYSIWYGDocument().createElement("DIV")).innerHTML = e,
            (o = n.firstChild).className = this._sSETblClass,
            r = this.oApp.getSelection(),
            r = this._divideParagraph(r),
            this.oApp.exec("RECORD_UNDO_BEFORE_ACTION", ["INSERT TABLE", {
                sSaveTarget: "BODY"
            }]),
            a = this.oApp.getWYSIWYGDocument().createElement("DIV"),
            r.deleteContents(),
            r.insertNode(a),
            r.selectNode(a),
            this.oApp.exec("REMOVE_STYLE", [r]),
            l.ie && 1 === this.oApp.getWYSIWYGDocument().body.childNodes.length && this.oApp.getWYSIWYGDocument().body.firstChild === a ? a.insertBefore(o, null) : (a.parentNode.insertBefore(o, a),
            a.parentNode.removeChild(a)),
            l.firefox ? (t = this.oApp.getWYSIWYGDocument().createElement("BR"),
            o.parentNode.insertBefore(t, o.nextSibling)) : l.ie && (t = this.oApp.getWYSIWYGDocument().createElement("p"),
            11 == document.documentMode && (t.innerHTML = "<br>"),
            o.parentNode.insertBefore(t, o.nextSibling)),
            2 == this.nStyleMode && this.oApp.exec("STYLE_TABLE", [o, this.nTableStyleIdx]),
            s = o.getElementsByTagName("TD")[0],
            r.selectNodeContents(s.firstChild || s),
            r.collapseToEnd(),
            r.select(),
            this.oApp.exec("FOCUS"),
        ...
        _divideParagraph: function(e) {
            ...
            var r = e.commonAncestorContainer
              , a = nhn.husky.SE2M_Utils.findAncestorByTagNameWithCount("P", r)
              , l = a.elNode;
            if (l) {
                var h = nhn.husky.SE2M_Utils.findClosestAncestorAmongTagNamesWithCount(["TD", "TH"], r);
                if (h.elNode)
                    a.nRecursiveCount < h.nRecursiveCount && (t = l);
                else
                    t = l
            }
            return t && (!t.firstChild || nhn.husky.SE2M_Utils.isBlankNode(t) ? e.selectNode(t) : (n = e.placeStringBookmark(),
            e.moveToBookmark(n),
            o = this.oApp.getWYSIWYGDocument().createElement("P"),
            e.setStartBefore(t.firstChild),
            e.surroundContents(o),
            e.collapseToEnd(),
            s = this.oApp.getWYSIWYGDocument().createElement("P"),
            e.setEndAfter(t.lastChild),
            e.surroundContents(s),
            e.collapseToStart(),
            e.removeStringBookmark(n),
            (i = jindo.$Element(t)).after(s),
            i.after(o),
            i.leave(),
            (e = this.oApp.getEmptySelection()).setEndAfter(o),
            e.setStartBefore(s)),
            e.select()),
            e
        },
        ...
        $ON_TABLE_SET_BORDER_SIZE: function(e, t) {
            e = e || parseInt(this.elText_borderSize.value, 10) || 0,
            (e += t = t || 0) < this.nMinBorderWidth && (e = this.nMinBorderWidth),
            e > this.nMaxBorderWidth && (e = this.nMaxBorderWidth),
            this.elText_borderSize.value = e
        },
        ...
        $ON_TABLE_SET_BORDER_COLOR_FROM_PALETTE: function(e) {
            this.oApp.exec("TABLE_SET_BORDER_COLOR", [e]),
            this.oApp.exec("TABLE_HIDE_BORDER_COLOR_PALLET", [])
        },
        $ON_TABLE_SET_BORDER_COLOR: function(e) {
            this.elText_borderColor.value = e,
            this.elBtn_borderColor.style.backgroundColor = e
        },
        $ON_TABLE_SET_BGCOLOR_FROM_PALETTE: function(e) {
            this.oApp.exec("TABLE_SET_BGCOLOR", [e]),
            this.oApp.exec("TABLE_HIDE_BGCOLOR_PALLET", [])
        },
        $ON_TABLE_SET_BGCOLOR: function(e) {
            this.elText_BGColor.value = e,
            this.elBtn_BGColor.style.backgroundColor = e
        },
        ...
        $ON_EVENT_TABLE_CREATE_KEYDOWN: function(e) {
            e.key().enter && (this.elBtn_apply.focus(),
            this.oApp.exec("TABLE_INSERT"),
            e.stop())
        },
        _drawTableDropdownLayer: function() {
            1 == this.nBorderStyleIdx ? (this.elPanel_borderStylePreview.innerHTML = this.sNoBorderText,
            this.elLayer_Dim1.className = "se2_t_dim2") : (this.elPanel_borderStylePreview.innerHTML = "",
            this.elLayer_Dim1.className = "se2_t_dim0"),
            1 == this.nStyleMode ? (this.elRadio_manualStyle.checked = !0,
            this.elLayer_Dim2.className = "se2_t_dim3",
            this.elText_borderSize.disabled = !1,
            this.elText_borderColor.disabled = !1,
            this.elText_BGColor.disabled = !1) : (this.elRadio_templateStyle.checked = !0,
            this.elLayer_Dim2.className = "se2_t_dim1",
            this.elText_borderSize.disabled = !0,
            this.elText_borderColor.disabled = !0,
            this.elText_BGColor.disabled = !0),
            this.oApp.exec("TABLE_CLOSE_ALL", [])
        },
        _selectBorderStyle: function(e) {
            this.elPanel_borderStylePreview.className = "se2_b_style" + e,
            this.nBorderStyleIdx = e,
            this._drawTableDropdownLayer()
        },
        _selectTableStyle: function(e) {
            this.elPanel_tableStylePreview.className = "se2_t_style" + e,
            this.nTableStyleIdx = e,
            this._drawTableDropdownLayer()
        },
        _showNewTable: function() {
            var e = document.createElement("DIV");
            this._loadValuesFromHTML(),
            e.innerHTML = this._getPreviewTableString(this.nColumns, this.nRows);
            var t = e.firstChild;
            this.elTable_preview.parentNode.insertBefore(t, this.elTable_preview),
            this.elTable_preview.parentNode.removeChild(this.elTable_preview),
            this.elTable_preview = t,
            this._refresh()
        },
        _getPreviewTableString: function(e, t) {
            for (var i = '<table border="0" cellspacing="1" class="se2_pre_table husky_se2m_table_preview">', n = "<tr>", o = 0; o < e; o++)
                n += "<td><p>&nbsp;</p></td>\n";
            for (n += "</tr>\n",
            i += "<tbody>",
            o = 0; o < t; o++)
        ...
        _doGetTableString: function(e, t, i, n, o, s) {
            ...
            for (var h = "<table " + a + " " + (1 == s ? 'attr_no_border_tbl="1"' : "") + ">", d = "<tr>", c = 0; c < e; c++)
                d += "<td " + l + "><p>&nbsp;</p></td>\n";
            for (d += "</tr>\n",
            h += "<tbody>\n",
            c = 0; c < t; c++)
        ...
        _numRowKeydown: function(e) {
            var t = e.key();
            38 == t.keyCode && this.oApp.exec("TABLE_INC_ROW", []),
            40 == t.keyCode && this.oApp.exec("TABLE_DEC_ROW", [])
        },
        _numColKeydown: function(e) {
            var t = e.key();
            38 == t.keyCode && this.oApp.exec("TABLE_INC_COLUMN", []),
            40 == t.keyCode && this.oApp.exec("TABLE_DEC_COLUMN", [])
        },
        _borderSizeKeydown: function(e) {
            var t = e.key();
            38 == t.keyCode && this.oApp.exec("TABLE_INC_BORDER_SIZE", []),
            40 == t.keyCode && this.oApp.exec("TABLE_DEC_BORDER_SIZE", [])
        },
        _refresh: function() {
...
, function(e, t) {
    ...
    nhn.husky.HuskyCore.mixin(nhn.husky.SE2M_TableEditor, {
        ...
        _assignHTMLObjects: function() {
            ...
            for (var e = 0; e < this.aElBtn_tableStyle.length; e++)
                this.oApp.registerBrowserEvent(this.aElBtn_tableStyle[e], "click", "TABLE_QE_SELECT_TEMPLATE")
        },
        _attachEvents: function() {
            ...
            e.ie && 8 < e.version && (this._wfnOnResizeEndTable = jindo.$Fn(this._fnOnResizeEndTable, this).bind()),
        ...
        $LOCAL_BEFORE_FIRST: function(e) {
            if (-1 < e.indexOf("REGISTER_CONVERTERS"))
                return this.oApp.acceptLocalBeforeFirstAgain(this, !0),
                !0;
            this.htResizing = {},
            this.nDraggableCellEdge = 2;
            var t = jindo.$Element(document.body);
            this.nPageLeftRightMargin = parseInt(t.css("marginLeft"), 10) + parseInt(t.css("marginRight"), 10),
            this.nPageTopBottomMargin = parseInt(t.css("marginTop"), 10) + parseInt(t.css("marginBottom"), 10),
            ...
            this.sEmptyTDSrc = "",
            this.oApp.oNavigator.firefox ? this.sEmptyTDSrc = "<p><br/></p>" : this.sEmptyTDSrc = "<p>&nbsp;</p>",
        ...
        $ON_EVENT_EDITING_AREA_KEYUP: function(e) {
            var t = e.key();
            if (229 != t.keyCode && !t.alt && !t.ctrl && 16 != t.keyCode)
                switch (8 != t.keyCode && 46 != t.keyCode || (this.oApp.exec("DELETE_BLOCK_CONTENTS"),
                e.stop()),
                this.nStatus) {
        ...
        $ON_TABLE_QE_SELECT_TEMPLATE: function(e) {
            ...
            this._changeTableEditorStatus(this.STATUS.S_0),
            this.oApp.exec("STYLE_TABLE", [i, t[1]]);
            var n = i && i.parentNode ? i.parentNode : null
              , o = i ? null : "BODY";
        ...
        $ON_TABLE_QE_SET_BGC_FROM_PALETTE: function(e) {
            this.oApp.exec("TABLE_QE_SET_BGC", [e]),
            this.oSelection && this.oSelection.select(),
            this._changeTableEditorStatus(this.STATUS.S_0)
        },
        $ON_TABLE_QE_SET_BGC: function(e) {
            this.elBtnBGPalette.style.backgroundColor = e;
            for (var t = 0, i = this.aSelectedCells.length; t < i; t++)
                this.aSelectedCells[t].setAttribute(this.TMP_BGC_ATTR, e),
                this.aSelectedCells[t].removeAttribute(this.TMP_BGIMG_ATTR);
        ...
        $ON_TABLE_QE_SET_IMG_FROM_PALETTE: function(e) {
            this.oApp.exec("TABLE_QE_SET_IMG", [e.element]),
            this.oSelection && this.oSelection.select(),
            this._changeTableEditorStatus(this.STATUS.S_0)
        },
        $ON_TABLE_QE_SET_IMG: function(e) {
            for (var t = jindo.$Element(e).className(), i = jindo.$Element(this.elBtnBGIMGPalette), n = i.className().split(" "), o = 0, s = n.length; o < s; o++)
                0 < n[o].indexOf("cellimg") && i.removeClass(n[o]);
            jindo.$Element(this.elBtnBGIMGPalette).addClass(t);
            var r = t.substring(11, t.length)
              , a = "pattern_";
            if ("0" === r)
                for (o = 0,
                s = this.aSelectedCells.length; o < s; o++)
                    jindo.$Element(this.aSelectedCells[o]).css("backgroundImage", ""),
                    this.aSelectedCells[o].removeAttribute(this.TMP_BGC_ATTR),
                    this.aSelectedCells[o].removeAttribute(this.TMP_BGIMG_ATTR);
            else {
                ...
                for (o = 0,
                s = this.aSelectedCells.length; o < s; o++)
                    jindo.$Element(this.aSelectedCells[o]).css("backgroundImage", "url(" + l + ")"),
                    this.aSelectedCells[o].removeAttribute(this.TMP_BGC_ATTR),
                    this.aSelectedCells[o].setAttribute(this.TMP_BGIMG_ATTR, "url(" + l + ")")
            }
        ...
        $ON_CLOSE_SUB_LAYER_QE: function() {
            "undefined" != typeof this.elPanelBGPaletteHolder && (this.elPanelBGPaletteHolder.parentNode.style.display = "none"),
            "undefined" != typeof this.elPanelBGIMGPaletteHolder && (this.elPanelBGIMGPaletteHolder.parentNode.style.display = "none")
        },
        $ON_SETUP_TABLE_QE_MODE: function(e) {
            var t = !0;
            "number" == typeof e && (this.nQEMode = e),
            this.aSelectedCells.length < 2 && (t = !1),
            this.oApp.exec("TABLE_QE_DIM", [this.QE_DIM_MERGE_BTN, t]);
            for (var i = this.aSelectedCells[0].getAttribute(this.TMP_BGC_ATTR) || "rgb(255,255,255)", n = !0, o = 1, s = this.aSelectedCells.length; o < s; o++)
            ...
            var r, a = this.aSelectedCells[0].getAttribute(this.TMP_BGIMG_ATTR) || "", l = !0, h = 0, d = jindo.$Element(this.elBtnBGIMGPalette);
            if (a) {
                var c = a.match(/_[0-9]*/);
                for (h = (r = c ? c[0] : "_0").substring(1, r.length),
                o = 1,
                s = this.aSelectedCells.length; o < s; o++)
                    if (a != this.aSelectedCells[o].getAttribute(this.TMP_BGIMG_ATTR)) {
                        l = !1;
                        break
                    }
            }
            ...
            s = _.length;
            for (var p = 0; p < s; p++)
                0 < _[p].indexOf("cellimg") && d.removeClass(_[p]);
            if (l && 0 < h ? d.addClass("se2_cellimg" + h) : d.addClass("se2_cellimg0"),
            0 === this.nQEMode) {
                ...
                E || (this.elInputRadioBGColor.checked = "true",
                E = 1),
                this.elPanelQETemplatePreview.className = "se2_t_style" + E,
                this.elPanelBGImg.style.position = ""
            } else
                1 == this.nQEMode ? (this.elPanelTableTemplateArea.style.display = "none",
                this.elPanelReviewBGArea.style.display = "block",
                E = this.parseIntOr0(this.elSelectionStartTable.getAttribute(this.ATTR_REVIEW_TEMPLATE)),
                this.elPanelBGImg.style.position = "relative") : (this.elPanelTableTemplateArea.style.display = "none",
                this.elPanelReviewBGArea.style.display = "none");
            this.oApp.exec("DRAW_QE_RADIO_OPTION", [0])
        },
        $ON_DRAW_QE_RADIO_OPTION: function(e) {
            0 !== e && 2 != e && this.oApp.exec("HIDE_TABLE_QE_BGC_PALETTE", []),
            0 !== e && 3 != e && this.oApp.exec("HIDE_TABLE_QE_IMG_PALETTE", []),
            0 !== e && 4 != e && this.oApp.exec("TABLE_QE_HIDE_TEMPLATE", []),
            0 === this.nQEMode ? (this.elInputRadioBGImg.checked && (this.elInputRadioBGColor.checked = "true"),
            this.elInputRadioBGColor.checked ? this.oApp.exec("TABLE_QE_DIM", [this.QE_DIM_TABLE_TEMPLATE, !1]) : this.oApp.exec("TABLE_QE_DIM", [this.QE_DIM_BG_COLOR, !1])) : (this.elInputRadioTemplate.checked && (this.elInputRadioBGColor.checked = "true"),
            this.elInputRadioBGColor.checked ? this.oApp.exec("TABLE_QE_DIM", [this.QE_DIM_REVIEW_BG_IMG, !1]) : this.oApp.exec("TABLE_QE_DIM", [this.QE_DIM_BG_COLOR, !1]))
        },
        $ON_TABLE_QE_DIM: function(e, t) {
            var i;
            i = 1 == e ? this.elPanelDim1 : this.elPanelDim2,
            t && (e = 0),
            i.className = "se2_qdim" + e
        },
        $ON_TE_SELECT_TABLE: function(e) {
            this.elSelectionStartTable = e,
        ...
        $ON_TE_MERGE_CELLS: function() {
            if (0 !== this.aSelectedCells.length && 1 != this.aSelectedCells.length) {
                ...
                t = this.aSelectedCells[0];
                var s, r = this.aSelectedCells[0];
                for (n = parseInt(r.style.height || r.getAttribute("height"), 10),
                o = parseInt(r.style.width || r.getAttribute("width"), 10),
                e = this.htSelectionSPos.x + 1; e < this.htSelectionEPos.x + 1; e++)
                    (s = this.htMap[e][this.htSelectionSPos.y]) != r && (r = s,
                    o += parseInt(s.style.width || s.getAttribute("width"), 10));
                for (r = this.aSelectedCells[0],
                e = this.htSelectionSPos.y + 1; e < this.htSelectionEPos.y + 1; e++)
                    (s = this.htMap[this.htSelectionSPos.x][e]) != r && (r = s,
                    n += parseInt(s.style.height || s.getAttribute("height"), 10));
                for (o && (t.style.width = o + "px"),
                n && (t.style.height = n + "px"),
                t.setAttribute("colSpan", this.htSelectionEPos.x - this.htSelectionSPos.x + 1),
                t.setAttribute("rowSpan", this.htSelectionEPos.y - this.htSelectionSPos.y + 1),
                e = 1; e < this.aSelectedCells.length; e++)
                    if ((i = this.aSelectedCells[e]).parentNode) {
                        ...
                        !a.ie || 9 != a.nativeVersion && 10 != a.nativeVersion || 9 != a.version && 10 != a.version || this._removeEmptyTextNode_IE(i),
                        i.parentNode.removeChild(i)
                    }
                this.htMap = this._getCellMapping(this.elSelectionStartTable),
        ...
        $ON_STYLE_TABLE: function(e, t) {
            e || (this._t || (this._t = 1),
            e = this.elSelectionStartTable,
            t = this._t++ % 20 + 1),
            this.oSelection && this.oSelection.select(),
            this._applyTableTemplate(e, t)
        },
        $ON_TE_DELETE_COLUMN: function() {
            0 !== this.aSelectedCells.length && (this._selectAll_Column(),
            this._deleteSelectedCells(),
            this.sQEAction = "DELETE_TABLE_COLUMN",
            this._changeTableEditorStatus(this.STATUS.S_0))
        },
        $ON_TE_DELETE_ROW: function() {
            0 !== this.aSelectedCells.length && (this._selectAll_Row(),
            this._deleteSelectedCells(),
        ...
        $ON_TE_SPLIT_COLUMN: function() {
            ...
            if (0 !== this.aSelectedCells.length) {
                this._removeClassFromSelection();
                for (var r = this.aSelectedCells[0], a = 0, l = this.aSelectedCells.length; a < l; a++)
                    if (o = this.aSelectedCells[a],
                    !(1 < (e = parseInt(o.getAttribute("colSpan"), 10) || 1)))
                        for (var h = this._getBasisCellPosition(o), d = 0; d < this.htMap[0].length; )
                            o = this.htMap[h.x][d],
                            e = parseInt(o.getAttribute("colSpan"), 10) || 1,
                            o.setAttribute("colSpan", e + 1),
                            d += parseInt(o.getAttribute("rowSpan"), 10) || 1;
                for (a = 0,
                l = this.aSelectedCells.length; a < l; a++) {
                    o = this.aSelectedCells[a],
                    t = ((e = parseInt(o.getAttribute("colSpan"), 10) || 1) / 2).toFixed(0),
                    o.setAttribute("colSpan", t),
                    (s = this._shallowCloneTD(o)).setAttribute("colSpan", e - t),
                    r = s,
                    e = parseInt(o.getAttribute("rowSpan"), 10) || 1,
                    s.setAttribute("rowSpan", e),
                    s.innerHTML = "&nbsp;",
                    (i = o.width || o.style.width) && (i = this.parseIntOr0(i),
                    o.removeAttribute("width"),
                    n = (i / 2).toFixed(),
                    o.style.width = n + "px",
                    s.style.width = i - n + "px"),
                ...
                this.htMap = this._getCellMapping(this.elSelectionStartTable),
                h = this._getBasisCellPosition(r),
                this.htSelectionEPos.x = h.x,
                this._selectCells(this.htSelectionSPos, this.htSelectionEPos),
        ...
        $ON_TE_SPLIT_ROW: function() {
            var e, t, i, n, o, s, r;
            if (0 !== this.aSelectedCells.length) {
                var a = jindo.$$(">TBODY>TR", this.elSelectionStartTable, {
                    oneTimeOffCache: !0
                });
                this._removeClassFromSelection();
                for (var l, h, d, c = 0, _ = 0, p = this.aSelectedCells.length; _ < p; _++)
                    if (n = this.aSelectedCells[_],
                    !(1 < (e = parseInt(n.getAttribute("rowSpan"), 10) || 1))) {
                        l = a[(s = this._getBasisCellPosition(n)).y],
                        r = this.oApp.getWYSIWYGDocument().createElement("TR"),
                        l.parentNode.insertBefore(r, l.nextSibling),
                        c++;
                        for (var E = 0; E < this.htMap.length; )
                            n = this.htMap[E][s.y],
                            e = parseInt(n.getAttribute("rowSpan"), 10) || 1,
                            n.setAttribute("rowSpan", e + 1),
                            E += parseInt(n.getAttribute("colSpan"), 10) || 1
                    }
                for (a = jindo.$$(">TBODY>TR", this.elSelectionStartTable, {
                    oneTimeOffCache: !0
                }),
                _ = 0,
                p = this.aSelectedCells.length; _ < p; _++) {
                    if (n = this.aSelectedCells[_],
                    t = ((e = parseInt(n.getAttribute("rowSpan"), 10) || 1) / 2).toFixed(0),
                    n.setAttribute("rowSpan", t),
                    (o = this._shallowCloneTD(n)).setAttribute("rowSpan", e - t),
                    e = parseInt(n.getAttribute("colSpan"), 10) || 1,
                    o.setAttribute("colSpan", e),
                    o.innerHTML = "&nbsp;",
                    i = n.height || n.style.height) {
                        i = this.parseIntOr0(i),
                        n.removeAttribute("height");
                        var u = (i / 2).toFixed();
                        n.style.height = u + "px",
                        o.style.height = i - u + "px"
                    }
                    var g, f = jindo.$A(a).indexOf(n.parentNode), A = a[parseInt(f, 10) + parseInt(t, 10)], S = A.childNodes, T = null;
                    h = this._getBasisCellPosition(n);
                    for (var C = 0, m = S.length; C < m; C++)
                        if ((g = S[C]).tagName && this._rxCellNames.test(g.tagName) && (d = this._getBasisCellPosition(g),
                        h.x < d.x)) {
                            T = g;
                            break
                        }
        ...
        $ON_MSG_CELL_SELECTED: function() {
            ...
            0 === this.htSelectionSPos.x && this.htSelectionEPos.x === this.htMap.length - 1 && this.oApp.exec("MSG_ROW_SELECTED"),
            0 === this.htSelectionSPos.y && this.htSelectionEPos.y === this.htMap[0].length - 1 && this.oApp.exec("MSG_COL_SELECTED"),
            this.oApp.exec("SHOW_COMMON_QE")
        },
            ...
            if (this.oApp.isWYSIWYGEnabled())
                ...
                case this.STATUS.S_0:
                    ...
                    if (t && this._rxCellNames.test(t.tagName)) {
                        ...
                        if (!jindo.$Element(i).hasClass(this._sSETblClass) && !jindo.$Element(i).hasClass(this._sSEReviewTblClass))
                            return;
                        if (!this._isValidTable(i))
                            return jindo.$Element(i).removeClass(this._sSETblClass),
                            void jindo.$Element(i).removeClass(this._sSEReviewTblClass);
                        i && (this.elSelectionStartTD = t,
                        this.elSelectionStartTable = i,
        ...
        $ON_EVENT_EDITING_AREA_MOUSEMOVE: function(e) {
            if ("WYSIWYG" == this.oApp.getEditingMode()) {
                var t = e.element
                  ...
                  , n = "onpointerup"
                  , o = "onresizeend";
                switch (i.ie && t && t.tagName && "TABLE" === t.tagName.toUpperCase() && (n in t ? t[n] = this._wfnOnResizeEndTable : o in t && (8 < i.version ? t[o] = this._wfnOnResizeEndTable : t[o] = this._getTableResizeEndHandler(t))),
                this.nStatus) {
                case this.STATUS.S_0:
                ...
                case this.STATUS.MOUSEDOWN_CELL:
                    ...
                    (s && s !== this.elSelectionStartTD || !s) && (s = s || this.elSelectionStartTD,
                    this._reassignCellSizes(this.elSelectionStartTable),
                    this._startCellSelection(),
                    this._selectBetweenCells(this.elSelectionStartTD, s));
                    break;
                case this.STATUS.CELL_SELECTING:
                    if (!(s = nhn.husky.SE2M_Utils.findClosestAncestorAmongTagNames(this._aCellName, e.element)) || s === this.elLastSelectedTD)
                        return;
                    if (nhn.husky.SE2M_Utils.findAncestorByTagName("TABLE", s) !== this.elSelectionStartTable)
                        return;
                    this.elLastSelectedTD = s,
                    this._selectBetweenCells(this.elSelectionStartTD, s);
                    break;
                case this.STATUS.CELL_SELECTED:
                }
            ...
            case this.STATUS.CELL_SELECTING:
                ...
                if (i < this.htEditingAreaPos.top) {
                    ...
                    if (0 < o) {
                        ...
                        s.selectNodeContents(this.aSelectedCells[0]),
                        s.select(),
                        s.oBrowserSelection.selectNone()
                    }
                } else
                    i > this.htEditingAreaPos.bottom && (o = this.htSelectionEPos.y) < this.htMap[0].length - 1 && (this.htSelectionEPos.y++,
                    this._selectCells(this.htSelectionSPos, this.htSelectionEPos),
                    (s = this.oApp.getSelection()).selectNodeContents(this.htMap[this.htSelectionEPos.x][this.htSelectionEPos.y]),
                    s.select(),
                    s.oBrowserSelection.selectNone());
                if (n < this.htEditingAreaPos.left) {
                    var r = this.htSelectionSPos.x;
                    0 < r && (this.htSelectionSPos.x--,
                    this._selectCells(this.htSelectionSPos, this.htSelectionEPos),
                    (s = this.oApp.getSelection()).selectNodeContents(this.aSelectedCells[0]),
                    s.select(),
                    s.oBrowserSelection.selectNone())
                } else
                    n > this.htEditingAreaPos.right && (r = this.htSelectionEPos.x) < this.htMap.length - 1 && (this.htSelectionEPos.x++,
                    this._selectCells(this.htSelectionSPos, this.htSelectionEPos),
                    (s = this.oApp.getSelection()).selectNodeContents(this.htMap[this.htSelectionEPos.x][this.htSelectionEPos.y]),
                    s.select(),
                    s.oBrowserSelection.selectNone())
        ...
        _coverResizeLayer: function() {
            ...
            this.elResizeCover.style.width = e.width - this.nPageLeftRightMargin + "px",
            this.elResizeCover.style.height = e.height - this.nPageTopBottomMargin + "px",
        ...
        _reassignCellSizes: function(e) {
            ...
            for (var i = new Array(t[0].length + t[1].length), n = 0, o = 0; o < 2; o++)
                for (var s = 0; s < t[o].length; s++) {
                    var r, a, l, h, d, c, _, p, E, u, g = t[o][s], f = jindo.$Element(g);
                    p = g.getComputedStyle ? (r = parseFloat(getComputedStyle(g).paddingLeft, 10),
                    a = parseFloat(getComputedStyle(g).paddingRight, 10),
                    l = parseFloat(getComputedStyle(g).paddingTop, 10),
                    h = parseFloat(getComputedStyle(g).paddingBottom, 10),
                    d = parseFloat(getComputedStyle(g).borderLeftWidth, 10),
                    c = parseFloat(getComputedStyle(g).borderRightWidth, 10),
                    _ = parseFloat(getComputedStyle(g).borderTopWidth, 10),
                    parseFloat(getComputedStyle(g).borderBottomWidth, 10)) : (r = this.parseIntOr0(g.style.paddingLeft),
                    a = this.parseIntOr0(g.style.paddingRight),
                    l = this.parseIntOr0(g.style.paddingTop),
                    h = this.parseIntOr0(g.style.paddingBottom),
                    d = this.parseBorder(f.css("borderLeftWidth"), f.css("borderLeftStyle")),
                    c = this.parseBorder(f.css("borderRightWidth"), f.css("borderRightStyle")),
                    _ = this.parseBorder(f.css("borderTopWidth"), f.css("borderTopStyle")),
                    this.parseBorder(f.css("borderBottomWidth"), f.css("borderBottomStyle")));
                    var A = jindo.$Element(g).attr("width")
                      , S = jindo.$Element(g).attr("height");
                    u = A || S ? (E = g.offsetWidth - (r + a + d + c) + "px",
                    g.offsetHeight - (l + h + _ + p) + "px") : (E = g.style.width,
                    g.style.height),
                    i[n++] = [g, E, u]
                }
            var T = e._nWidth
              ...
              , L = 1
              , N = 1;
            for (nhn.husky.SE2M_Utils.isNumber(T) && nhn.husky.SE2M_Utils.isNumber(C) && nhn.husky.SE2M_Utils.isNumber(m) && nhn.husky.SE2M_Utils.isNumber(R) && (L = m / T,
            N = R / C),
            e._nResizedWidth && nhn.husky.SE2M_Utils.deleteProperty(e, "_nResizedWidth"),
            e._nResizedHeight && nhn.husky.SE2M_Utils.deleteProperty(e, "_nResizedHeight"),
            s = 0; s < n; s++) {
                var O = i[s];
                O[0].removeAttribute("width"),
                O[0].removeAttribute("height"),
                O[0].style.width = parseFloat(O[1], 10) * L + "px",
                O[0].style.height = parseFloat(O[2], 10) * N + "px"
            }
        ...
        _fnOnMouseDownResizeCover: function(e) {
            this.bResizing = !0,
            this.nStartHeight = e.pos().clientY,
            this.bResizingCover = !0,
            ...
            this.nStartHeight = e.pos().clientY,
            this.nStartWidth = e.pos().clientX,
        ...
        _fnOnMouseMoveResizeCover: function(e) {
            (jindo.$Agent().navigator().chrome || jindo.$Agent().navigator().safari) && this.htResizing.nPreviousResizeMode != undefined && 0 != this.htResizing.nPreviousResizeMode && this.htResizing.nResizeMode != this.htResizing.nPreviousResizeMode && (this.htResizing.nResizeMode = this.htResizing.nPreviousResizeMode,
            this._showResizer()),
            1 == this.htResizing.nResizeMode ? this.elResizeGrid.style.left = e.pos().clientX - this.nClientXDiff - this.parseIntOr0(this.elResizeGrid.style.width) / 2 + "px" : this.elResizeGrid.style.top = e.pos().clientY - this.nClientYDiff - this.parseIntOr0(this.elResizeGrid.style.height) / 2 + "px"
        },
        _fnOnMouseUpResizeCover: function(e) {
            ...
            var t, i, n = 0, o = 0;
            2 == this.htResizing.nResizeMode && (n = e.pos().clientY - this.nStartHeight),
            1 == this.htResizing.nResizeMode && (o = e.pos().clientX - this.nStartWidth,
            -1 != this.htAllAffectedCells.nMinBefore && o < -1 * this.htAllAffectedCells.nMinBefore && (o = -1 * this.htAllAffectedCells.nMinBefore + this.MIN_CELL_WIDTH),
            -1 != this.htAllAffectedCells.nMinAfter && o > this.htAllAffectedCells.nMinAfter && (o = this.htAllAffectedCells.nMinAfter - this.MIN_CELL_WIDTH));
            for (var s = this.htAllAffectedCells.aCellsBefore, r = 0; r < s.length; r++) {
                var a = s[r];
                i = t = 0,
                t = a.style.width,
                t = isNaN(parseFloat(t, 10)) ? 0 : parseFloat(t, 10),
                t += o,
                i = a.style.height,
                i = isNaN(parseFloat(i, 10)) ? 0 : parseFloat(i, 10),
                i += n,
                a.style.width = Math.max(t, this.MIN_CELL_WIDTH) + "px",
                a.style.height = Math.max(i, this.MIN_CELL_HEIGHT) + "px"
            }
        ...
        _markResizedMetric: function(e) {
            if (e && "TABLE" === e.tagName.toUpperCase()) {
                ...
                e._nResizedWidth = t.width(),
                e._nResizedHeight = t.height()
            }
        },
        $ON_CLOSE_QE_LAYER: function(e) {
            var t, i, n = e ? e.element : null, o = n ? jindo.$Element(n) : null, s = ["q_open_table_fold", "q_open_table_full"], r = !1;
            if (o)
                for (i = s.length; i--; )
                    if (t = s[i],
                    o.hasClass(t)) {
            ...
            if (this.nStatus != e) {
                ...
                case this.STATUS.S_0:
                    if (this.nStatus == this.STATUS.MOUSEDOWN_CELL)
                        break;
                    this._deselectCells(),
                    this.sQEAction && (this.oApp.exec("RECORD_UNDO_ACTION", [this.sQEAction, {
                        elSaveTarget: this.elSelectionStartTable,
                        bDontSaveSelection: !0
                    }]),
                    this.sQEAction = ""),
                    (this.oApp.oNavigator.safari || this.oApp.oNavigator.chrome) && (this.oApp.getWYSIWYGDocument().onselectstart = null),
                ...
                case this.STATUS.CELL_SELECTED:
                    ...
                    this.oApp.oNavigator.ie && "function" == typeof document.body.releaseCapture && document.body.releaseCapture()
                }
        ...
        _isOnBorder: function(e) {
            ...
            !this._rxCellNames.test(e.element.tagName))
                return !1;
            if (this.htResizing.elTable = nhn.husky.SE2M_Utils.findAncestorByTagName("TABLE", this.htResizing.elCell),
            this.htResizing.elTable && (jindo.$Element(this.htResizing.elTable).hasClass(this._sSETblClass) || jindo.$Element(this.htResizing.elTable).hasClass(this._sSEReviewTblClass))) {
                var t, i;
                this.htResizing.nVA = 0,
                this.htResizing.nHA = 0,
                this.htResizing.nBorderLeftPos = 0,
                this.htResizing.nBorderTopPos = -1,
                this.htResizing.htEPos = e.pos(!0),
                this.htResizing.nBorderSize = this.parseIntOr0(this.htResizing.elTable.border),
                i = jindo.$Agent().navigator().ie || jindo.$Agent().navigator().safari ? (t = this.htResizing.nBorderSize + this.nDraggableCellEdge,
                this.nDraggableCellEdge) : (t = this.nDraggableCellEdge,
                this.htResizing.nBorderSize + this.nDraggableCellEdge);
                var n = this.htResizing.elCell.clientWidth
                  , o = this.htResizing.elCell.clientHeight
                  , s = n - this.htResizing.htEPos.offsetX
                  , r = o - this.htResizing.htEPos.offsetY;
                if (this.htResizing.htEPos.offsetY <= t) {
                    var a = !1
                      , l = this.htResizing.elCell.parentNode
                      , h = l.parentNode;
                    jindo.$$("tr", h, {
                        oneTimeOffCache: !0
                    })[0] == l && (a = !0),
                    a && (this.htResizing.nVA = -1,
                    this.htResizing.nResizeMode = 4)
                }
                return r <= i && (this.htResizing.nBorderTopPos = this.htResizing.elCell.offsetHeight + t - 1,
                this.htResizing.nResizeMode = 2),
                this.htResizing.htEPos.offsetX <= t && this.htResizing.elTable.scrollLeft != this.htResizing.elCell.offsetLeft && (this.htResizing.nHA = -1,
                this.htResizing.nResizeMode = 3),
                s <= t && (this.htResizing.nBorderLeftPos = this.htResizing.elCell.offsetWidth + t - 1,
                this.htResizing.nResizeMode = 1),
                (jindo.$Agent().navigator().chrome || jindo.$Agent().navigator().safari) && (this.htResizing.elPreviousCell ? this.htResizing.elCell != this.htResizing.elPreviousCell && (this.htResizing.elPreviousCell = this.htResizing.elCell) : this.htResizing.elPreviousCell = this.htResizing.elCell),
                0 !== this.htResizing.nResizeMode
            }
        },
        _showCellResizeGrip: function() {
            if (4 != this.htResizing.nResizeMode)
                if (1 == this.htResizing.nResizeMode || 3 == this.htResizing.nResizeMode ? this.elResizeCover.style.cursor = "col-resize" : 2 == this.htResizing.nResizeMode && (this.elResizeCover.style.cursor = "row-resize"),
                this._showResizer(),
                1 == this.htResizing.nResizeMode)
                    this._setResizerSize(2 * (this.htResizing.nBorderSize + this.nDraggableCellEdge), this.parseIntOr0(jindo.$Element(this.elIFrame).css("height"))),
                    ...
                    this._setResizerSize(this.parseIntOr0(e), 2 * (this.htResizing.nBorderSize + this.nDraggableCellEdge)),
                    ...
                    3 == this.htResizing.nResizeMode && (this._setResizerSize(2 * (this.htResizing.nBorderSize + this.nDraggableCellEdge), this.parseIntOr0(jindo.$Element(this.elIFrame).css("height"))),
                    this.elResizeGrid.style.top = "0px",
        ...
        _getAllAffectedCells: function(e, t, i, n) {
            ...
            if (1 == i) {
                for (var _ = 0; _ < a; _++)
                    if (!(0 < l.length && l[l.length - 1] == s[e][_])) {
                        l[l.length] = s[e][_];
                ...
                if (s.length > e + 1)
                    for (_ = 0; _ < a; _++)
                        0 < h.length && h[h.length - 1] == s[e + 1][_] || (h[h.length] = s[e + 1][_],
                        p = parseInt(s[e + 1][_].style.width),
                        (-1 == c || p < c) && (c = p));
                o = {
                    aCellsBefore: l,
                    aCellsAfter: h,
                ...
                for (var E = 0; E < r; E++)
                    0 < l.length && l[l.length - 1] == s[E][t] || (l[l.length] = s[E][t],
                    (-1 == d || d > s[E][t].style.height) && (d = s[E][t].style.height));
                o = {
                    aCellsBefore: l,
                    aCellsAfter: h,
                    nMinBefore: d,
        ...
        _deleteSelectedCells: function() {
            for (var e, t = 0, i = this.aSelectedCells.length; t < i; t++) {
                ...
                !n.ie || 9 != n.nativeVersion && 10 != n.nativeVersion || 9 != n.version && 10 != n.version || this._removeEmptyTextNode_IE(e),
                e.parentNode.removeChild(e)
            }
            ...
            if (this.htSelectionEPos.x - this.htSelectionSPos.x + 1 == this.htMap.length) {
                ...
                i = o.length; t < i; t++)
                    e = o[t],
                    this.htMap[0][t] && this.htMap[0][t].parentNode && "TR" === this.htMap[0][t].parentNode.tagName || (!(n = jindo.$Agent().navigator()).ie || 9 != n.nativeVersion && 10 != n.nativeVersion || 9 != n.version && 10 != n.version || this._removeEmptyTextNode_IE(e),
                    e.parentNode.removeChild(e));
                o = jindo.$$(">TBODY>TR", this.elSelectionStartTable, {
                    oneTimeOffCache: !0
                })
            }
            o.length < 1 && this.elSelectionStartTable.parentNode.removeChild(this.elSelectionStartTable),
            this._updateSelection()
        },
        _insertColumnAfter: function() {
            this._removeClassFromSelection(),
            this._hideTableTemplate(this.elSelectionStartTable);
            for (var e, t, i, n, o = jindo.$$(">TBODY>TR", this.elSelectionStartTable, {
                oneTimeOffCache: !0
            }), s = jindo.$Agent().navigator(), r = 0, a = this.htMap[0].length; r < a; r++) {
                i = o[r];
                for (var l = this.htSelectionEPos.x; l >= this.htSelectionSPos.x; l--) {
                    e = this.htMap[l][r],
                    t = this._shallowCloneTD(e);
                    var h = parseInt(e.getAttribute("rowSpan"));
                    1 < h && (t.setAttribute("rowSpan", 1),
                    t.style.height = ""),
                    1 < (h = parseInt(e.getAttribute("colSpan"))) && (t.setAttribute("colSpan", 1),
                    t.style.width = ""),
                    n = null;
                    for (var d = this.htSelectionEPos.x; d >= this.htSelectionSPos.x; d--)
                        if (this.htMap[d][r].parentNode == i) {
                            n = this.htMap[d][r].nextSibling;
                            break
                        }
                    i.insertBefore(t, n),
                    (s.edge && 12 === Math.floor(s.version) || s.ie && (9 <= s.nativeVersion || s.nativeVersion <= 11) && (9 <= s.version || s.version <= 11)) && (t.style.cssText = t.style.cssText)
                }
            }
            for (var c = 0, _ = this.aSelectedCells.length; c < _; c++)
                this.aSelectedCells[c].removeAttribute("_tmp_inserted");
            var p = this.htSelectionEPos.x - this.htSelectionSPos.x + 1;
            this.htSelectionSPos.x += p,
            this.htSelectionEPos.x += p,
            this.htMap = this._getCellMapping(this.elSelectionStartTable),
            this._selectCells(this.htSelectionSPos, this.htSelectionEPos),
            this._showTableTemplate(this.elSelectionStartTable),
            this._addClassToSelection(),
        ...
        _insertRowBelow: function() {
            ...
            for (var t = this.htMap[0][0].parentNode.parentNode, i = jindo.$$(">TR", t, {
                oneTimeOffCache: !0
            })[this.htSelectionEPos.y + 1] || null, n = jindo.$Agent().navigator(), o = this.htSelectionSPos.y; o <= this.htSelectionEPos.y; o++)
                if (e = this._getTRCloneWithAllTD(o),
                t.insertBefore(e, i),
                n.edge && 12 === Math.floor(n.version) || n.ie && (9 <= n.nativeVersion || n.nativeVersion <= 11) && (9 <= n.version || n.version <= 11)) {
                    for (var s = this.htMap[0][o].parentNode.childNodes, r = [], a = 0, l = s.length; a < l; a++)
                        this._rxCellNames.test(s[a].nodeName) && r.push(s[a].cloneNode());
                    var h = e.childNodes;
                    for (a = 0,
                    l = h.length; a < l; a++) {
                        var d = h[a]
            ...
            this.htSelectionSPos.y += _,
            this.htSelectionEPos.y += _,
            this.htMap = this._getCellMapping(this.elSelectionStartTable),
            this._selectCells(this.htSelectionSPos, this.htSelectionEPos),
            this._showTableTemplate(this.elSelectionStartTable),
            this._addClassToSelection(),
        ...
        _startCellSelection: function() {
            this.htMap = this._getCellMapping(this.elSelectionStartTable),
            this.oApp.getEmptySelection().oBrowserSelection.selectNone(),
            (this.oApp.oNavigator.safari || this.oApp.oNavigator.chrome) && (this.oApp.getWYSIWYGDocument().onselectstart = function() {
                return !1
            }
            );
            var e = this.oApp.getWYSIWYGWindow().frameElement;
            ...
            this.htEditingAreaPos.width = e.offsetWidth,
        ...
        _selectBetweenCells: function(e, t) {
            ...
            var i = this._getBasisCellPosition(e)
              , n = this._getBasisCellPosition(t);
            this._setEndPos(i),
            this._setEndPos(n);
            var o = {}
              , s = {};
            o.x = Math.min(i.x, i.ex, n.x, n.ex),
            o.y = Math.min(i.y, i.ey, n.y, n.ey),
            s.x = Math.max(i.x, i.ex, n.x, n.ex),
            s.y = Math.max(i.y, i.ey, n.y, n.ey),
            this._selectCells(o, s)
        },
        _getNextCell: function(e) {
            for (; e; )
                if ((e = e.nextSibling) && e.tagName && e.tagName.match(/^TD|TH$/))
                    return e;
            return null
        },
        _getCellMapping: function(e) {
            for (var t = jindo.$$(">TBODY>TR", e, {
                oneTimeOffCache: !0
            }), i = 0, n = t[0].childNodes, o = 0; o < n.length; o++) {
                var s = n[o];
                s.tagName && s.tagName.match(/^TD|TH$/) && (s.getAttribute("colSpan") ? i += this.parseIntOr0(s.getAttribute("colSpan")) : i++)
            }
            for (var r = i, a = t.length, l = new Array(r), h = 0; h < r; h++)
                l[h] = new Array(a);
            for (var d = 0; d < a; d++) {
                var c = t[d].childNodes[0];
                if (c)
                    for (c.tagName && c.tagName.match(/^TD|TH$/) || (c = this._getNextCell(c)),
                    h = -1; c; )
                        if (l[++h] || (l[h] = []),
                        !l[h][d]) {
                            for (var _ = parseInt(c.getAttribute("colSpan"), 10) || 1, p = parseInt(c.getAttribute("rowSpan"), 10) || 1, E = 0; E < p; E++)
                                for (var u = 0; u < _; u++)
                                    l[h + u] || (l[h + u] = []),
                                    l[h + u][d + E] = c;
            ...
            S++)
                if (A = null,
                !t[d].innerHTML.match(/TD|TH/i)) {
                    for (h = 0,
                    g = l.length; h < g; h++)
                        (c = l[h][d]) && c !== A && (A = c,
                        1 < (p = parseInt(c.getAttribute("rowSpan"), 10) || 1) && c.setAttribute("rowSpan", p - 1));
                    var C = jindo.$Agent().navigator();
                    !C.ie || 9 != C.nativeVersion && 10 != C.nativeVersion || 9 != C.version && 10 != C.version || this._removeEmptyTextNode_IE(t[d]),
                    t[d].parentNode.removeChild(t[d]),
                    this.htSelectionEPos.y >= S && (S--,
        ...
        _selectCells: function(e, t) {
            this.aSelectedCells = this._getSelectedCells(e, t),
            this._addClassToSelection()
        },
        ...
        _addClassToSelection: function() {
            for (var e, t, i = 0; i < this.aSelectedCells.length; i++)
                (t = this.aSelectedCells[i]) && (null == t.ondragstart && (t.ondragstart = function() {
                    return !1
                }
                ),
                (e = jindo.$Element(t)).addClass(this.CELL_SELECTION_CLASS),
                e.addClass("undraggable"),
                t.style.backgroundColor && (t.setAttribute(this.TMP_BGC_ATTR, t.style.backgroundColor),
                e.css("backgroundColor", "")),
                t.style.backgroundImage && (t.setAttribute(this.TMP_BGIMG_ATTR, t.style.backgroundImage),
                e.css("backgroundImage", "")))
        },
        _removeClassFromSelection: function() {
            for (var e, t, i = 0; i < this.aSelectedCells.length; i++)
                (t = this.aSelectedCells[i]) && ((e = jindo.$Element(t)).removeClass(this.CELL_SELECTION_CLASS),
                e.removeClass("undraggable"),
                t.getAttribute(this.TMP_BGC_ATTR) && (t.style.backgroundColor = t.getAttribute(this.TMP_BGC_ATTR),
                t.removeAttribute(this.TMP_BGC_ATTR)),
                t.getAttribute(this.TMP_BGIMG_ATTR) && (e.css("backgroundImage", t.getAttribute(this.TMP_BGIMG_ATTR)),
        ...
        _expandAndSelect: function(e, t) {
            ...
            if (0 < e.y)
                for (i = e.x; i <= t.x; i++)
                    if (o = this.htMap[i][e.y],
                    this.htMap[i][e.y - 1] == o) {
                        for (s = e.y - 2; 0 <= s && this.htMap[i][s] == o; )
                            s--;
                        return e.y = s + 1,
                        void this._expandAndSelect(e, t)
                    }
            if (0 < e.x)
                for (n = e.y; n <= t.y; n++)
                    if (o = this.htMap[e.x][n],
                    this.htMap[e.x - 1][n] == o) {
                        for (s = e.x - 2; 0 <= s && this.htMap[s][n] == o; )
                            s--;
                        return e.x = s + 1,
                        void this._expandAndSelect(e, t)
                    }
            if (t.y < this.htMap[0].length - 1)
                for (i = e.x; i <= t.x; i++)
                    if (o = this.htMap[i][t.y],
                    this.htMap[i][t.y + 1] == o) {
                        for (s = t.y + 2; s < this.htMap[0].length && this.htMap[i][s] == o; )
                            s++;
                        return t.y = s - 1,
                        void this._expandAndSelect(e, t)
                    }
            if (t.x < this.htMap.length - 1)
                for (n = e.y; n <= t.y; n++)
                    if (o = this.htMap[t.x][n],
                    this.htMap[t.x + 1][n] == o) {
                        for (s = t.x + 2; s < this.htMap.length && this.htMap[s][n] == o; )
                            s++;
                        return t.x = s - 1,
                        void this._expandAndSelect(e, t)
                    }
        ...
        _getSelectedCells: function(e, t) {
            ...
            var i = e.x
              ...
              , o = t.x
              , s = t.y;
            this.htSelectionSPos = e,
            this.htSelectionEPos = t;
            for (var r = [], a = n; a <= s; a++)
                for (var l = i; l <= o; l++)
                    jindo.$A(r).has(this.htMap[l][a]) || (r[r.length] = this.htMap[l][a]);
            return r
        },
        _setEndPos: function(e) {
            var t, i;
            t = parseInt(e.elCell.getAttribute("colSpan"), 10) || 1,
            i = parseInt(e.elCell.getAttribute("rowSpan"), 10) || 1,
            e.ex = e.x + t - 1,
            e.ey = e.y + i - 1
        },
        ...
        _applyTableTemplate: function(e, t) {
            e && (this._clearAllTableStyles(e),
            this._doApplyTableTemplate(e, nhn.husky.SE2M_TableTemplate[t], !1),
            e.setAttribute(this.ATTR_TBL_TEMPLATE, t))
        },
        ...
        _doApplyTableTemplate: function(e, t, i) {
            var n, o = t.htTableProperty, s = t.htTableStyle, r = t.ht1stRowStyle, a = t.ht1stColumnStyle, l = t.aRowStyle;
            o && this._copyAttributesTo(e, o, i),
            s && this._copyStylesTo(e, s, i);
            var h, d, c = jindo.$$(">TBODY>TR", e, {
                oneTimeOffCache: !0
            }), _ = 0;
            if (r) {
                _ = 1;
                for (var p = 0, E = c[0].childNodes.length; p < E; p++)
                    (n = c[0].childNodes[p]).tagName && n.tagName.match(/^TD|TH$/) && this._copyStylesTo(n, r, i)
            }
            if (a)
                for (var u = r ? 1 : 0, g = c.length; u < g; )
                    h = 1,
                    (d = c[u].firstChild) && d.tagName.match(/^TD|TH$/) && (h = parseInt(d.getAttribute("rowSpan"), 10) || 1,
                    this._copyStylesTo(d, a, i)),
                    u += h;
            if (l) {
                var f = l.length;
                for (u = _,
                g = c.length; u < g; u++)
                    for (p = 0,
                    E = c[u].childNodes.length; p < E; p++)
                        (n = c[u].childNodes[p]).tagName && n.tagName.match(/^TD|TH$/) && this._copyStylesTo(n, l[(u + _) % f], i)
            }
        },
        _copyAttributesTo: function(e, t, i) {
            var n;
            for (var o in t)
                Object.prototype.hasOwnProperty.call(t, o) && (i ? e[o] && ((n = document.createElement(e.tagName))[o] = t[o],
                n[o] == e[o] && e.removeAttribute(o)) : ((n = document.createElement(e.tagName)).style[o] = "",
                e[o] && e.style[o] != n.style[o] || e.setAttribute(o, t[o])))
        },
        _copyStylesTo: function(e, t, i) {
            var n;
            for (var o in t)
                Object.prototype.hasOwnProperty.call(t, o) && (i ? e.style[o] && ((n = document.createElement(e.tagName)).style[o] = t[o],
                n.style[o] == e.style[o] && (e.style[o] = "")) : ((n = document.createElement(e.tagName)).style[o] = "",
                e.style[o] && e.style[o] != n.style[o] && !o.match(/^border/) || (e.style[o] = t[o])))
        },
        ...
        _setResizerSize: function(e, t) {
            this.elResizeGrid.style.width = e + "px",
            this.elResizeGrid.style.height = t + "px"
        },
        ...
        _getTRCloneWithAllTD: function(e) {
            for (var t, i, n = this.htMap[0][e].parentNode.cloneNode(!1), o = 0, s = this.htMap.length; o < s; o++)
                t = this.htMap[o][e],
                this._rxCellNames.test(t.tagName) && ((i = this._shallowCloneTD(t)).setAttribute("rowSpan", 1),
                i.setAttribute("colSpan", 1),
                i.style.width = "",
                i.style.height = "",
        ...
        _shallowCloneTD: function(e) {
            var t = e.cloneNode(!1);
            return t.innerHTML = this.sEmptyTDSrc,
            t
        },
        _isValidTable: function(e) {
            if (!e || !e.tagName || "TABLE" != e.tagName)
                return !1;
            ...
            if (i < 1)
                return !1;
            for (var n = 1; n < t; n++) {
                if (this.htMap[n].length != i || !this.htMap[n][i - 1])
                    return !1;
                for (var o = 0; o < i; o++)
                    if (!this.htMap[n] || !this.htMap[n][o])
                        return !1
            }
            return !0
        },
        addCSSClass: function(e, t) {
            ...
            if (i.styleSheets[0] && i.styleSheets[0].addRule)
                i.styleSheets[0].addRule("." + e, t);
            else {
                var n = i.getElementsByTagName("HEAD")[0]
                  , o = i.createElement("STYLE");
                n.appendChild(o),
                o.sheet.insertRule("." + e + " { " + t + " }", 0)
            }
        },
...
, function(e, t) {
    ...
    nhn.husky.HuskyCore.mixin(nhn.husky.SE2M_BGColor, {
        ...
        $ON_EVENT_APPLY_BGCOLOR: function(e) {
            for (var t, i, n = e.element; "SPAN" == n.tagName; )
                n = n.parentNode;
            "BUTTON" == n.tagName && (t = n.style.backgroundColor,
            i = n.style.color,
            this.oApp.exec("APPLY_BGCOLOR", [t, i]))
        },
        ...
        $ON_APPLY_BGCOLOR: function(e, t) {
            if (this.rxColorPattern.test(e)) {
                ...
                t && (i.color = t),
                this.oApp.exec("SET_WYSIWYG_STYLE", [i]),
                this.oApp.exec("HIDE_ACTIVE_LAYER")
            } else
                alert(this.oApp.$MSG("SE_Color.invalidColorCode"))
        }
...
, function(e, t) {
    ...
    nhn.husky.HuskyCore.mixin(nhn.husky.SE2M_FontColor, {
        ...
        $ON_APPLY_FONTCOLOR: function(e) {
            this.rxColorPattern.test(e) ? (this._setLastUsedFontColor(e),
            this.oApp.exec("SET_WYSIWYG_STYLE", [{
                color: e
            }]),
...
, function(e, t) {
    ...
    nhn.husky.HuskyCore.mixin(nhn.husky.SE2M_Hyperlink, {
        $ON_TOGGLE_HYPERLINK_LAYER: function() {
            this.bLayerShown || (this.oApp.exec("IE_FOCUS", []),
            this.oSelection = this.oApp.getSelection()),
        ...
        _validateTarget: function() {
            ...
            return e.ie && jindo.$A(this.oSelection.getNodes(!0)).forEach(function(e) {
                e && 1 == e.nodeType && "iframe" == e.tagName.toLowerCase() && "db" == e.getAttribute("s_type").toLowerCase() && (t = !1,
                jindo.$A.Break()),
                jindo.$A.Continue()
            }, this),
            t
        ...
        $ON_APPLY_HYPERLINK: function() {
            if (this._validateTarget()) {
                ...
                /^((http|https|ftp|mailto):(?:\/\/)?)/.test(e) || (e = "http://" + e),
                e = e.replace(/\s+$/, "");
                var t = jindo.$Agent().navigator()
                  , i = "";
                if (this.oApp.exec("IE_FOCUS", []),
                t.ie && (i = '<span style="text-decoration:none;">&nbsp;</span>'),
                this._validateURL(e)) {
                    var n, o = "_self";
                    ...
                    this.oSelection.collapsed) {
                        ...
                        this.oSelection.pasteHTML(s),
                        n = this.oSelection.placeStringBookmark()
                    } else {
                        n = this.oSelection.placeStringBookmark(),
                        this.oSelection.select(),
                        !t.ie || 8 !== t.version && 8 !== t.nativeVersion || (this.oApp.exec("IE_FOCUS", []),
                        this.oSelection.moveToBookmark(n),
                        this.oSelection.select());
                        ...
                        if ("" == e)
                            ...
                            jindo.$A(this.oSelection.getNodes(!0)).forEach(function(e) {
                                var t = this.oApp.getEmptySelection();
                                3 === e.nodeType ? (t.selectNode(e),
                                t.pasteHTML(a + e.nodeValue + "</a>")) : 1 === e.nodeType && "IMG" === e.tagName && (t.selectNode(e),
                                t.pasteHTML(a + jindo.$Element(e).outerHTML() + "</a>"))
                            }, this)
                        } else
                            this.oApp.exec("EXECCOMMAND", ["createLink", !1, this.sATagMarker + r + encodeURIComponent(e), {
                                bDontAddUndoHistory: !0
                            }]);
...
, function(e, t) {
    ...
    nhn.husky.HuskyCore.mixin(nhn.husky.SE2M_LineHeightWithLayerUI, {
        _assignHTMLObjects: function(e) {
            this.oDropdownLayer = jindo.$$.getSingle("DIV.husky_se2m_lineHeight_layer", e),
            this.aLIOptions = jindo.$A(jindo.$$("LI", this.oDropdownLayer)).filter(function(e) {
                return null !== e.firstChild
            })._array,
            ...
            this.oBtn_down = t[1],
            this.oBtn_ok = t[2],
            this.oBtn_cancel = t[3]
        },
        $LOCAL_BEFORE_FIRST: function() {
            this._assignHTMLObjects(this.oApp.htOptions.elAppContainer),
            this.oApp.exec("SE2_ATTACH_HOVER_EVENTS", [this.aLIOptions]);
            for (var e = 0; e < this.aLIOptions.length; e++)
                this.oApp.registerBrowserEvent(this.aLIOptions[e], "click", "SET_LINEHEIGHT_FROM_LAYER_UI", [this._getLineHeightFromLI(this.aLIOptions[e])]);
        ...
        $ON_EVENT_SE2M_LINEHEIGHT_KEYDOWN: function(e) {
            e.key().enter && (this.oApp.exec("SE2M_SET_LINEHEIGHT_FROM_DIRECT_INPUT"),
            e.stop())
        },
        ...
        $ON_SE2M_DEC_LINEHEIGHT: function() {
            this.oInput.value = parseInt(this.oInput.value, 10) || this.MIN_LINE_HEIGHT,
            this.oInput.value > this.MIN_LINE_HEIGHT && this.oInput.value--
        },
        ...
        _setLineHeightAndCloseLayer: function(e) {
            ...
            0 < t ? this.oApp.exec("SET_LINE_STYLE", ["lineHeight", t]) : alert(this.oApp.$MSG("SE_LineHeight.invalidLineHeight")),
        ...
        _getMatchingLI: function(e) {
            ...
            for (var i = 0; i < this.aLIOptions.length; i++)
                if (t = this.aLIOptions[i],
                this._getLineHeightFromLI(t).toLowerCase() == e)
                    return t;
            return null
        },
        ...
        _clearOptionSelection: function() {
            for (var e = 0; e < this.aLIOptions.length; e++)
                jindo.$Element(this.aLIOptions[e].firstChild).removeClass("active")
        }
    })
}
, function(e, t) {
    ...
    nhn.husky.HuskyCore.mixin(nhn.husky.SE2M_QuickEditor_Common, {
        setOpenType: function(e, t) {
            "undefined" != typeof this._environmentData && null != this._environmentData || (this._environmentData = {}),
            "undefined" != typeof this._environmentData[e] && null != this._environmentData[e] || (this._environmentData[e] = {}),
            "undefined" != typeof this._environmentData[e].isOpen && null != this._environmentData[e].isOpen || (this._environmentData[e].isOpen = !0),
            this._environmentData[e].isOpen = t
        },
        $ON_OPEN_QE_LAYER: function(e, t, i) {
            if (0 < this.waHotkeys.length() && !this.waHotkeyLayers.has(t)) {
                var n;
                this.waHotkeyLayers.push(t);
                for (var o = 0, s = this.waHotkeys.length(); o < s; o++)
                    n = this.waHotkeys.get(o),
                    this.oApp.exec("ADD_HOTKEY", [n[0], n[1], n[2], t])
            }
            var r = i;
            r && (this.targetEle = e,
            this.currentEle = t,
        ...
        $ON_CLOSE_QE_LAYER: function(e) {
            this.currentEle && (this.oApp.exec("CLOSE_SUB_LAYER_QE"),
            this.layer_hide(e))
        },
        $LOCAL_BEFORE_FIRST: function(e) {
            if (!e.match(/OPEN_QE_LAYER/))
                return this.oApp.acceptLocalBeforeFirstAgain(this, !0),
                !!e.match(/REGISTER_HOTKEY/);
            ...
            new jindo.DragArea(this._qe_wrap,{
                ...
                dragStart: function(e) {
                    jindo.$Element(e.elDrag).hasClass("se2_qmax") || (e.elDrag = e.elDrag.parentNode),
                    i.oApp.exec("SHOW_EDITING_AREA_COVER")
                },
                dragEnd: function(e) {
                    i.changeFixedMode(),
                    i._in_event = !1;
                    var t = jindo.$Element(e.elDrag);
                    i._environmentData[i._currentType].position = [t.css("top"), t.css("left")],
                    i.oApp.exec("HIDE_EDITING_AREA_COVER")
                }
            });
            var t = jindo.$Fn(this.toggle, this).bind("img")
              , n = jindo.$Fn(this.toggle, this).bind("table");
            jindo.$Fn(t, this).attach(jindo.$$.getSingle(".q_open_img_fold", this.oApp.htOptions.elAppContainer), "click"),
            jindo.$Fn(t, this).attach(jindo.$$.getSingle(".q_open_img_full", this.oApp.htOptions.elAppContainer), "click"),
            jindo.$Fn(n, this).attach(jindo.$$.getSingle(".q_open_table_fold", this.oApp.htOptions.elAppContainer), "click"),
            jindo.$Fn(n, this).attach(jindo.$$.getSingle(".q_open_table_full", this.oApp.htOptions.elAppContainer), "click")
        },
        toggle: function(e, t) {
            e = this._currentType,
            this.oApp.exec("CLOSE_QE_LAYER", [t]),
            "full" == this._environmentData[e].type ? this._environmentData[e].type = "fold" : this._environmentData[e].type = "full",
            this._environmentData && this._bUseConfig && jindo.$Ajax(this._sAddTextAjaxUrl, {
                type: "jsonp",
                onload: function() {}
            }).request({
                text_key: "qeditor_fold",
            ...
            this.oApp.exec("OPEN_QE_LAYER", [this.targetEle, this.currentEle, e]),
            this._in_event = !1,
        ...
        $ON_EVENT_EDITING_AREA_MOUSEDOWN: function(e) {
            this._currentType && !this._in_event && this._environmentData[this._currentType].isOpen && this.oApp.exec("CLOSE_QE_LAYER", [e]),
            this._in_event = !1
        },
        ...
        layer_hide: function() {
            this.setOpenType(this._currentType, !1),
        ...
        layer_show: function(e, t) {
            this._currentType = e,
            this.setOpenType(this._currentType, !0);
            var i = jindo.$$.getSingle("._" + this._environmentData[this._currentType].type, this.currentEle);
            jindo.$Element(i).show().css(this.get_position_layer(t, i)),
            this.lazy_common()
        },
        get_position_layer: function(e, t) {
            if (!this.isCurrentFixed() || "fold" == this._environmentData[this._currentType].type)
                return this.calculateLayer(e, t);
            var i = this._environmentData[this._currentType].position
              , n = parseInt(i[0], 10)
              , o = this.getAppPosition().h
              , s = jindo.$Element(t).height();
            return n + s + this.nYGap > o && (n = o - s,
            this._environmentData[this._currentType].position[0] = n),
            {
                top: n + "px",
                left: i[1]
            }
        ...
        getPositionInfo: function(e, t) {
            ...
            this.nXGap = 1;
            var i = {}
              , n = this.getElementPosition(e, t)
              , o = this.getAppPosition()
              , s = jindo.$Element(t).width()
              , r = jindo.$Element(t).height();
            return n.x + s + this.nXGap > o.w ? i.x = o.w - s : i.x = n.x + this.nXGap,
            n.y + r + this.nYGap > o.h ? i.y = o.h - r - 2 : i.y = n.y + this.nYGap,
            {
                x: i.x,
                y: i.y
            }
        ...
        getElementPosition: function(e, t) {
            var i, n, o, s, r, a;
            s = e ? (n = (i = jindo.$Element(e)).offset(),
            o = i.width(),
            i.height()) : (n = {
            ...
            return a = "undefined" == typeof l.scrollX ? (r = l.document.documentElement.scrollLeft,
            l.document.documentElement.scrollTop) : (r = l.scrollX,
            l.scrollY),
            {
                x: n.left - r + o,
                y: n.top - a + s
...
, function(e, t) {
    ...
    nhn.husky.HuskyCore.mixin(nhn.husky.DialogLayerManager, {
        $ON_SHOW_DIALOG_LAYER: function(e, t) {
            if (t = t || {},
            (e = jindo.$(e)) && !jindo.$A(this.aOpenedLayers).has(e)) {
                var i;
                this.oApp.exec("POSITION_DIALOG_LAYER", [e]),
                this.aOpenedLayers[this.aOpenedLayers.length] = e;
                var n = jindo.$A(this.aMadeDraggable).indexOf(e);
                -1 == n ? (i = new nhn.DraggableLayer(e,t),
                this.aMadeDraggable[this.aMadeDraggable.length] = e,
                this.aDraggableLayer[this.aDraggableLayer.length] = i) : (t && (i = this.aDraggableLayer[n]).setOptions(t),
                e.style.display = "block"),
                t.sOnShowMsg && this.oApp.exec(t.sOnShowMsg, t.sOnShowParam)
            }
        },
        ...
        $ON_HIDE_ALL_DIALOG_LAYER: function() {
            for (var e = this.aOpenedLayers.length - 1; 0 <= e; e--)
                this.oApp.exec("HIDE_DIALOG_LAYER", [this.aOpenedLayers[e]])
        },
        $ON_HIDE_DIALOG_LAYER: function(e) {
            (e = jindo.$(e)) && (e.style.display = "none"),
            this.aOpenedLayers = jindo.$A(this.aOpenedLayers).refuse(e).$value()
        },
...
, function(e, t) {
    ...
    nhn.FindReplace = jindo.$Class({
        ...
        bEOC: !1,
        $init: function(e) {
            if (this.sInlineContainer = "SPAN|B|U|I|S|STRIKE",
            this.rxInlineContainer = new RegExp("^(" + this.sInlineContainer + ")$"),
            this.window = e,
            this.document = this.window.document,
            this.document.domain != this.document.location.hostname) {
                var t = jindo.$Agent().navigator();
                if (t.firefox && t.version < 3)
                    return this.bBrowserSupported = !1,
                    void (this.find = function() {
                        return 3
                    }
                    )
            }
            this._bLGDevice = -1 < navigator.userAgent.indexOf("LG-"),
            this.bBrowserSupported = !0
        },
        find: function(e, t, i, n) {
            return this._bLGDevice || this.window.focus(),
            e ? (this.bEOC = !1,
            this.findNext(e, t, i, n) ? 0 : (this.bEOC = !0,
            this.findNew(e, t, i, n) ? 0 : 1)) : 2
        },
        findNew: function(e, t, i, n) {
            return this.findReset(),
            this.findNext(e, t, i, n)
        },
        findNext: function(e, t, i, n) {
            ...
            if (this.document.body.createTextRange)
                try {
                    ...
                    t && (s += 4),
                    this.window.focus(),
                    this.document.selection ? (this._range = this.document.selection.createRangeCollection().item(0),
                    this._range.collapse(!1)) : this._range ? this._range.collapse(!1) : this._range = this.document.body.createTextRange(),
                    o = this._range.findText(e, 1, s),
                    this._range.select(),
                    o
                } catch (r) {
                    return !1
        ...
        findReset: function() {
            this.window.find ? this.window.getSelection().removeAllRanges() : this.document.body.createTextRange && (this._range = this.document.body.createTextRange(),
            this._range.collapse(!0),
            this._range.select())
        },
        ...
        _replace: function(e, t, i, n, o, s) {
            if (!e)
                return 4;
            (s = s || new nhn.HuskyRange(this.window)).setFromSelection(),
            i = i || !1;
            var r = s.toString();
            return (i ? r == e : r.toLowerCase() == e.toLowerCase()) ? ("function" == typeof t ? s = t(s) : s.pasteText(t),
            s.select(),
            this.find(e, i, n, o)) : this.find(e, i, n, o) + 2
        },
        replaceAll: function(e, t, i, n) {
            if (!e)
                return -1;
            var o, s = 0, r = this.window;
            if (0 !== this.find(e, i, !1, n))
                return s;
            var a = new nhn.HuskyRange(this.window);
            a.setFromSelection(),
            a.collapseToStart();
            var l = this.window.document.createElement("SPAN");
            l.innerHTML = unescape("%uFEFF"),
            a.insertNode(l),
            a.select();
            var h = a.placeStringBookmark();
            for (this.bEOC = !1; !this.bEOC; )
                0 != (o = this._replace(e, t, i, !1, n, a)) && 1 != o || s++;
            var d;
            for (o = 0,
            this.bEOC = !1; d = void 0,
            (d = new nhn.HuskyRange(r)).setFromSelection(),
            a.moveToBookmark(h),
            1 == a.compareBoundaryPoints(nhn.W3CDOMRange.START_TO_END, d) && 0 == o && !this.bEOC; )
                0 != (o = this._replace(e, t, i, !1, n, a)) && 1 != o || s++;
            return a.moveToBookmark(h),
            a.deleteContents(),
            a.removeStringBookmark(h),
            setTimeout(function() {
        ...
        _getNextNode: function(e, t) {
            ...
            if (e.nextSibling) {
                for (e = e.nextSibling; e.firstChild; )
                    e.tagName && !this.rxInlineContainer.test(e.tagName) && (t = !0),
                    e = e.firstChild;
                return {
                    elNextNode: e,
                    bDisconnected: t
        ...
        _getNextTextNode: function(e, t) {
            for (var i; e = (i = this._getNextNode(e, t)).elNextNode,
            t = i.bDisconnected,
            e && 3 != e.nodeType && !this.rxInlineContainer.test(e.tagName) && (t = !0),
            e && (3 != e.nodeType || this._isBlankTextNode(e)); )
                ;
            return {
                elNextText: e,
                bDisconnected: t
        ...
        _getFirstTextNode: function() {
            for (var e = this.document.body.firstChild; e && e.firstChild; )
                e = e.firstChild;
            if (!e)
                return null;
        ...
        _addToTextMap: function(e, t, i, n) {
            for (var o = t[n].length, s = 0, r = e.nodeValue.length; s < r; s++)
                i[n][o + s] = [e, s];
            t[n] += e.nodeValue
        },
        _createTextMap: function() {
            for (var e = [], t = [], i = -1, n = this._getFirstTextNode(), o = {
                ...
                o.bDisconnected && (e[++i] = "",
                t[i] = []),
                this._addToTextMap(o.elNextText, e, t, i),
                n = (o = this._getNextTextNode(n, !1)).elNextText;
            return {
                aTexts: e,
                aElTexts: t
            }
        ...
        replaceAll_js: function(e, t, i, n) {
            try {
                for (var o = this._createTextMap(), s = o.aTexts, r = o.aElTexts, a = 0, l = e.length, h = 0, d = s.length; h < d; h++)
                    for (var c = s[h], _ = c.length - l; 0 <= _; _--) {
                        var p = c.substring(_, _ + l);
                        if (!(n && 0 < _ && c.charAt(_ - 1).match(/[a-zA-Z가-힣]/)) && p == e) {
                            a++;
                            var E, u, g = new nhn.HuskyRange(this.window);
                            u = _ + l < r[h].length ? (E = r[h][_ + l][0],
                            r[h][_ + l][1]) : (E = r[h][_ + l - 1][0],
                            r[h][_ + l - 1][1] + 1),
                            g.setEnd(E, u, !0, !0),
                            g.setStart(r[h][_][0], r[h][_][1], !0),
                            "function" == typeof t ? g = t(g) : g.pasteText(t),
                            _ -= l
                        }
                    }
                return a
...
, function(e, t) {
    ...
    nhn.DraggableLayer = jindo.$Class({
        $init: function(e, t) {
            ...
            e.style.zIndex = "9999",
            this.aBasePosition = this.getBaseOffset(e);
            ...
            e.style.top = o.y + "px",
            e.style.left = o.x + "px",
            this.$FnMouseDown = jindo.$Fn(jindo.$Fn(this._mousedown, this).bind(e), this),
            this.$FnMouseMove = jindo.$Fn(jindo.$Fn(this._mousemove, this).bind(e), this),
            this.$FnMouseUp = jindo.$Fn(jindo.$Fn(this._mouseup, this).bind(e), this),
        ...
        _mousedown: function(e, t) {
            "INPUT" != t.element.tagName && (this.oOptions.fnOnDragStart(),
            this.MouseOffsetY = t.pos().clientY - this.toInt(e.style.top) - this.aBasePosition.top,
            this.MouseOffsetX = t.pos().clientX - this.toInt(e.style.left) - this.aBasePosition.left,
            this.$FnMouseMove.attach(e.ownerDocument, "mousemove"),
            this.$FnMouseUp.attach(e.ownerDocument, "mouseup"),
            this.elHandle.style.cursor = "move")
        },
        _mousemove: function(e, t) {
            var i = t.pos().clientY - this.MouseOffsetY - this.aBasePosition.top
              , n = t.pos().clientX - this.MouseOffsetX - this.aBasePosition.left
              , o = this._correctXY({
                x: n,
                y: i
            });
        ...
        _mouseup: function(e) {
            ...
            this.$FnMouseMove.detach(e.ownerDocument, "mousemove"),
            this.$FnMouseUp.detach(e.ownerDocument, "mouseup"),
            this.elHandle.style.cursor = ""
        },
        _correctXY: function(e) {
            var t = e.x
              , i = e.y;
            return i < this.oOptions.nMinY && (i = this.oOptions.nMinY),
            i > this.oOptions.nMaxY && (i = this.oOptions.nMaxY),
            t < this.oOptions.nMinX && (t = this.oOptions.nMinX),
            t > this.oOptions.nMaxX && (t = this.oOptions.nMaxX),
            {
                x: t,
                y: i
            }
        ...
        setOptions: function(e) {
            this.oOptions = e || {},
            this.oOptions.bModal = this.oOptions.bModal || !1,
