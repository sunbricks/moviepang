function isUnCacheAgent() {
    var e = _ua.indexOf("iPad") > -1
      ...
      , n = !(_ua.indexOf("IEMobile") > -1) && _ua.indexOf("Mobile") > -1 || e && _ua.indexOf("Safari") > -1;
    return n && !e && !t
}
"undefined" != typeof window && "undefined" == typeof window.nhn && (window.nhn = {}),
"undefined" != typeof window ? "undefined" == typeof window.jindo && (window.jindo = {}) : jindo || (jindo = {}),
jindo.$Jindo = function() {
    var e = arguments.callee
      , t = e._cached;
    return t ? t : this instanceof e ? (t || (e._cached = this),
    void (this.version = "1.5.2-SMART_EDITOR")) : new e
}
,
jindo.$ = function(e) {
    var t = []
      ...
      , a = /^<([a-z]+|h[1-5])>$/i
      , u = /^<([a-z]+|h[1-5])(\s+[^>]+)?>/i;
    o > 1 && "string" != typeof i && i.body && (n = Array.prototype.slice.apply(n, [0, o - 1]),
    r = i);
    for (var l = 0; o > l; l++) {
        if (s = n[l],
        "string" == typeof s)
            ...
            s.indexOf("<") > -1) {
                if (a.test(s))
                    ...
                    for (var d = {
                        ...
                        legend: "fieldset",
                        option: "select"
                    }, c = RegExp.$1.toLowerCase(), p = jindo._createEle(d[c], s, r), l = 0, f = p.length; f > l; l++)
                        t.push(p[l]);
                    s = null
                }
            } else
                s = r.getElementById(s);
        s && (t[t.length] = s)
    }
...
jindo.$Class = function(oDef) {
    function typeClass() {
        for (var t = this, a = [], superFunc = function(m, superClass, func) {
            if ("constructor" != m && func.toString().indexOf("$super") > -1) {
                var funcArg = func.toString().replace(/function[^\(]*\(([^\)]*)[\w\W]*/g, "$1").split(",")
                  , funcStr = func.toString().replace(/function[^{]*{/, "").replace(/(\w|\.?)(this\.\$super|this)/g, function(e, t, n) {
                    return t ? e : n + ".$super"
                });
            ...
            for (var x in t._$superClass.prototype)
                t._$superClass.prototype.hasOwnProperty(x) && ("undefined" == typeof this[x] && "$init" != x && (this[x] = t._$superClass.prototype[x]),
                "constructor" != x && "_$superClass" != x && "function" == typeof t._$superClass.prototype[x] ? t.$super[x] = superFunc(x, t._$superClass, t._$superClass.prototype[x]) : t.$super[x] = t._$superClass.prototype[x]);
    ...
    if ("undefined" != typeof oDef.$static) {
        var i = 0, x;
        for (x in oDef)
            oDef.hasOwnProperty(x) && ("$static" == x || i++);
    ...
    return typeClass.prototype = oDef,
...
jindo.$$ = jindo.cssquery = function() {
    ...
    var sVersion = "3.0"
      ...
      , getUID4HTML = function(e) {
        ...
        return t && validUID[t] == e ? t : (t = UID++,
        e._cssquery_UID = safeHTML ? [t] : t,
        validUID[t] = e,
        t)
    }
      , getUID4XML = function(e) {
        var t = e.getAttribute("_cssquery_UID")
          , n = safeHTML ? t && t[0] : t;
        return n || (n = UID++,
        e.setAttribute("_cssquery_UID", safeHTML ? [n] : n)),
        n
    }
      , getUID = getUID4HTML
      , uniqid = function(e) {
      ...
      , getChilds_dontShrink = function(e, t, n) {
        return bSupportByClassName && n ? e.getElementsByClassName ? e.getElementsByClassName(n) : e.querySelectorAll ? e.querySelectorAll(n) : getElementsByClass(n, e, t) : "*" == t ? e.all || e.getElementsByTagName(t) : e.getElementsByTagName(t)
    }
      , clearKeys = function() {
        backupKeys._keys = {}
    }
      ...
      , restoreKeys = function(e, t) {
        var n, o = backupKeys._keys, i = t ? /(\[ATTR[0-9]+\])/g : /(QUOT[0-9]+|\[ATTR[0-9]+\])/g;
        do
            n = !1,
      ...
      , getCSS = function(e, t) {
        return e.currentStyle ? ("float" == t && (t = "styleFloat"),
        e.currentStyle[t] || e.style[t]) : window.getComputedStyle ? oDocument_dontShrink.defaultView.getComputedStyle(e, null).getPropertyValue(t.replace(/([A-Z])/g, "-$1").toLowerCase()) || e.style[t] : ("float" == t && /MSIE/.test(window.navigator.userAgent) && (t = "styleFloat"),
        e.style[t])
    }
      , oCamels = {
        accesskey: "accessKey",
      ...
      , getDefineCode = function(e) {
        var t, n;
        if (bXMLDocument)
            t = 'oEl.getAttribute("' + e + '",2)';
        else if (n = getStyleKey(e))
            e = "$$" + n,
            t = 'getCSS(oEl, "' + n + '")';
        else
            switch (e) {
      ...
      , getReturnCode = function(e) {
        ...
        case "$=":
            return "(" + n + " && " + n + ".substr(" + n + ".length - " + e.val.length + ") == " + o + ")";
        case "*=":
            return "(" + n + " && " + n + ".indexOf(" + o + ") > -1)";
        case "!=":
            return "(" + n + " != " + o + ")";
      ...
      , oPseudoes_dontShrink = {
        ...
        "last-child": function(e, t) {
            for (e = e.nextSibling; e; e = e.nextSibling)
                if (1 == e.nodeType)
                    return !1;
            return !0
        },
        ...
        "only-child": function(e, t) {
            for (var n = 0, o = (e.parentNode || e._IE5_parentNode).firstChild; o; o = o.nextSibling)
                if (1 == o.nodeType && n++,
                n > 1)
                    return !1;
            return n ? !0 : !1
        ...
        "nth-last-child": function(e, t, n) {
            for (var o = (e.parentNode || e._IE5_parentNode).lastChild; o && 1 != o.nodeType; o = o.previousSibling)
                ;
      ...
      , getExpression = function(e) {
        var t, n, o = {
            defines: "",
            returns: "true"
        }, e = restoreKeys(e, !0), i = [], r = [], s = [], e = e.replace(/:([\w-]+)(\(([^)]*)\))?/g, function(e, t, n, i) {
            switch (t) {
            case "not":
            ...
            case "nth-last-child":
                i = restoreString(i),
                "even" == i ? i = "2n" : "odd" == i && (i = "2n+1");
                var l, d, c = i.match(/([0-9]*)n([+-][0-9]+)*/);
                c ? (l = c[1] || 1,
                d = c[2] || 0) : (l = 1 / 0,
                d = parseInt(i, 10)),
            ...
            case "first-of-type":
            case "last-of-type":
                t = "first-of-type" == t ? "nth-of-type" : "nth-last-of-type",
                i = 1;
            case "nth-of-type":
            case "nth-last-of-type":
                ...
                "even" == i ? i = "2n" : "odd" == i && (i = "2n+1");
                var l, d;
                /([0-9]*)n([+-][0-9]+)*/.test(i) ? (l = parseInt(RegExp.$1, 10) || 1,
                d = parseInt(RegExp.$2, 20) || 0) : (l = 1 / 0,
                d = parseInt(i, 10)),
                o.nth = [l, d, t];
                break;
            default:
            ...
            return t = restoreString(t),
            r = restoreString(r),
            ("checked" == t || "disabled" == t || "enabled" == t || "readonly" == t || "selected" == t) && (r || (o = "=",
            r = "true")),
            i.push({
                key: t,
                op: o,
            ...
            ""
        }), a = null, e = e.replace(/\.([\w-]+)/g, function(e, t) {
            return i.push({
                key: "class",
                op: "~=",
                val: t
        ...
        for (var u, l = {}, d = 0; u = i[d]; d++) {
            var c = u.key;
            l[c] || r.push(getDefineCode(c)),
            s.unshift(getReturnCode(u)),
            l[c] = !0
        }
        return r.length && (o.defines = "var " + r.join(",") + ";"),
      ...
      , isNth_dontShrink = function(e, t, n, o, i) {
        for (var r = 0, s = e; s; s = s[i])
            1 != s.nodeType || t && t != s.tagName || r++;
        return r % n == o
    }
      , compileParts = function(aParts) {
        ...
        for (var sFunc = "", sPushCode = "aRet.push(oEl); if (oOptions.single) { bStop = true; }", i = aParts.length - 1, oPart; oPart = aParts[i]; i--) {
            ...
            sTmpFunc += (0 == i ? "return aRet;" : "") + "})",
            sFunc = sTmpFunc
        }
        return eval("var fpCompiled = " + sFunc + ";"),
        fpCompiled
    }
    ...
    var parseTestQuery = function(sQuery) {
        for (var fpSelf = arguments.callee, aSplitQuery = backupKeys(sQuery).split(/\s*,\s*/), aResult = [], nLen = aSplitQuery.length, aFunc = [], i = 0; nLen > i; i++)
    ...
    var distinct = function(e) {
        ...
        var n = getUID(e);
        return cssquery._marked[t][n] ? !1 : (cssquery._marked[t][n] = !0,
        !0)
    }, oResultCache = null, bUseResultCache = !1, bExtremeMode = !1, old_cssquery = function(e, t, n) {
        if ("object" == typeof e) {
            var o = {};
            for (var i in e)
                e.hasOwnProperty(i) && (o[i] = arguments.callee(e[i], t, n));
            return o
        }
        cost = 0;
        for (var r, s = (new Date).getTime(), a = 0, u = debugOption.repeat; u > a; a++)
            r = function(e, t, n) {
                ...
                /\bMSIE\s([0-9]+(\.[0-9]+)*);/.test(navigator.userAgent) && parseFloat(RegExp.$1) < 6) {
                    try {
                ...
                bXMLDocument = "undefined" != typeof XMLDocument ? oDocument_dontShrink.constructor === XMLDocument : !oDocument_dontShrink.location,
                ...
                for (var a = 0; s > a; a++) {
                    ...
                    if (!l) {
                        var h = parseQuery(u);
                        cssquery._marked = [];
                        for (var f = 0, y = h.depth; y > f; f++)
                            cssquery._marked.push({});
                        l = distinct(h(t, n)),
                        bUseResultCache && !n.oneTimeOffCache && (oResultCache[d]instanceof Array || (oResultCache[d] = []),
                        oResultCache[d].push({
                            parent: t,
                            result: l
                        }))
                ...
                return unsetNodeIndexes(),
                r
            }(e, t, n);
        return s = (new Date).getTime() - s,
    ...
    if (document.querySelectorAll) {
        ...
        try {
            ...
            _toArray = function(e) {
                for (var t = [], n = e.length, o = 0; n > o; o++)
                    t.push(e[o]);
                return t
            }
        }
        cssquery = function(e, t, n) {
            t = t || document;
            try {
                if (_isNonStandardQueryButNotException(e))
    ...
    return cssquery.test = function(e, t) {
        clearKeys();
        for (var n = parseTestQuery(t), o = 0, i = n.length; i > o; o++)
            if (n[o](e))
                return !0;
        return !1
    }
    ...
    cssquery.useCache = function(e) {
        return "undefined" != typeof e && (bUseResultCache = e,
        cssquery.clearCache()),
        bUseResultCache
    }
    ,
    ...
    cssquery.getSingle = function(e, t, n) {
        return cssquery(e, t, {
            single: !0,
            oneTimeOffCache: n ? !!n.oneTimeOffCache : !1
        })[0] || null
    }
    ,
    ...
    cssquery.debug = function(e, t) {
        debugOption.callback = e,
        debugOption.repeat = t || 1
    }
    ,
    cssquery.safeHTML = function(e) {
        var t = /MSIE/.test(window.navigator.userAgent);
        return arguments.length > 0 && (safeHTML = e && t),
        safeHTML || !t
    }
    ,
    cssquery.version = sVersion,
    cssquery.release = function() {
        /MSIE/.test(window.navigator.userAgent) && (delete validUID,
        validUID = {},
...
jindo.$Agent = function() {
    ...
    void (this._dm = document.documentMode)) : new e
}
,
jindo.$Agent.prototype.navigator = function() {
    ...
    t.getName = function() {
        var e = "";
        for (x in t)
            "boolean" == typeof t[x] && t[x] && t.hasOwnProperty(x) && (e = x);
        return e
    }
    ,
    t.edge = e("Edge", i),
    ...
    t.icab = e("iCab", r),
    t.konqueror = e("KDE", r),
    t.mobile = !t.edge && (e("Mobile", i) || e("Android", i) || e("Nokia", i) || e("webOS", i) || e("Opera Mini", i) || e("Opera Mobile", i) || e("BlackBerry", i) || e("Windows", i) && e("PPC", i) || e("Smartphone", i) || e("IEMobile", i)) && !(e("iPad", i) || e("Tablet", i)),
    t.msafari = !t.edge && (!e("IEMobile", i) && e("Mobile", i) || e("iPad", i) && e("Safari", i)) && !t.chrome && !t.opera && !t.firefox,
    ...
    try {
        if (t.ie)
            if (s > 0)
                ...
                o = n = i.match(/(?:MSIE) ([0-9.]+)/)[1];
        else
            t.edge ? n = i.match(/(?:Edge)\/([\d.]+)/)[1] : t.safari || t.msafari ? (n = parseFloat(i.match(/Safari\/([0-9.]+)/)[1]),
            n = 100 == n ? 1.1 : i.match(/Version\/([0-9.]+)/) ? RegExp.$1 : [1, 1.2, -1, 1.3, 2, 3][Math.floor(n / 100)]) : t.mopera ? n = i.match(/(?:Opera\sMini)\/([0-9.]+)/)[1] : t.firefox || t.opera || t.omniweb ? n = i.match(/(?:Firefox|Opera|OmniWeb)\/([0-9.]+)/)[1] : t.mozilla ? n = i.match(/rv:([0-9.]+)/)[1] : t.icab ? n = i.match(/iCab[ \/]([0-9.]+)/)[1] : t.chrome && (n = i.match(/Chrome[ \/]([0-9.]+)/)[1]);
...
jindo.$Agent.prototype.os = function() {
    ...
    return e.getName = function() {
        var t = "";
        for (x in e)
            "boolean" == typeof e[x] && e[x] && e.hasOwnProperty(x) && (t = x);
        return t
    }
    ,
    e.win = o("Win", n),
...
jindo.$Agent.prototype.flash = function() {
    ...
    if (e.installed = !1,
    e.version = -1,
    "undefined" != typeof t && t.length)
        o = t["Shockwave Flash"],
        o && (e.installed = !0,
        o.description && (e.version = parseFloat(o.description.match(/[0-9.]+/)[0]))),
        t["Shockwave Flash 2.0"] && (e.installed = !0,
        e.version = 2);
    else if ("undefined" != typeof n && n.length)
        o = n["application/x-shockwave-flash"],
        e.installed = o && o.enabledPlugin;
    else
        for (var i = 10; i > 1; i--)
            try {
...
jindo.$Agent.prototype.silverlight = function() {
    ...
    "undefined" != typeof t && t.length)
        ...
        try {
            ...
            e.installed = !0,
            n.isVersionSupported("3.0") ? e.version = 3 : n.isVersionSupported("2.0") ? e.version = 2 : n.isVersionSupported("1.0") && (e.version = 1)
        } catch (o) {}
...
jindo.$A = function(e) {
    ...
    e.constructor != String) {
        ...
        for (var n = 0; n < e.length; n++)
            this._array[this._array.length] = e[n]
    }
}
,
...
jindo.$A.prototype.indexOf = function(e) {
    return "undefined" != typeof this._array.indexOf ? jindo.$A.prototype.indexOf = function(e) {
...
jindo.$A.prototype.unshift = function(e) {
    return this._array.unshift.apply(this._array, Array.prototype.slice.apply(arguments)),
    this._array.length
}
,
jindo.$A.prototype.forEach = function(e, t) {
    return "function" == typeof this._array.forEach ? jindo.$A.prototype.forEach = function(e, t) {
        function n(n, o, r) {
            try {
                e.call(t, n, o, r)
            } catch (s) {
    ...
    : jindo.$A.prototype.forEach = function(e, t) {
        ...
        for (var o = this._array, i = this.constructor.Break, r = this.constructor.Continue, s = 0; s < o.length; s++)
            try {
                n(o[s], s, o)
            } catch (a) {
                if (a instanceof i)
...
jindo.$A.prototype.shuffle = function() {
    return this._array.sort(function(e, t) {
...
jindo.$A.prototype.map = function(e, t) {
    return "function" == typeof this._array.map ? jindo.$A.prototype.map = function(e, t) {
        function n(n, o, r) {
            try {
    ...
    : jindo.$A.prototype.map = function(e, t) {
        ...
        for (var o = this._array, i = [], r = this.constructor.Break, s = this.constructor.Continue, a = 0; a < this._array.length; a++)
            try {
                i[a] = n(o[a], a, o)
            } catch (u) {
                if (u instanceof r)
...
jindo.$A.prototype.filter = function(e, t) {
    return "undefined" != typeof this._array.filter ? jindo.$A.prototype.filter = function(e, t) {
...
jindo.$A.prototype.every = function(e, t) {
    return "undefined" != typeof this._array.every ? jindo.$A.prototype.every = function(e, t) {
        return this._array.every(e, t)
    }
    : jindo.$A.prototype.every = function(e, t) {
        var n = !0;
        return this.forEach(function(o, i, r) {
            e.call(t, o, i, r) === !1 && (n = !1,
            jindo.$A.Break())
        }),
        n
    }
...
jindo.$A.prototype.some = function(e, t) {
    return "undefined" != typeof this._array.some ? jindo.$A.prototype.some = function(e, t) {
        return this._array.some(e, t)
    }
    : jindo.$A.prototype.some = function(e, t) {
        var n = !1;
        return this.forEach(function(o, i, r) {
            e.call(t, o, i, r) === !0 && (n = !0,
            jindo.$A.Break())
        }),
        n
    }
...
jindo.$A.prototype.unique = function() {
    var e, t, n = this._array, o = [], i = n.length;
    for (e = 0; i > e; e++) {
...
jindo.$Ajax = function(e, t) {
    function n() {
        ...
        if (this._checkCORSUrl(this._url)) {
            ...
            if (window.XDomainRequest)
                return this._bXDomainRequest = !0,
                new XDomainRequest
        } else {
            if (e)
                return e;
    ...
    var i = this._options;
    switch (i.type = i.type.toLowerCase(),
    ...
    case "post":
        ...
        i.type = "xhr";
    case "xhr":
        this._request = n.call(this),
        this._checkCORS(this._url, i.type);
        break;
    case "flash":
...
jindo.$Ajax.prototype._onload = function(e) {
    return e ? function() {
        var e, t = this._request.status, n = 4 == this._request.readyState && (200 == t || 0 == t) || this._bXDomainRequest && !!this._request.responseText;
        if (4 == this._request.readyState || this._bXDomainRequest)
            try {
                200 != this._request.status && "function" == typeof this._options.onerror ? 0 == !this._request.status && this._options.onerror(jindo.$Ajax.Response(this._request)) : this._is_abort || (e = this._options.onload(jindo.$Ajax.Response(this._request)))
            } finally {
                if ("function" == typeof this._oncompleted && this._oncompleted(n, e),
    ...
    : function() {
        var e, t = 4 == this._request.readyState && 200 == this._request.status;
        if (4 == this._request.readyState)
            try {
                200 != this._request.status && "function" == typeof this._options.onerror ? this._options.onerror(jindo.$Ajax.Response(this._request)) : e = this._options.onload(jindo.$Ajax.Response(this._request))
            } finally {
                this._status--,
                "function" == typeof this._oncompleted && this._oncompleted(t, e)
            }
    }
}(/MSIE/.test(window.navigator.userAgent)),
jindo.$Ajax.prototype.request = function(e) {
    this._status++;
    var t, n, o = this, i = this._request, r = this._options, s = [], t = "", a = null, u = this._url;
    this._is_abort = !1;
    ...
    if (r.postBody && "XHR" == l && "GET" != d)
        ...
        for (var c in e)
            ...
            n instanceof Array || n instanceof jindo.$A ? jindo.$A(n).forEach(function(e, t, n) {
                s[s.length] = c + "=" + encodeURIComponent(e)
            }) : s[s.length] = c + "=" + encodeURIComponent(n));
        t = s.join("&")
    } else
        t = null;
    if (t && "XHR" == l && "GET" == d && (u += -1 == u.indexOf("?") ? "?" : "&",
    u += t,
    t = null),
    i.open(d, u, !!r.async),
    r.withCredentials && (i.withCredentials = !0),
    this._bCORS && r.sendheader === !1 && (i.setRequestHeader = null),
    "XHR" == l && "GET" == d && /MSIE|Trident/.test(window.navigator.userAgent) && i.setRequestHeader && i.setRequestHeader("If-Modified-Since", "Thu, 1 Jan 1970 00:00:00 GMT"),
    ("XHR" == l || "IFRAME" == l || "FLASH" == l && r.sendheader) && i.setRequestHeader) {
        this._headers["Content-Type"] || i.setRequestHeader("Content-Type", "application/x-www-form-urlencoded; charset=utf-8"),
        i.setRequestHeader("charset", "utf-8"),
        this._bCORS || this._headers["X-Requested-With"] || i.setRequestHeader("X-Requested-With", "XMLHttpRequest");
        for (var p in this._headers)
            if (this._headers.hasOwnProperty(p)) {
                if ("function" == typeof this._headers[p])
                    continue;
    ...
    if (!i.addEventListener || f.indexOf("Opera") > -1 || f.indexOf("MSIE") > -1)
        if ("undefined" != typeof i.onload) {
            if (i.onload = function(e) {
                4 != i.readyState || o._is_abort || (clearTimeout(a),
                a = void 0,
                o._onload(e))
            }
            ,
            this._bXDomainRequest) {
                var h = i.onload;
                i.onload = function(e) {
                    o._request.readyState = 4,
                    o._request.status = 200,
                    h(e)
                }
                ,
                i.onerror = function(e) {
                    o._request.readyState = 4,
                    o._request.status = 404,
                    h(e)
                }
            }
        } else if (6 == window.navigator.userAgent.match(/(?:MSIE) ([0-9.]+)/)[1] && r.async) {
            var y = function(e) {
                4 != i.readyState || o._is_abort || (a && (clearTimeout(a),
                a = void 0),
                o._onload(e),
    ...
    return r.timeout > 0 && (this._timer && clearTimeout(this._timer),
    a = setTimeout(function() {
        o._is_abort = !0,
        o._interval && (clearInterval(o._interval),
        o._interval = void 0);
        try {
            i.abort()
        } catch (e) {}
        r.ontimeout(i),
        "function" == typeof o._oncompleted && o._oncompleted(!1)
    }, 1e3 * r.timeout),
    this._timer = a),
    this._test_url = u,
    i.send(t),
...
jindo.$Ajax.prototype.option = function(e, t) {
    if ("undefined" == typeof e)
        return "";
    if ("string" == typeof e)
        return "undefined" == typeof t ? this._options[e] : (this._options[e] = t,
        this);
    try {
        for (var n in e)
            e.hasOwnProperty(n) && (this._options[n] = e[n])
    } catch (o) {}
    return this
}
,
jindo.$Ajax.prototype.header = function(e, t) {
    if ("undefined" == typeof e)
        return "";
    if ("string" == typeof e)
        return "undefined" == typeof t ? this._headers[e] : (this._headers[e] = t,
        this);
    try {
        for (var n in e)
            e.hasOwnProperty(n) && (this._headers[n] = e[n])
    } catch (o) {}
    return this
}
,
...
jindo.$Ajax.Response.prototype.header = function(e) {
    return "string" == typeof e ? this._response.getResponseHeader(e) : this._response.getAllResponseHeaders()
}
,
...
jindo.$Ajax.JSONPRequest = jindo.$Class({
    ...
    _callback: function(e) {
        this._onerror && (clearTimeout(this._onerror),
        this._onerror = null);
        var t = this;
        this.responseJSON = e,
        this.onload(this),
    ...
    send: function(e) {
        ...
        o ? o.appendChild(this._script) : document.body && document.body.appendChild(this._script),
        ...
        i.navigator().ie || i.navigator().opera ? this._script.onreadystatechange = function() {
            "loaded" == this.readyState && (t.responseJSON || (t.readyState = 4,
            t.status = 500,
...
jindo.$Ajax.SWFRequest = jindo.$Class({
    ...
    _getFlashObj: function() {
        var e, t = jindo.$Agent(window.navigator).navigator();
        return e = t.ie && 9 == t.version ? document.getElementById(jindo.$Ajax.SWFRequest._tmpId) : window.document[jindo.$Ajax.SWFRequest._tmpId],
        ...
        200 == this.status) {
            if ("string" == typeof t)
                try {
                    ...
                    "URIError" == o.name && (this.responseText = t,
                    this.responseText && "" != this.responseText || (this.responseText = t))
                }
        ...
        function t(e) {
            ...
            case "object":
                ...
                if (e instanceof Array) {
                    ...
                    for (var r in e)
                        e.hasOwnProperty(r) && (o[o.length] = t(r) + ":" + t(e[r]));
                    n = "{" + o.join(",") + "}"
                }
                return n;
            default:
...
jindo.$Ajax.SWFRequest.loaded = function() {
    ...
    jindo.$Ajax.SWFRequest.activeFlash = !0
}
,
jindo.$Ajax.FrameRequest = jindo.$Class({
    ...
    send: function(e) {
        ...
        for (var s in this._headers)
            this._headers.hasOwnProperty(s) && (r[r.length] = "'" + s + "':'" + this._headers[s] + "'");
        r = "{" + r.join(",") + "}",
        i.push("&id=" + o.id),
        ...
        u.firstChild ? u.insertBefore(a, u.firstChild) : u.appendChild(a),
        a.src = i.join("")
    }
}).extend(jindo.$Ajax.RequestBase),
jindo.$Ajax.Queue = function(e) {
    var t = arguments.callee;
    return this instanceof t ? (this._options = {
        async: !1,
        useResultAsParam: !1,
        stopOnFailure: !1
    },
    this.option(e),
    void (this._queue = [])) : new t(e)
}
,
...
jindo.$Ajax.Queue.prototype._requestSync = function(e, t) {
    var n = this;
    this._queue.length > e + 1 && (this._queue[e].obj._oncompleted = function(t, o) {
    ...
    if (this.option("useResultAsParam") && t)
        try {
            for (var i in t)
                "undefined" == typeof o[i] && t.hasOwnProperty(i) && (o[i] = t[i])
        } catch (r) {}
...
jindo.$Ajax.Queue.prototype._requestAsync = function() {
    for (var e = 0; e < this._queue.length; e++)
        this._queue[e].obj.request(this._queue[e].param)
}
,
jindo.$H = function(e) {
    var t = arguments.callee;
    if ("undefined" == typeof e && (e = new Object),
    e instanceof t)
        return e;
    if (!(this instanceof t))
        return new t(e);
    this._table = {};
    for (var n in e)
        e.hasOwnProperty(n) && (this._table[n] = e[n])
}
,
...
jindo.$H.prototype.$ = function(e, t) {
    return "undefined" == typeof t ? this._table[e] : (this._table[e] = t,
    this)
}
,
...
jindo.$H.prototype.forEach = function(e, t) {
    ...
    for (var i in n)
        if (n.hasOwnProperty(i)) {
            if (!n.propertyIsEnumerable(i))
                continue;
            try {
                e.call(t, n[i], i, n)
            } catch (r) {
                if (r instanceof o.Break)
                    break;
...
jindo.$H.prototype.add = function(e, t) {
    return this._table[e] = t,
    this
}
,
jindo.$H.prototype.remove = function(e) {
    if ("undefined" == typeof this._table[e])
        return null;
    var t = this._table[e];
    return delete this._table[e],
    t
}
,
jindo.$H.prototype.search = function(e) {
    var t = !1;
    return this.forEach(function(n, o, i) {
        n === e && (t = o,
        jindo.$H.Break())
    }),
    t
...
jindo.$H.prototype.keys = function() {
    var e = new Array;
    for (var t in this._table)
        this._table.hasOwnProperty(t) && e.push(t);
    return e
}
,
jindo.$H.prototype.values = function() {
    var e = [];
    for (var t in this._table)
        this._table.hasOwnProperty(t) && (e[e.length] = this._table[t]);
    return e
}
,
    ...
    for (var n in this._table)
        if (this._table.hasOwnProperty(n))
            if ("object" == typeof (t = this._table[n]) && t.constructor == Array)
                ...
                e[e.length] = encodeURIComponent(n) + "=" + encodeURIComponent(this._table[n] + "");
    return e.join("&")
}
,
jindo.$H.prototype.empty = function() {
    for (var e = this.keys(), t = 0; t < e.length; t++)
        delete this._table[e[t]];
    return this
}
,
...
jindo.$Json = function(e) {
    ...
    e instanceof t ? e : this instanceof t ? void ("string" == typeof e ? this._object = jindo.$Json._oldMakeJSON(e) : this._object = e) : new t(e)
}
,
...
jindo.$Json.fromXML = function(e) {
    var t = {}
      , n = /\s*<(\/?[\w:\-]+)((?:\s+[\w:\-]+\s*=\s*(?:"(?:\\"|[^"])*"|'(?:\\'|[^'])*'))*)\s*((?:\/>)|(?:><\/\1>|\s*))|\s*<!\[CDATA\[([\w\W]*?)\]\]>\s*|\s*>?([^<]*)/gi
      , o = /^[0-9]+(?:\.[0-9]+)?$/
      , i = {
        "&amp;": "&",
        "&nbsp;": " ",
      ...
      , s = function(e) {
        return "undefined" == typeof e ? "" : e.replace(/&[a-z]+;/g, function(e) {
            return "string" == typeof i[e] ? i[e] : e
        })
    }
      , a = function(e, t) {
        e.replace(/([\w\:\-]+)\s*=\s*(?:"((?:\\"|[^"])*)"|'((?:\\'|[^'])*)')/g, function(e, n, o, i) {
            t[n] = s((o ? o.replace(/\\"/g, '"') : void 0) || (i ? i.replace(/\\'/g, "'") : void 0))
        })
    }
      , u = function(e) {
        for (var t in e)
      ...
      , l = function(e, t, n, i, l, d) {
        ...
        if ("string" == typeof t && t)
            ...
            "string" == typeof l && l ? p = l : "string" == typeof d && d && (p = s(d));
        if (p.replace(/^\s+/g, "").length > 0) {
            var g = r.stack[f - 1]
              , v = r.tags[f];
            if (o.test(p) ? p = parseFloat(p) : "true" == p ? p = !0 : "false" == p && (p = !1),
            "undefined" == typeof g)
                return;
            if (g[v]instanceof Array) {
                var j = g[v];
                "object" != typeof j[j.length - 1] || u(j[j.length - 1]) ? j[j.length - 1] = p : (j[j.length - 1].$cdata = p,
                j[j.length - 1].toString = function() {
                    return p
                }
                )
            } else
                "object" != typeof g[v] || u(g[v]) ? g[v] = p : (g[v].$cdata = p,
...
jindo.$Json.prototype.get = function(e) {
    for (var t, n, o, i, r, s = this._object, a = e.split("/"), u = /^([\w:\-]+)\[([0-9]+)\]$/, l = [[s]], d = l[0], c = a.length, p = 0; c > p; p++)
        if ("." != a[p] && "" != a[p]) {
            if (".." == a[p])
                l.length--;
            else {
                ...
                0 == t)
                    return [];
                for (u.test(a[p]) && (n = +RegExp.$2),
                i = 0; t > i; i++)
                    r = d[i][a[p]],
                    "undefined" != typeof r && (r instanceof Array ? n > -1 ? n < r.length && (o[o.length] = r[n]) : o = o.concat(r) : -1 == n && (o[o.length] = r));
                l[l.length] = o
            }
            d = l[l.length - 1]
        }
...
jindo.$Json._oldToString = function(e) {
    var t = {
        $: function(e) {
            return "object" == typeof e && null == e ? "null" : "undefined" == typeof e ? '""' : "boolean" == typeof e ? e ? "true" : "false" : "string" == typeof e ? this.s(e) : "number" == typeof e ? e : e instanceof Array ? this.a(e) : e instanceof Object ? this.o(e) : void 0
        },
        s: function(e) {
            var t = {
                '"': '\\"',
        ...
        a: function(e) {
            for (var t = "[", n = "", o = e.length, i = 0; o > i; i++)
                "function" != typeof e[i] && (t += n + this.$(e[i]),
                n || (n = ","));
            return t + "]"
        },
        o: function(e) {
            ...
            if (t instanceof Array)
                ...
                for (var u in t)
                    if (t.hasOwnProperty(u)) {
                        if ("$cdata" == u || "function" == typeof t[u])
                            continue;
                        i += e(t[u], u)
                    }
                n && (i = o(i, a))
...
jindo.$Json.prototype.compare = function(e) {
    return jindo.$Json._oldToString(this._object).toString() == jindo.$Json._oldToString(jindo.$Json(e).$value()).toString()
}
,
...
jindo.$Cookie = function() {
    var e = arguments.callee;
    e._cached;
    return e._cached ? e._cached : this instanceof e ? void ("undefined" == typeof e._cached && (e._cached = this)) : new e
}
,
jindo.$Cookie.prototype.keys = function() {
    for (var e = document.cookie.split(";"), t = /^\s+|\s+$/g, n = new Array, o = 0; o < e.length; o++)
        n[n.length] = e[o].substr(0, e[o].indexOf("=")).replace(t, "");
    return n
}
,
jindo.$Cookie.prototype.get = function(e) {
    for (var t = document.cookie.split(/\s*;\s*/), n = new RegExp("^(\\s*" + e + "\\s*=)"), o = 0; o < t.length; o++)
        if (n.test(t[o]))
            return unescape(t[o].substr(RegExp.$1.length));
    return null
}
,
jindo.$Cookie.prototype.set = function(e, t, n, o, i) {
    var r = "";
    return "number" == typeof n && (r = ";expires=" + new Date((new Date).getTime() + 1e3 * n * 60 * 60 * 24).toGMTString()),
...
jindo.$Cookie.prototype.remove = function(e, t, n) {
    return null != this.get(e) && this.set(e, "", -1, t, n),
    this
}
,
jindo.$Event = function(e) {
    var t = arguments.callee;
    return e instanceof t ? e : this instanceof t ? ("undefined" == typeof e && (e = window.event),
    e === window.event && document.createEventObject && (e = document.createEventObject(e)),
    this._event = e,
    this._globalEvent = window.event,
    this.type = e.type.toLowerCase(),
    "dommousescroll" == this.type ? this.type = "mousewheel" : "domcontentloaded" == this.type && (this.type = "domready"),
    this.canceled = !1,
    this.element = e.target || e.srcElement,
    this.currentElement = e.currentTarget,
    this.relatedElement = null,
    void ("undefined" != typeof e.relatedTarget ? this.relatedElement = e.relatedTarget : e.fromElement && e.toElement && (this.relatedElement = e["mouseout" == this.type ? "toElement" : "fromElement"]))) : new t(e)
}
,
...
jindo.$Event.prototype.pos = function(e) {
    ...
    if (e && jindo.$Element) {
        ...
        r.offsetX = r.pageX - s.left,
        r.offsetY = r.pageY - s.top
    }
    return r
}
,
...
jindo.$Element.prototype.visible = function(e, t) {
    return "undefined" != typeof e ? (this[e ? "show" : "hide"](t),
    this) : "none" != this.css("display")
}
,
...
jindo.$Element.prototype.toggle = function(e) {
    return this[this.visible() ? "hide" : "show"](e),
    this
}
,
jindo.$Element.prototype.opacity = function(e) {
    var t, n = this._element, o = "none" != this._getCss(n, "display");
    return e = parseFloat(e),
    n.style.zoom = 1,
    isNaN(e) ? ("undefined" != typeof n.filters ? (t = "undefined" == typeof n.filters.alpha ? o ? 100 : 0 : n.filters.alpha.opacity,
    t /= 100) : (t = parseFloat(n.style.opacity),
    isNaN(t) && (t = o ? 1 : 0)),
    t) : (e = Math.max(Math.min(e, 1), 0),
    "undefined" != typeof n.filters ? (e = Math.ceil(100 * e),
    "unknown" != typeof n.filters && "undefined" != typeof n.filters.alpha ? n.filters.alpha.opacity = e : n.style.filter = n.style.filter + " alpha(opacity=" + e + ")") : n.style.opacity = e,
    e)
}
,
jindo.$Element.prototype.css = function(e, t) {
    var n = this._element
      , o = typeof t;
    if ("opacity" == e)
        return "undefined" == o ? this.opacity() : this.opacity(t);
    var i = typeof e;
    if ("string" == i) {
        if ("string" != o && "number" != o) {
            ...
            if ((IS_FF || IS_SF || IS_CH) && ("padding" == e || "margin" == e)) {
                var a = r(n, e + "Top")
                  ...
                  , l = r(n, e + "Bottom")
                  , d = r(n, e + "Left");
                return a == u && l == d ? a : a == l && u == d ? a + " " + u : a + " " + u + " " + l + " " + d
            }
            return r(n, e)
        }
        var c = {};
    ...
    var p = jindo.$H;
    if ("undefined" != typeof p && e instanceof p && (e = e._table),
    "object" == typeof e) {
        var f, h;
        for (var y in e)
            if (e.hasOwnProperty(y)) {
                ...
                if ("cssFloat" == y && IS_IE && (y = "styleFloat"),
...
jindo.$Element.prototype._getCss = function(e, t) {
    var n;
    return n = e.currentStyle ? function(e, t) {
        try {
    ...
    : window.getComputedStyle ? function(e, t) {
        try {
            ...
            var n = e.ownerDocument || e.document || document
              , o = e.style[t] || n.defaultView.getComputedStyle(e, null).getPropertyValue(t.replace(/([A-Z])/g, "-$1").toLowerCase());
            return "textDecoration" == t && (o = o.replace(",", "")),
            o
        } catch (i) {
            throw new Error((e.tagName || "document") + "는 css를 사용 할수 없습니다.")
        }
    ...
    : function(e, t) {
        try {
            return "cssFloat" == t && IS_IE && (t = "styleFloat"),
            e.style[t]
        } catch (n) {
            throw new Error((e.tagName || "document") + "는 css를 사용 할수 없습니다.")
        }
...
jindo.$Element.prototype._setCss = function(e, t, n) {
    "#top#left#right#bottom#".indexOf(t + "#") > 0 && ("number" == typeof n || /\d$/.test(n)) ? e.style[t] = parseInt(n, 10) + "px" : e.style[t] = n
}
,
jindo.$Element.prototype.attr = function(e, t) {
    ...
    if ("string" == typeof e) {
        if ("undefined" == typeof t)
            return "class" == e || "className" == e ? n.className : "style" == e ? n.style.cssText : "checked" == e || "disabled" == e ? !!n[e] : "value" == e ? n.value : "href" == e ? n.getAttribute(e, 2) : n.getAttribute(e);
        var o = {};
        o[e] = t,
        e = o
    }
    if ("undefined" != typeof jindo.$H && e instanceof jindo.$H && (e = e.$value()),
    "object" == typeof e)
        for (var i in e)
            e.hasOwnProperty(i) && ("undefined" != typeof t && null === t ? n.removeAttribute(i) : "class" == i || "className" == i ? n.className = e[i] : "style" == i ? n.style.cssText = e[i] : "checked" == i || "disabled" == i ? n[i] = e[i] : "value" == i ? n.value = e[i] : n.setAttribute(i, e[i]));
    return this
}
,
...
jindo.$Element.prototype.className = function(e) {
    var t = this._element;
    return "undefined" == typeof e ? t.className : (t.className = e,
    this)
}
,
jindo.$Element.prototype.hasClass = function(e) {
    return this._element.classList ? jindo.$Element.prototype.hasClass = function(e) {
...
jindo.$Element.prototype.addClass = function(e) {
    return this._element.classList ? jindo.$Element.prototype.addClass = function(e) {
...
jindo.$Element.prototype.removeClass = function(e) {
    return this._element.classList ? jindo.$Element.prototype.removeClass = function(e) {
    ...
    : jindo.$Element.prototype.removeClass = function(e) {
        for (var t, n = this._element, o = e.split(/\s+/), i = o.length - 1; i >= 0; i--)
            t = o[i],
            this.hasClass(t) && (n.className = (" " + n.className.replace(/\s+$/, "").replace(/^\s+/, "") + " ").replace(" " + t + " ", " ").replace(/\s+$/, "").replace(/^\s+/, ""));
        return this
    }
    ,
    this.removeClass(e)
...
jindo.$Element.prototype.toggleClass = function(e, t) {
    return this._element.classList ? jindo.$Element.prototype.toggleClass = function(e, t) {
        return "undefined" == typeof t ? this._element.classList.toggle(e) : this.hasClass(e) ? (this.removeClass(e),
        this.addClass(t)) : (this.addClass(e),
        this.removeClass(t)),
        this
    }
    : jindo.$Element.prototype.toggleClass = function(e, t) {
        ...
        t && this.addClass(t)) : (this.addClass(e),
...
jindo.$Element.prototype.html = function(e) {
    var t = IS_IE
      , n = IS_FF;
    return t ? jindo.$Element.prototype.html = function(e) {
        if ("undefined" != typeof e && arguments.length) {
            e += "",
            jindo.$$.release();
            for (var t = this._element; t.firstChild; )
                t.removeChild(t.firstChild);
            var n, o = "R" + (new Date).getTime() + parseInt(1e5 * Math.random(), 10), i = t.ownerDocument || t.document || document, r = t.tagName.toLowerCase();
            switch (r) {
            case "select":
            case "table":
            ...
            case "colgroup":
                n = i.createElement("div"),
                n.innerHTML = "<table><" + r + ' class="' + o + '">' + e + "</" + r + "></table>";
                break;
            default:
                t.innerHTML = e
            }
    ...
    : n ? jindo.$Element.prototype.html = function(e) {
        if ("undefined" != typeof e && arguments.length) {
            e += "";
            var t = this._element;
            if (t.parentNode)
...
jindo.$Element._getTransition = function() {
    var e = !1
      , t = "";
    return "undefined" != typeof document.body.style.trasition ? (e = !0,
    t = "trasition") : "undefined" != typeof document.body.style.webkitTransition ? (e = !0,
    t = "webkitTransition") : "undefined" != typeof document.body.style.OTransition && (e = !0,
    t = "OTransition"),
    (jindo.$Element._getTransition = function() {
        return {
            hasTransition: e,
...
jindo.$Element.prototype.appear = function(e, t) {
    ...
    return n.hasTransition ? jindo.$Element.prototype.appear = function(e, t) {
        e = e || .3;
        var o = this;
        t = t || function() {}
        ;
        var i = function() {
            t(),
            o.show(),
            this.removeEventListener(n.name + "End", arguments.callee, !1)
        }
          , r = this._element;
        return this.visible() || (r.style.opacity = r.style.opacity || 0,
        o.show()),
    ...
    : jindo.$Element.prototype.appear = function(e, t) {
        ...
        var r = (1 - o) / (100 * (e || .3))
          , s = function() {
            o += r,
            n.opacity(o),
            o >= 1 ? t(n) : n._fade_timer = setTimeout(s, 10)
        };
        return this.show(),
        s(),
        this
...
jindo.$Element.prototype.disappear = function(e, t) {
    var n = jindo.$Element._getTransition();
    return n.hasTransition ? jindo.$Element.prototype.disappear = function(e, t) {
        e = e || .3;
        var o = this;
        t = t || function() {}
        ;
        var i = function() {
          ...
          , r = this._element;
        return r.addEventListener(n.name + "End", i, !1),
        r.style[n.name + "Property"] = "opacity",
        r.style[n.name + "Duration"] = e + "s",
        r.style[n.name + "TimingFunction"] = "linear",
        setTimeout(function() {
    ...
    : jindo.$Element.prototype.disappear = function(e, t) {
        ...
        var r = o / (100 * (e || .3))
          , s = function() {
            ...
            0 >= o ? (n.hide(),
            n.opacity(1),
            t(n)) : n._fade_timer = setTimeout(s, 10)
        };
        return s(),
        this
    }
...
jindo.$Element.prototype.offset = function(e, t) {
    ...
    if ("number" == typeof e && "number" == typeof t) {
        ...
        return n.style.top = parseInt(this.css("top"), 10) + r.top + "px",
    ...
    var s = /Safari/.test(navigator.userAgent)
      ...
      , l = function(e) {
        for (var t = {
            left: 0,
            top: 0
        }, n = e, o = n.offsetParent; n = n.parentNode; )
            n.offsetParent && (t.left -= n.scrollLeft,
            t.top -= n.scrollTop),
            n == o && (t.left += e.offsetLeft + n.clientLeft,
            t.top += e.offsetTop + n.clientTop,
            n.offsetParent || (t.left += n.offsetLeft,
            t.top += n.offsetTop),
            o = n.offsetParent,
            e = n);
        return t
      ...
      , d = function(e) {
        ...
        if (e.getBoundingClientRect) {
            ...
            t.left = d.screenX - c.screenX,
            t.top = d.screenY - c.screenY
        } else {
            for (var p = e; p; p = p.offsetParent)
                t.left += p.offsetLeft,
                t.top += p.offsetTop;
            for (var p = e.parentNode; p && "BODY" != p.tagName; p = p.parentNode)
                "TR" == p.tagName && (t.top += 2),
                t.left -= p.scrollLeft,
                t.top -= p.scrollTop
        }
        return t
...
jindo.$Element.prototype.evalScripts = function(sHTML) {
    var aJS = [];
    return sHTML = sHTML.replace(new RegExp("<script(\\s[^>]+)*>(.*?)</script>","gi"), function(e, t, n) {
        return aJS.push(n),
        ""
    }),
    eval(aJS.join("\n")),
...
jindo.$Element._append = function(e, t) {
    return "string" == typeof t ? t = jindo.$(t) : t instanceof jindo.$Element && (t = t.$value()),
...
jindo.$Element._prepend = function(e, t) {
    ...
    var n = e.childNodes;
    return n.length > 0 ? e.insertBefore(t._element, n[0]) : e.appendChild(t._element),
    t
}
,
...
jindo.$Element.prototype.replace = function(e) {
    ...
    var t = this._element
      ...
      , o = jindo.$Element(e);
    if (n && n.replaceChild)
        return n.replaceChild(o.$value(), t),
        o;
    var o = o.$value();
...
jindo.$Element.prototype.appendTo = function(e) {
    ...
    return jindo.$Element._append(t, this._element),
    t
}
,
jindo.$Element.prototype.prependTo = function(e) {
    return jindo.$Element._prepend(e, this),
    jindo.$Element(e)
}
,
jindo.$Element.prototype.before = function(e) {
    var t = jindo.$Element(e)
      , n = t.$value();
    return this._element.parentNode.insertBefore(n, this._element),
    t
}
,
...
jindo.$Element.prototype.parent = function(e, t) {
    var n = this._element
      ...
      , i = null;
    if ("undefined" == typeof e)
        return jindo.$Element(n.parentNode);
    for (("undefined" == typeof t || 0 == t) && (t = -1); n.parentNode && 0 != t-- && (i = jindo.$Element(n.parentNode),
    n.parentNode != document.documentElement); )
        (!e || e && e(i)) && (o[o.length] = i),
        n = n.parentNode;
    return o
}
,
jindo.$Element.prototype.child = function(e, t) {
    var n = this._element
      , o = []
      , i = null;
    return "undefined" == typeof e ? jindo.$A(n.childNodes).filter(function(e) {
        return 1 == e.nodeType
    }).map(function(e) {
        return jindo.$Element(e)
    }).$value() : (("undefined" == typeof t || 0 == t) && (t = -1),
    (i = function(t, n) {
        for (var r = null, s = null, a = 0; a < t.childNodes.length; a++)
            r = t.childNodes[a],
            1 == r.nodeType && (s = jindo.$Element(t.childNodes[a]),
...
jindo.$Element._contain = function(e, t) {
    return document.compareDocumentPosition ? jindo.$Element._contain = function(e, t) {
        return !!(16 & e.compareDocumentPosition(t))
    }
    : document.body.contains ? jindo.$Element._contain = function(e, t) {
        return e !== t && (e.contains ? e.contains(t) : !0)
    }
    : jindo.$Element._contain = function(e, t) {
        for (var n = e, o = t; n && n.parentNode; )
            if (n = n.parentNode,
            n == o)
                return !0;
        return !1
...
jindo.$Element.prototype.fireEvent = function(e, t) {
    function n(e, t) {
        ...
        if (t) {
            for (k in t)
                t.hasOwnProperty(k) && (n[k] = t[k]);
            n.button = (t.left ? 1 : 0) + (t.middle ? 4 : 0) + (t.right ? 2 : 0),
            n.relatedTarget = t.relatedElement || null
        }
        var o = this._element;
        return "input" == this.tag && "click" == e && ("checkbox" == o.type ? o.checked = !o.checked : "radio" == o.type && (o.checked = !0)),
    ...
    function o(e, t) {
        var n = "HTMLEvents";
        e = (e + "").toLowerCase(),
        "click" == e || 0 == e.indexOf("mouse") ? (n = "MouseEvent",
        "mousewheel" == e && (e = "dommousescroll")) : 0 == e.indexOf("key") && (n = "KeyboardEvent");
        var o;
        if (t)
            switch (t.button = 0 + (t.middle ? 1 : 0) + (t.right ? 2 : 0),
            t.ctrl = t.ctrl || !1,
            t.alt = t.alt || !1,
            t.shift = t.shift || !1,
            t.meta = t.meta || !1,
            ...
            case "MouseEvent":
                ...
                o.initMouseEvent(e, !0, !0, null, t.detail || 0, t.screenX || 0, t.screenY || 0, t.clientX || 0, t.clientY || 0, t.ctrl, t.alt, t.shift, t.meta, t.button, t.relatedElement || null);
                break;
            case "KeyboardEvent":
                if (window.KeyEvent)
                    o = document.createEvent("KeyEvents"),
                    o.initKeyEvent(e, !0, !0, window, t.ctrl, t.alt, t.shift, t.meta, t.keyCode, t.keyCode);
                else
                    try {
            ...
            o = document.createEvent(n),
            o.initEvent(e, !0, !0);
        return this._element.dispatchEvent(o),
        this
    }
    return jindo.$Element.prototype.fireEvent = "undefined" != typeof this._element.dispatchEvent ? o : n,
    this.fireEvent(e, t)
}
,
jindo.$Element.prototype.empty = function() {
    return jindo.$$.release(),
    this.html(""),
    this
}
,
...
jindo.$Element.prototype.leave = function() {
    var e = this._element;
    return e.parentNode && (jindo.$$.release(),
...
jindo.$Element.prototype.wrap = function(e) {
    var t = this._element;
    return e = jindo.$Element(e).$value(),
...
jindo.$Element.prototype.indexOf = function(e) {
    try {
        for (var t = jindo.$Element(e).$value(), n = this._element.childNodes, o = 0, i = n.length, r = 0; i > r; r++)
            if (1 == n[r].nodeType) {
                if (n[r] === t)
                    return o;
                o++
...
jindo.$Element.insertAdjacentHTML = function(e, t, n, o, i) {
    var r = e._element;
    if (r.insertAdjacentHTML && !/^<(option|tr|td|th|col)(?:.*?)>/.test(t.replace(/^(\s|　)+|(\s|　)+$/g, "").toLowerCase()))
        r.insertAdjacentHTML(n, t);
    else {
        var s, a = r.ownerDocument || r.document || document, u = a.createDocumentFragment(), l = t.replace(/^(\s|　)+|(\s|　)+$/g, ""), d = {
            option: "select",
            tr: "tbody",
            thead: "table",
            tbody: "table",
            ...
            th: "tr",
            div: "div"
        }, c = /^\<(option|tr|thead|tbody|td|th|col)(?:.*?)\>/i.exec(l), p = null === c ? "div" : c[1].toLowerCase(), f = d[p];
...
jindo.$Element.prototype.prependHTML = function(e) {
    return jindo.$Element.insertAdjacentHTML(this, e, "afterBegin", "lastChild", jindo.$Fn(function(e) {
        this.prepend(e)
    }, this).bind())
}
,
...
jindo.$Element.prototype.afterHTML = function(e) {
    return jindo.$Element.insertAdjacentHTML(this, e, "afterEnd", "lastChild", jindo.$Fn(function(e) {
...
jindo.$Element.prototype.delegate = function(e, t, n) {
    if (!this._element["_delegate_" + e]) {
        ...
        var o = jindo.$Fn(function(e, t) {
            t = t || window.event,
            "undefined" == typeof t.currentTarget && (t.currentTarget = this._element);
            var n, o, i, r, s = t.target || t.srcElement, a = this._element["_delegate_" + e];
            for (var u in a)
                if (n = a[u],
                r = n.checker(s),
                r[0]) {
        ...
        this._element._delegate_events ? this._element._delegate_events.push(e) : this._element._delegate_events = [e],
        i = null
    }
    return this._bind(e, t, n),
    this
}
,
jindo.$Element._eventBind = function(e, t, n) {
    e.addEventListener ? jindo.$Element._eventBind = function(e, t, n) {
...
jindo.$Element.prototype._bind = function(e, t, n) {
    ...
    if (o) {
        var i;
        "string" == typeof t ? i = jindo.$Fn(function(e, t) {
            var n = t
              , o = jindo.$$.test(t, e);
            if (!o)
            ...
            return [o, n]
        }, this).bind(t) : "function" == typeof t && (i = jindo.$Fn(function(e, t) {
            var n = t
              , o = e(this._element, t);
            if (!o)
                for (var i = this._getParent(t), r = 0, s = i.length; s > r; r++)
...
jindo.$Element.prototype._getParent = function(e) {
    for (var t = this._element, n = [], o = null; e.parentNode && o != t && (o = e.parentNode,
...
jindo.$Element.prototype._unbind = function(e, t, n) {
    ...
    if (e && t && n) {
        ...
        jindo.$Element._deleteFilter(o, e, t);
    else if (e)
        jindo.$Element._deleteEvent(o, e, t);
    else {
...
jindo.$Element._deleteFilter = function(e, t, n) {
    ...
    o && o[n] && (1 == jindo.$H(o).keys().length ? jindo.$Element._deleteEvent(e, t, n) : jindo.$Element._delDelegateInfo(o, n))
}
,
jindo.$Element._deleteEvent = function(e, t, n) {
    ...
    o.length ? e._delegate_events = jindo.$A(o).refuse(t).$value() : jindo.$Element._delDelegateInfo(e, "_delegate_events")
}
,
jindo.$Element._unEventBind = function(e, t, n) {
    e.removeEventListener ? jindo.$Element._unEventBind = function(e, t, n) {
...
jindo.$Fn = function(func, thisObject) {
    ...
    return func instanceof cl ? func : this instanceof cl ? (this._events = [],
    this._tmpElm = null,
    this._key = null,
    void ("function" == typeof func ? (this._func = func,
    this._this = thisObject) : "string" == typeof func && "string" == typeof thisObject && (this._func = eval("false||function(" + func + "){" + thisObject + "}")))) : new cl(func,thisObject)
}
;
var _ua = navigator.userAgent;
if (jindo.$Fn.prototype.$value = function() {
    return this._func
}
,
...
jindo.$Fn.prototype.bindForEvent = function() {
    var e = arguments
      ...
      , i = function(i) {
        ...
        r.unshift(s);
        var a = t.apply(n, r);
        return "undefined" != typeof a && "beforeunload" == s.type && (i.returnValue = a),
        a
    };
    return i
}
        ...
        if ("domready" == i)
            ...
            if ("mouseleave" != i || u) {
                if ("transitionend" == i || "transitionstart" == i) {
                    var l, d = i.replace("transition", "");
                    d = d.substr(0, 1).toUpperCase() + d.substr(1),
                    "undefined" != typeof document.body.style.WebkitTransition ? l = "webkit" : "undefined" != typeof document.body.style.OTransition ? l = "o" : "undefined" != typeof document.body.style.MsTransition && (l = "ms"),
                    ...
                    var l, d = i.replace("animation", "");
                    d = d.substr(0, 1).toUpperCase() + d.substr(1),
                    "undefined" != typeof document.body.style.WebkitAnimationName ? l = "webkit" : "undefined" != typeof document.body.style.OAnimationName ? l = "o" : "undefined" != typeof document.body.style.MsTransitionName && (l = "ms"),
                ...
                i = "mouseout",
                o = jindo.$Fn._fireWhenElementBoundary(r, o);
        else
            i = "mouseover",
            o = jindo.$Fn._fireWhenElementBoundary(r, o);
        r.addEventListener(i, o, n)
    }
    return this._key || (this._key = "$" + jindo.$Fn.gc.count++,
...
jindo.$Fn.prototype.detach = function(e, t) {
    ...
    for (var a = this._events, s = 0; s < a.length; s++)
        if (a[s].element === o && a[s].event === i) {
            n = a[s].func,
            this._events = jindo.$A(this._events).refuse(a[s]).$value();
            break
        }
    if ("undefined" == typeof o.removeEventListener || jindo.$Fn._resizeEventBugInIE(t)) {
        if ("undefined" != typeof o.detachEvent) {
            if ("domready" == i)
                return jindo.$Fn._domready.list = jindo.$Fn._domready.list.refuse(n),
                this;
        ...
        if ("domready" == i)
            i = "DOMContentLoaded";
        else if ("mousewheel" == i && r.indexOf("WebKit") < 0)
            i = "DOMMouseScroll";
        else if ("mouseenter" == i)
            i = "mouseover";
        else if ("mouseleave" == i)
            i = "mouseout";
        else if ("transitionend" == i || "transitionstart" == i) {
            var u, l = i.replace("transition", "");
            l = l.substr(0, 1).toUpperCase() + l.substr(1),
            "undefined" != typeof document.body.style.WebkitTransition ? u = "webkit" : "undefined" != typeof document.body.style.OTransition ? u = "o" : "undefined" != typeof document.body.style.MsTransition && (u = "ms"),
            i = (u ? u + "Transition" : "transition") + l,
            this._for_test_detach = i,
            this._for_test_attach = ""
        } else if ("animationstart" == i || "animationend" == i || "animationiteration" == i) {
            var u, l = i.replace("animation", "");
            l = l.substr(0, 1).toUpperCase() + l.substr(1),
            "undefined" != typeof document.body.style.WebkitAnimationName ? u = "webkit" : "undefined" != typeof document.body.style.OAnimationName ? u = "o" : "undefined" != typeof document.body.style.MsTransitionName && (u = "ms"),
...
jindo.$Fn.prototype.free = function(e) {
    for (var t = this._events.length; t > 0; ) {
        ...
        if (!e || n === e) {
            this.detach(n, o);
            var i = !e;
            i && window === n && "unload" == o && _ua.indexOf("MSIE") < 1 && this._func.call(this._this),
...
jindo.$Fn._domready = function(e, t) {
    if ("undefined" == typeof jindo.$Fn._domready.list) {
        ...
        e.onreadystatechange = function() {
            "complete" == e.readyState && (e.onreadystatechange = null,
            r())
        }
    } else
        jindo.$Fn._domready.list.push(t)
}
,
...
jindo.$Fn.gc.count = 0,
jindo.$Fn.gc.pool = {},
"undefined" == typeof window || isUnCacheAgent() || jindo.$Fn(jindo.$Fn.gc).attach(window, "unload"),
jindo.$ElementList = function(e) {
    var t = arguments.callee;
    return e instanceof t ? e : this instanceof t ? (e = e instanceof Array ? jindo.$A(e) : jindo.$A && e instanceof jindo.$A ? jindo.$A(e.$value()) : "string" == typeof e && jindo.cssquery ? jindo.$A(jindo.cssquery(e)) : jindo.$A(),
...
,
function(e) {
    var t = ["show", "hide", "toggle", "addClass", "removeClass", "toggleClass", "fireEvent", "leave", "empty", "appear", "disappear", "className", "width", "height", "text", "html", "css", "attr"];
    jindo.$A(t).forEach(function(t) {
        e[t] = function() {
            var e = jindo.$A(arguments).$value();
            return this._elements.forEach(function(n) {
                n[t].apply(n, e)
            }),
            this
        }
    ...
    jindo.$A(["appear", "disappear"]).forEach(function(t) {
        e[t] = function(e, n) {
            var o = this._elements.length
              , i = this;
            return this._elements.forEach(function(r, s) {
                s == o - 1 ? r[t](e, function() {
                    n(i)
                }) : r[t](e)
            }),
            this
...
jindo.$S.prototype.bytes = function(e) {
    var t, n, o = 0, i = 0, r = 0, s = this._str.length, a = (document.charset || document.characterSet || document.defaultCharset) + "";
    if ("undefined" == typeof e ? t = !1 : e.constructor == Number ? (t = !0,
    n = e) : e.constructor == Object ? (a = e.charset || a,
    n = e.size || !1,
    t = !!n) : t = !1,
    "utf-8" == a.toLowerCase()) {
        for (r = 0; s > r; r++)
            if (o = this._str.charCodeAt(r),
        ...
        for (r = 0; s > r; r++)
            if (i += this._str.charCodeAt(r) > 128 ? 2 : 1,
            t && i > n) {
                this._str = this._str.substr(0, r);
                break
            }
...
jindo.$S.prototype.parseString = function() {
    ...
    for (var e, t, n, o = this._str.split(/&/g), i = {}, r = !1, s = 0; s < o.length; s++) {
        t = o[s].substring(0, e = o[s].indexOf("=")),
        r = !1;
        try {
            n = decodeURIComponent(o[s].substring(e + 1))
        } catch (a) {
            r = !0,
            n = decodeURIComponent(unescape(o[s].substring(e + 1)))
        }
        "[]" == t.substr(t.length - 2, 2) ? (t = t.substring(0, t.length - 2),
        "undefined" == typeof i[t] && (i[t] = []),
        i[t][i[t].length] = r ? escape(n) : n) : i[t] = r ? escape(n) : n
    }
    return i
}
,
    ...
    var e = arguments
      ...
      , n = this._str.replace(/%([ 0])?(-)?([1-9][0-9]*)?([bcdsoxX])/g, function(n, o, i, r, s) {
        ...
        "s" == s)
            ...
            if ("number" != typeof a)
                return "";
            u = "c" == s ? String.fromCharCode(a) : a.toString({
                b: 2,
                d: 10,
                o: 8,
                x: 16,
        ...
        return u.length < r && (l = jindo.$S(o || " ").times(r - u.length).toString()),
        "-" == i ? u += l : u = l + u,
        u
    });
    return jindo.$S(n)
...
jindo.$Document = function(e) {
    var t = arguments.callee;
    return e instanceof t ? e : this instanceof t ? (this._doc = e || document,
    void (this._docKey = "Standards" == this.renderingMode() ? "documentElement" : "body")) : new t(e)
}
,
...
jindo.$Document.prototype.renderingMode = function() {
    var e, t = navigator.userAgent, n = "undefined" == typeof window.opera && t.indexOf("MSIE") > -1, o = t.indexOf("WebKit") > -1 && t.indexOf("Chrome") < 0 && navigator.vendor.indexOf("Apple") > -1;
    return e = "compatMode"in this._doc ? "CSS1Compat" == this._doc.compatMode ? "Standards" : n ? "Quirks" : "Almost" : o ? "Standards" : "Quirks"
}
,
...
jindo.$Form = function(e) {
    ...
    if (!(this instanceof t))
        return new t(e);
    if (e = jindo.$(e),
    !e.tagName || "FORM" != e.tagName.toUpperCase())
...
jindo.$Form.prototype.enable = function() {
    ...
    if ("object" == typeof e) {
        var t = this;
        return jindo.$H(e).forEach(function(e, n) {
            t.enable(n, e)
        }),
        this
    }
    ...
    if (!n)
        return this;
    if (n = 1 == n.nodeType ? [n] : n,
    arguments.length < 2) {
        var o = !0;
        return jindo.$A(n).forEach(function(e) {
            e.disabled && (o = !1,
            jindo.$A.Break())
        }),
        o
    ...
    arguments.length > 1) {
        ...
        return jindo.$A(n).forEach(function(e) {
            ...
            case "radio":
                ...
                break;
            case "checkbox":
                o.constructor == Array ? e.checked = jindo.$A(o).has(e.value) : e.checked = e.value == o;
                break;
            case "select-one":
...
jindo.$Form.prototype.submit = function(e, t) {
    var n = null;
    return "string" == typeof e && (n = this._form.target,
    this._form.target = e),
    "function" == typeof e && (t = e),
    "undefined" == typeof t || t(this._form) ? (this._form.submit(),
    null !== n && (this._form.target = n),
    this) : this
}
,
jindo.$Form.prototype.reset = function(e) {
    return "undefined" == typeof e || e(this._form) ? (this._form.reset(),
    this) : this
}
,
jindo.$Template = function(e) {
    var t = null
      , n = ""
      , o = arguments.callee;
    return e instanceof o ? e : this instanceof o ? ("undefined" == typeof e ? e = "" : (t = document.getElementById(e) || e) && t.tagName && (n = t.tagName.toUpperCase()) && ("TEXTAREA" == n || "SCRIPT" == n && "text/template" == t.getAttribute("type")) && (e = (t.value || t.innerHTML).replace(/^\s+|\s+$/g, "")),
    void (this._str = e + "")) : new o(e)
}
,
...
jindo.$Template.prototype.process = function(data) {
    ...
    , "", ""]
      , stm = []
      , lev = 0;
    if (tpl[0] = tpl[0].substr(1),
    tpl[i - 1] = tpl[i - 1].substr(0, tpl[i - 1].length - 1),
    2 > i)
        return tpl[0];
    tpl = jindo.$A(tpl).reverse().$value();
    for (var delete_info; i--; )
        i % 2 ? tpl[i] = tpl[i].replace(jindo.$Template.pattern, function() {
            var e = arguments;
            if (e[10])
                return e[10].replace(/(\w+)(?:\s*)=(?:\s*)(?:([a-zA-Z0-9_]+)|(.+))$/g, function() {
                    var e = arguments
                      , t = "d." + e[1] + "=";
                    return t += e[2] ? "d." + e[2] : e[3].replace(/(=(?:[a-zA-Z_][\w\.]*)+)/g, function(e) {
                        return "=" == e.substring(0, 1) ? "d." + e.replace("=", "") : e
                    })
                }) + ";";
            if (e[9])
                return "s[i++]=" + e[9].replace(/(=(?:[a-zA-Z_][\w\.]*)+)/g, function(e) {
                    return "=" == e.substring(0, 1) ? "d." + e.replace("=", "") : e
                }) + ";";
            if (e[8])
                return "s[i++]= d." + e[8] + ";";
            if (e[1])
                return "if(" + e[1].replace(reg[0], cb[0]).replace(/d\.(typeof) /, "$1 ").replace(/ d\.(instanceof) d\./, " $1 ") + "){";
            if (e[2])
                return "}else if(" + e[2].replace(reg[0], cb[0]).replace(/d\.(typeof) /, "$1 ").replace(/ d\.(instanceof) d\./, " $1 ") + "){";
            if (e[5]) {
                delete_info = e[4];
                var t = [];
                return t.push("var t#=d." + e[5] + "||{},p#=isArray(t#),i#=0;"),
                t.push("for(var x# in t#){"),
                t.push("if(!t#.hasOwnProperty(x#)){continue;}"),
                t.push("	if( (p# && isNaN(i#=parseInt(x#,10))) || (!p# && !t#.propertyIsEnumerable(x#)) ) continue;"),
                t.push("	d." + e[4] + "=t#[x#];"),
                t.push(e[3] ? "d." + e[3] + "=p#?i#:x#;" : ""),
                t.join("").replace(reg[4], lev++)
            }
            return e[6] ? "}else{" : e[7] ? "for" == e[7] ? "delete d." + delete_info + "; };" : "};" : e[0]
...
jindo.$Date = function(e) {
    ...
    if (e && e instanceof o)
        return e;
    if (!(this instanceof o))
        return new o(t[0],t[1],t[2],t[3],t[4],t[5],t[6]);
    if ("string" == (n = typeof e))
        if (/(\d\d\d\d)(?:-?(\d\d)(?:-?(\d\d)))/.test(e))
            try {
                this._date = new Date(e),
                this._date.toISOString ? "Invalid Date" == this._date.toISOString() && (this._date = jindo.$Date.makeISO(e)) : this._date = jindo.$Date.makeISO(e)
            } catch (i) {
                this._date = jindo.$Date.makeISO(e)
            }
        else
            this._date = o.parse(e);
    else if ("number" == n)
        if ("undefined" == typeof t[1])
            this._date = new Date(e);
        else {
            for (var r = 0; 7 > r; r++)
                "number" != typeof t[r] && (t[r] = 1);
            this._date = new Date(t[0],t[1],t[2],t[3],t[4],t[5],t[6])
        }
    else
        "object" == n && e.constructor == Date ? ((this._date = new Date).setTime(e.getTime()),
        this._date.setMilliseconds(e.getMilliseconds())) : this._date = new Date;
    this._names = {};
...
jindo.$Date.makeISO = function(e) {
    var t = e.match(/(\d\d\d\d)(?:-?(\d\d)(?:-?(\d\d)(?:[T ](\d\d)(?::?(\d\d)(?::?(\d\d)(?:\.(\d+))?)?)?(Z|(?:([-+])(\d\d)(?::?(\d\d))?)?)?)?)?)?/)
      , n = parseInt(t[4] || 0, 10)
      , o = parseInt(t[5] || 0, 10);
    return "Z" == t[8] ? n += jindo.$Date.utc : ("+" == t[9] || "-" == t[9]) && (n += jindo.$Date.utc - parseInt(t[9] + t[10], 10),
    o += parseInt(t[9] + t[11], 10)),
...
jindo.$Date.prototype.name = function(e) {
    if (!arguments.length)
        return this._names;
    for (var t in e)
        e.hasOwnProperty(t) && (this._names[t] = e[t])
}
,
...
jindo.$Date.prototype.format = function(e) {
    ...
    return (e || "").replace(/[a-z]/gi, function(e) {
        ...
        case "z":
            return t.z = Math.floor((n.getTime() - new Date(n.getFullYear(),0,1).getTime()) / 864e5),
            t.z;
        case "m":
        case "n":
            return t.n = n.getMonth() + 1,
            t.m = (t.n > 9 ? "" : "0") + t.n,
            t[e];
        case "L":
            return t.L = i.isLeapYear(),
            t.L;
        case "o":
        case "Y":
        case "y":
            return t.o = t.Y = n.getFullYear(),
            t.y = (t.o + "").substr(2),
            t[e];
        case "a":
        case "A":
        ...
        case "H":
            ...
            t[e];
        case "i":
            return t.i = ((t.i = n.getMinutes()) > 9 ? "" : "0") + t.i,
            t.i;
        case "s":
            return t.s = ((t.s = n.getSeconds()) > 9 ? "" : "0") + t.s,
            t.s;
        case "u":
            return t.u = n.getMilliseconds(),
            t.u;
        case "U":
            return t.U = i.time(),
            t.U;
...
jindo.$Date.prototype.time = function(e) {
    return "number" == typeof e ? (this._date.setTime(e),
    this) : this._date.getTime()
}
,
jindo.$Date.prototype.year = function(e) {
    return "number" == typeof e ? (this._date.setFullYear(e),
    this) : this._date.getFullYear()
}
,
jindo.$Date.prototype.month = function(e) {
    return "number" == typeof e ? (this._date.setMonth(e),
    this) : this._date.getMonth()
}
,
jindo.$Date.prototype.date = function(e) {
    return "number" == typeof e ? (this._date.setDate(e),
    this) : this._date.getDate()
}
,
...
jindo.$Date.prototype.hours = function(e) {
    return "number" == typeof e ? (this._date.setHours(e),
    this) : this._date.getHours()
}
,
jindo.$Date.prototype.minutes = function(e) {
    return "number" == typeof e ? (this._date.setMinutes(e),
    this) : this._date.getMinutes()
}
,
jindo.$Date.prototype.seconds = function(e) {
    return "number" == typeof e ? (this._date.setSeconds(e),
    this) : this._date.getSeconds()
}
,
...
jindo.$Window.prototype.resizeTo = function(e, t) {
    return this._win.resizeTo(e, t),
    this
}
,
jindo.$Window.prototype.resizeBy = function(e, t) {
    return this._win.resizeBy(e, t),
    this
}
,
jindo.$Window.prototype.moveTo = function(e, t) {
    return this._win.moveTo(e, t),
    this
}
,
jindo.$Window.prototype.moveBy = function(e, t) {
    return this._win.moveBy(e, t),
    this
}
,
jindo.$Window.prototype.sizeToContent = function(e, t) {
    if ("function" == typeof this._win.sizeToContent)
        this._win.sizeToContent();
    else {
        if (2 != arguments.length) {
            var n, o, i = this._win, r = this._win.document;
            i.innerHeight ? (n = i.innerWidth,
            o = i.innerHeight) : r.documentElement && r.documentElement.clientHeight ? (n = r.documentElement.clientWidth,
            o = r.documentElement.clientHeight) : r.body && (n = r.body.clientWidth,
            o = r.body.clientHeight);
            var s, a, u = r.body.scrollHeight, l = r.body.offsetHeight;
            u > l ? (s = r.body.scrollWidth,
            a = r.body.scrollHeight) : (s = r.body.offsetWidth,
            a = r.body.offsetHeight),
            e = s - n,
            t = a - o
        }
        this.resizeBy(e, t)
...
"undefined" != typeof window)
    for (prop in jindo)
        jindo.hasOwnProperty(prop) && (window[prop] = jindo[prop]);
