jindo.Component = jindo.$Class({
    ...
    option: function(t, e) {
        ...
        case "string":
            if ("undefined" == typeof e)
                return this._htOption[t];
            if ("htCustomEventHandler" == t) {
                if ("undefined" != typeof this._htOption[t])
                    return this;
                this.attach(e)
            }
            this._htOption[t] = e,
        ...
        case "object":
            for (var n in t) {
                if ("htCustomEventHandler" == n) {
                    if ("undefined" != typeof this._htOption[n])
                        continue;
                    this.attach(t[n])
                }
    ...
    optionSetter: function(t, e) {
        ...
        case "string":
            if ("undefined" == typeof e)
                return this._htOption._htSetter[t];
            this._htOption._htSetter[t] = jindo.$Fn(e, this).bind();
            break;
        case "object":
            for (var n in t)
                this._htOption._htSetter[n] = jindo.$Fn(t[n], this).bind()
        }
        return this
    },
    fireEvent: function(t, e) {
        ...
        i = i.concat(),
        e.sType = t,
        "undefined" == typeof e._aExtend && (e._aExtend = [],
        e.stop = function() {
    ...
    attach: function(t, e) {
        if (1 == arguments.length)
            return jindo.$H(arguments[0]).forEach(jindo.$Fn(function(t, e) {
                this.attach(e, t)
            }, this).bind()),
            this;
        var n = this._htEventHandler[t];
        return "undefined" == typeof n && (n = this._htEventHandler[t] = []),
        n.push(e),
        this
    },
    detach: function(t, e) {
    ...
    detachAll: function(t) {
        ...
        if (arguments.length)
            return "undefined" == typeof e[t] ? this : (delete e[t],
            this);
        for (var n in e)
            delete e[n];
        return this
...
jindo.Component.getInstance = function() {
    return "undefined" == typeof this._aInstance && (this._aInstance = []),
    this._aInstance
}
,
jindo.UIComponent = jindo.$Class({
    ...
    activate: function() {
        return this.isActivating() ? this : (this._bIsActivating = !0,
        arguments.length > 0 ? this._onActivate.apply(this, arguments) : this._onActivate(),
        this)
    },
    deactivate: function() {
        return this.isActivating() ? (this._bIsActivating = !1,
...
jindo.RolloverArea = jindo.$Class({
    ...
    _onActivate: function() {
        ...
        this.option("bCheckMouseDown") && (this._wfMouseDown.attach(this._elArea, "mousedown"),
    ...
    _onMouseOver: function(t) {
        for (var e, n = t.element, i = t.relatedElement; n = this._findRollover(n); n = n.parentNode)
            i && this._isInnerElement(n, i) || (this._addOvered(n),
            e = {
                element: n,
    ...
    _onMouseOut: function(t) {
        for (var e, n = t.element, i = t.relatedElement; n = this._findRollover(n); n = n.parentNode)
            i && this._isInnerElement(n, i) || (this._removeOvered(n),
            e = {
                element: n,
                htStatus: this.option("htStatus"),
                weEvent: t
    ...
    _onMouseUp: function(t) {
        var e, n, i, s = t.element, a = [], o = this._aDownedElements;
        for (i = 0; n = o[i]; i++)
            a.push({
                element: n,
                htStatus: this.option("htStatus"),
...
jindo.Calendar = jindo.$Class({
    ...
    _assignHTMLElements: function() {
        ...
        (this.elBtnPrevYear = jindo.$$.getSingle("." + t + "btn-prev-year", e)) && (this.wfPrevYear = jindo.$Fn(function(t) {
            t.stop(jindo.$Event.CANCEL_DEFAULT),
            this.draw(-1, 0, !0)
        }, this)),
        (this.elBtnPrevMonth = jindo.$$.getSingle("." + t + "btn-prev-mon", e)) && (this.wfPrevMonth = jindo.$Fn(function(t) {
            t.stop(jindo.$Event.CANCEL_DEFAULT),
            this.draw(0, -1, !0)
        }, this)),
        (this.elBtnNextMonth = jindo.$$.getSingle("." + t + "btn-next-mon", e)) && (this.wfNextMonth = jindo.$Fn(function(t) {
            t.stop(jindo.$Event.CANCEL_DEFAULT),
            this.draw(0, 1, !0)
        }, this)),
        (this.elBtnNextYear = jindo.$$.getSingle("." + t + "btn-next-year", e)) && (this.wfNextYear = jindo.$Fn(function(t) {
            t.stop(jindo.$Event.CANCEL_DEFAULT),
            this.draw(1, 0, !0)
        }, this)),
        ...
        this.elWeekTemplate = n.cloneNode(!0),
        this.elWeekAppendTarget = n.parentNode
    },
    _setCalendarTitle: function(t, e, n) {
        10 > e && (e = ("0" + 1 * e).toString());
        var i, s = this.elTitle, a = this.option("sTitleFormat");
        if ("undefined" != typeof n)
            ...
            case "month":
                ...
                i = a.replace(/mm/g, e).replace(/m/g, 1 * e).replace(/M/g, this.option("aMonthTitle")[e - 1])
            }
        else
            i = a.replace(/yyyy/g, t).replace(/y/g, t.toString().substr(2, 2)).replace(/mm/g, e).replace(/m/g, 1 * e).replace(/M/g, this.option("aMonthTitle")[e - 1]);
    ...
    draw: function(t, e, n) {
        ...
        if (a && "undefined" != typeof n && n) {
            ...
            "undefined" == typeof t && "undefined" == typeof e && "undefined" == typeof n ? (t = s.nYear,
            e = s.nMonth) : (t = t || a.nYear,
            e = e || a.nMonth);
        if (this.fireEvent("beforeDraw", {
            ...
            var r, h, l, u, c, f, d, _, g, p = this.getToday(), v = this.constructor.getFirstDay(t, e), m = this.constructor.getLastDay(t, e), E = this.constructor.getLastDate(t, e), w = 0, P = this.constructor.getRelativeDate(0, -1, 0, {
                nYear: t,
                nMonth: e,
                nDate: 1
                ...
                nMonth: e,
                nDate: 1
            }), L = this.constructor.getLastDate(P.nYear, P.nMonth), j = [], b = this.constructor.getWeeks(t, e);
            for (g = 0; b > g; g++)
                _ = this.elWeekTemplate.cloneNode(!0),
                jindo.$Element(_).appendTo(this.elWeekAppendTarget),
                this._aWeekElement.push(_);
            if (this._aDateElement = jindo.$$("." + i + "date", this.elWeekAppendTarget),
            ...
            for (g = 0; g < j.length; g++)
                ...
                c = e,
                v > g ? (r = !0,
                l.addClass(i + "prev-mon"),
                u = P.nYear,
                c = P.nMonth) : g > d ? (h = !0,
                l.addClass(i + "next-mon"),
                u = D.nYear,
                c = D.nMonth) : (u = t,
                c = e),
...
jindo.LayerManager = jindo.$Class({
    ...
    _check: function(t) {
        for (var e, n = jindo.$Element(t), i = 0; e = this._aLink[i]; i++)
            if (e = jindo.$Element(e).$value(),
            e && (t == e || n.isChildOf(e)))
                return !0;
        return !1
    },
    _find: function(t) {
        for (var e, n = 0; e = this._aLink[n]; n++)
            if (e == t)
                return n;
        return -1
    },
    ...
    setLinks: function(t) {
        return this._aLink = jindo.$A(t).unique().$value(),
        this
    },
    link: function(t) {
        if (arguments.length > 1) {
            for (var e = 0, n = arguments.length; n > e; e++)
                this.link(arguments[e]);
            return this
        }
        return -1 != this._find(t) ? this : (this._aLink.push(t),
        this)
    },
    unlink: function(t) {
        if (arguments.length > 1) {
            for (var e = 0, n = arguments.length; n > e; e++)
                this.unlink(arguments[e]);
            return this
        }
        var i = this._find(t);
        return i > -1 && this._aLink.splice(i, 1),
        this
    },
    ...
    _show: function(t, e) {
        ...
        this._bIsShowing = !0,
        this._bIsHiding = !1,
        e > 0 ? this._oShowTimer.start(t, e) : (this._oHideTimer.abort(),
        t())
    },
    _hide: function(t, e) {
        this._bIsShowing = !1,
        this._bIsHiding = !0,
        e > 0 ? this._oHideTimer.start(t, e) : (this._oShowTimer.abort(),
        t())
    },
    ...
    show: function(t) {
        return "undefined" == typeof t && (t = this.option("nShowDelay")),
        this[this._getShowMethod()](t),
        this
    },
    hide: function(t) {
        return "undefined" == typeof t && (t = this.option("nHideDelay")),
    ...
    showIn: function(t) {
        ...
        return this._show(function() {
            ...
            e.getVisible() || e._fireEventBeforeShow() && (e._wel.show(),
            e._fireEventAppear(),
            e._fireEventShow())
        }, t),
        this
    ...
    hideOut: function(t) {
        ...
        return this._hide(function() {
            e._sAppliedMethod = "show",
            e.getVisible() && e._fireEventBeforeHide() && (e._wel.hide(),
            e._fireEventHide())
        }, t),
        this
    },
    _getTransition: function() {
        return this._oTransition ? this._oTransition : this._oTransition = (new jindo.Transition).fps(30)
    },
    fadeIn: function(t) {
        ...
        return this._show(function() {
            ...
            var t = i.getLayer();
            i._wel.visible() && 1 == i._wel.opacity() || i._fireEventBeforeShow() && (i._wel.visible() || (i._wel.opacity(0),
            i._wel.show()),
            n *= 1 - i._wel.opacity(),
            e.attach({
                playing: function(t) {
                    1 === t.nStep && (this.detach("playing", arguments.callee),
                    i._fireEventAppear())
                },
                end: function(t) {
                ...
                "@opacity": i.option("Transition").fFadeIn.apply(null, [1])
            }))
        }, t),
        this
    },
    fadeOut: function(t) {
        ...
        var n = this.option("nDuration")
          , i = this;
        return this._hide(function() {
            if (i._sAppliedMethod = "fade",
            i.getVisible()) {
                var t = i.getLayer();
                i._fireEventBeforeHide() && (n *= i._wel.opacity(),
                e.attach({
                    end: function(t) {
                        this.detach("end", arguments.callee),
                        i._wel.hide(),
                    ...
                    "@opacity": i.option("Transition").fFadeOut.apply(null, [0])
                }))
            }
        }, t),
        this
    ...
    slideDown: function(t) {
        ...
        return this._show(function() {
            ...
            var t = i.getLayer();
            Math.ceil(i._wel.height()) < i._nLayerHeight && i._fireEventBeforeShow() && (i.getVisible() ? n = Math.ceil(n * ((i._nLayerHeight - i._wel.height()) / (i._nLayerHeight - i._nSlideMinHeight))) : i._wel.height(0).show(),
            e.attach({
                playing: function(t) {
                    1 === t.nStep && (this.detach("playing", arguments.callee),
                    i._fireEventAppear())
    ...
    slideUp: function(t) {
        ...
        return this._hide(function() {
            i._sAppliedMethod = "slide";
            var t = i.getLayer();
            i.getVisible() && i._fireEventBeforeHide() && (n = Math.ceil(n * (i._wel.height() / i._nLayerHeight)),
            e.attach({
                end: function(t) {
                    i._wel.hide().css({
                        height: i._sLayerCSSHeight
                    }),
                    this.detach("end", arguments.callee),
                    i._fireEventHide()
                }
    ...
    toggle: function(t) {
        return !this.getVisible() || this._bIsHiding ? this.show(t || this.option("nShowDelay")) : this.hide(t || this.option("nHideDelay")),
        this
    },
    _onEvent: function(t) {
        var e = t.element
        ...
        this._oEventTimer.start(function() {
            !n._bIsHiding && n.getVisible() && (n._check(e) ? n._bIsShowing || (n.fireEvent("ignore", {
                sCheckEvent: n.option("sCheckEvent")
            }),
            n._oHideTimer.abort(),
            n._bIsHiding = !1) : "undefined" != typeof e.tagName && n.hide())
...
jindo.LayerPosition = jindo.$Class({
    $init: function(t, e, n) {
        ...
        this._wfSetPosition = jindo.$Fn(function() {
            var t = this._elLayer;
            t && this._welLayer.visible() && this.fireEvent("beforeAdjust", {
                elLayer: t,
        ...
        this.option("bAuto") && this._wfSetPosition.attach(window, "scroll").attach(window, "resize")
    },
    getElement: function() {
        return this._el
    },
    setElement: function(t) {
        return this._el = jindo.$(t),
        this._wel = jindo.$Element(t),
        this
    },
    getLayer: function() {
    ...
    _setLeftRight: function(t, e) {
        ...
        return o ? h ? e.nLeft += t.nLeft : (e.nLeft -= a,
        e.nLeft -= t.nLeft) : r ? (e.nLeft += s,
        h ? (e.nLeft -= a,
        e.nLeft -= t.nLeft) : e.nLeft += t.nLeft) : ("left" == t.sAlign && (e.nLeft += t.nLeft),
        "center" == t.sAlign && (e.nLeft += (s - a) / 2),
        "right" == t.sAlign && (e.nLeft += s - a,
        e.nLeft -= t.nLeft)),
        e
    },
    _setVerticalAlign: function(t, e) {
        var n = this.getElement()
          ...
          , s = n.offsetHeight
          , a = i.offsetHeight;
        switch (n == document.body && (s = jindo.$Document().clientSize().height),
        t.sValign) {
        case "top":
            e.nTop += t.nTop;
            break;
    ...
    getPosition: function(t) {
        ...
        var e, n = this._isPosition(t, "center"), i = this._isPosition(t, "inside"), s = this._isPosition(t, "top"), a = this._isPosition(t, "bottom"), o = this._isPosition(t, "left"), r = this._isPosition(t, "right");
        o && (e = "left"),
        r && (e = "right"),
        s && (e = "top"),
        a && (e = "bottom"),
        n && (e = "center");
        var h, l = this.getElement(), u = jindo.$Element(l), c = this.getLayer(), f = jindo.$Element(c), d = u.offset(), _ = l.offsetWidth, g = l.offsetHeight, p = c.offsetWidth, v = c.offsetHeight, m = {
            nTop: d.top,
            nLeft: d.left
        };
        switch (l == document.body && (h = jindo.$Document().clientSize(),
        _ = h.width,
        g = h.height),
        ...
        case "center":
            ...
            break;
        case "top":
            i ? m.nTop += t.nTop : m.nTop -= t.nTop + v,
        ...
        case "bottom":
            ...
            break;
        case "left":
            i ? m.nLeft += t.nLeft : m.nLeft -= t.nLeft + p,
    ...
    setPosition: function(t) {
        ...
        return e.css("left", "-9999px").css("top", "0px"),
    ...
    getCurrentPosition: function() {
        ...
        return {
            nTop: parseInt(t.css("top")),
            nLeft: parseInt(t.css("left"))
        }
    },
    _isFullyVisible: function(t) {
        var e = this.getLayer()
          ...
          , h = e.offsetHeight + (parseInt(n.css("marginTop")) + parseInt(n.css("marginBottom")) || 0);
        return t.nLeft >= 0 && t.nTop >= 0 && o.width >= t.nLeft - a + r && o.height >= t.nTop - s + h ? !0 : !1
    },
    _mirrorHorizontal: function(t) {
        if ("center" == t.sAlign || "inside-center" == t.sPosition)
            return t;
        var e = {};
        for (var n in t)
            e[n] = t[n];
        return this._isPosition(e, "right") ? e.sPosition = e.sPosition.replace(/right/, "left") : this._isPosition(e, "left") ? e.sPosition = e.sPosition.replace(/left/, "right") : "right" == e.sAlign ? e.sAlign = "left" : "left" == e.sAlign && (e.sAlign = "right"),
        e
    },
    _mirrorVertical: function(t) {
        if ("middle" == t.sValign || "inside-center" == t.sPosition)
            return t;
        var e = {};
        for (var n in t)
            e[n] = t[n];
        return this._isPosition(e, "top") ? e.sPosition = e.sPosition.replace(/top/, "bottom") : this._isPosition(e, "bottom") ? e.sPosition = e.sPosition.replace(/bottom/, "top") : "top" == e.sValign ? e.sValign = "bottom" : "bottom" == e.sValign && (e.sValign = "top"),
        e
    },
...
jindo.Timer = jindo.$Class({
    ...
    _clearTimer: function() {
        var t = !1;
        return this._nTimer && (clearInterval(this._nTimer),
        this._bIsRunning = !1,
        t = !0),
        this._nTimer = null,
        t
    ...
    abort: function() {
        ...
        return t && (this.fireEvent("abort"),
        this._fRun = null),
        t
    },
    pause: function() {
        var t = this._getTime() - this._nLatest;
        return this._nRemained = Math.max(this._nDelay - t, 0),
        this._clearTimer()
    },
    _excute: function(t, e) {
        ...
        this._nTimer = setInterval(function() {
            if (n._nTimer) {
                n.fireEvent("run");
                var t = n._fRun();
                if (n._nLatest = n._getTime(),
                !t)
                    return clearInterval(n._nTimer),
                    n._nTimer = null,
                    n._bIsRunning = !1,
                    void n.fireEvent("end");
                n.fireEvent("wait"),
                e && n._excute(n._nDelay, !1)
            }
        }, t)
    },
    resume: function() {
        return !this._fRun || this.isRunning() ? !1 : (this._bIsRunning = !0,
        this.fireEvent("wait"),
...
jindo.Transition = jindo.$Class({
    ...
    fps: function(t) {
        return arguments.length > 0 ? (this._nFPS = t,
        this) : this._nFPS
    },
    isPlaying: function() {
    ...
    start: function(t, e, n) {
        return arguments.length > 0 && this.queue.apply(this, arguments),
    ...
    queue: function(t, e) {
        ...
        if ("function" == typeof arguments[0])
            ...
            for (var a = 0; a < i.length; a++) {
                ...
                for (var l in h)
                    o = h[l],
                    /^(@|style\.)(\w+)/i.test(l) ? r.push(["style", RegExp.$2, o]) : r.push(["attr", l, o]);
                n.aList.push({
                    elTarget: i[a][0],
                    aValue: r
                })
        ...
        return this._queueTask(n),
        this
    },
    pause: function() {
        return this._oTimer.abort() && this.fireEvent("pause"),
        this
    },
    resume: function() {
        if (this._htTaskToDo) {
            ...
            if ("task" == t.sType)
                for (var e = t.aList, n = 0, i = e.length; i > n; n++)
                    for (var s = e[n].elTarget, a = 0, o = e[n].aValue, r = o.length; r > a; a++) {
                        var h = o[a][0]
                          , l = o[a][2];
                        if ("function" != typeof l && (l = l instanceof Array ? this.option("fEffect")(l[0], l[1]) : this.option("fEffect")(l)),
                        l.setStart)
    ...
    _prepareNextTask: function() {
        if (this._bIsWaiting) {
            ...
            if (t)
                ...
                this._bIsPlaying && (this._bIsPlaying = !1,
                this.abort(),
                this.fireEvent("end"))
        }
    },
    ...
    _doTask: function() {
        for (var t = this._htTaskToDo, e = parseFloat(t.nRatio.toFixed(5), 1), n = t.nStep, i = t.nTotalStep, s = t.aList, a = {}, o = this.option("bCorrection"), r = 0, h = s.length; h > r; r++)
            for (var l = s[r].elTarget, u = 0, c = s[r].aValue, f = c.length; f > u; u++) {
                ...
                if (this._isHTMLElement(l)) {
                    ...
                    if (o) {
                        ...
                        if (v) {
                            var m, E = parseFloat(g);
                            E += a[_] || 0,
                            E = parseFloat(E.toFixed(5)),
                            r == h - 1 ? g = Math.round(E) + v : (m = parseFloat(/(\.[0-9]+)$/.test(E) && RegExp.$1 || 0),
                            g = parseInt(E, 10) + v,
                            a[_] = m)
                        }
                    }
        ...
        return t.nRatio = Math.min(t.nRatio + t.nGap, 1),
        t.nStep += 1,
        1 != e
    }
}).extend(jindo.Component),
...
jindo.Effect = function(t) {
    ...
    var e = /^(\-?[0-9\.]+)(%|px|pt|em)?$/
      ...
      , a = function(t) {
        var a, o = t;
        return e.test(t) ? (o = parseFloat(t),
        a = RegExp.$2) : n.test(t) ? (o = [parseInt(RegExp.$1, 10), parseInt(RegExp.$2, 10), parseInt(RegExp.$3, 10)],
        a = "color") : i.test(t = t.replace(s, "#$1$1$2$2$3$3")) && (o = [parseInt(RegExp.$1, 16), parseInt(RegExp.$2, 16), parseInt(RegExp.$3, 16)],
        a = "color"),
        {
            nValue: o,
            sUnit: a
    ...
    return function(e, n) {
        ...
        var s = function(s) {
            ...
            if ("color" == i) {
                ...
                for (var h = 0; 6 - r.length; h++)
                    r = "0" + r;
                return "#" + r
            }
            return o(e, n)
        };
        return null === e && (s.setStart = function(t) {
            if (t = a(t),
            t.sUnit != i)
...
,
jindo.Effect.overphase = jindo.Effect.cubicBezier(.25, .75, .8, 1.3),
jindo.Effect.easeInOut = jindo.Effect.cubicBezier(.75, 0, .25, 1),
jindo.Effect.easeOutIn = jindo.Effect.cubicBezier(.25, .75, .75, .25),
...
jindo.FileUploader = jindo.$Class({
    ...
    _appendIframe: function() {
        ...
        this._welIframe = jindo.$Element(jindo.$('<iframe name="' + t + '" src="">')).css({
            position: "absolute",
            width: "1px",
            height: "1px",
            left: "-100px",
    ...
    upload: function() {
        ...
        for (var o = 0; o < this._aHiddenInput.length; o++)
            t.appendChild(this._aHiddenInput[o]);
        this.constructor._oCallback[i + "_success"] = jindo.$Fn(function(t) {
        ...
        this.constructor._oCallback[i + "_error"] = jindo.$Fn(function(t) {
            this.option("bAutoReset") && this.reset(),
            this._revertFormAttr(),
    ...
    reset: function() {
        ...
        this._wel.wrap(t),
        t.reset(),
        jindo.$Element(t).replace(this._el);
    ...
    _onFileSelectChange: function(t) {
        ...
        e.length && this.fireEvent("select", i) && (n ? this.option("bAutoUpload") && this.upload() : alert(i.sMsgNotAllowedExt))
    },
    _clear: function() {
        null != this._sFunctionName && (delete this.constructor._oCallback[this._sFunctionName + "_success"],
...
jindo.MultipleAjaxRequest = jindo.$Class({
    ...
    _fireEventBeforeEachRequest: function(t) {
        return this.fireEvent("beforeEachRequest", {
            oAjax: this._aAjax[t],
            nIndex: t
        }) ? !0 : (this.abort(),
        !1)
    ...
    _fireEventAfterEachResponse: function(t) {
        return this.fireEvent("afterEachResponse", {
            oAjax: this._aAjax[t],
            nIndex: t
        }) ? !0 : (this.abort(),
        !1)
        ...
        this._fireEventStart()) {
            ...
            jindo.$A(this._aAjaxData).forEach(function(t, n) {
                var i = function(t) {
                    ...
                    e._aResponse[i] = t,
                    e._aStatus[i] = !0,
                    e._fireEventAfterEachResponse(i) && e._hasCompletedGotResponsesOfParallelResponses() && e._complete()
                };
                ...
                e._fireEventBeforeEachRequest(n) ? e._aAjax[n].request(t.htParameter) : jindo.$A.Break()
            })
        }
    },
    ...
    _hasCompletedGotResponsesOfParallelResponses: function() {
        var t = !0;
        return jindo.$A(this._aStatus).forEach(function(e) {
            e || (t = !1,
            jindo.$A.Break())
        }),
        t
    ...
    _serialRequest: function(t) {
        ...
        this._fireEventStart() && this._fireEventBeforeEachRequest(0) && (this._aAjax[0].request(this._aAjaxData[0].htParameter),
        this._aStatus[0] = !0)
    },
    ...
    _complete: function() {
        var t, e = this._aResponse.concat(), n = {};
        for (t in this._htMetaData)
            n[t] = this._htMetaData[t];
        this._reset(),
...
jindo.RolloverClick = jindo.$Class({
    ...
    _onActivate: function() {
        ...
        this.option("bCheckDblClick") && this._wfDblClick.attach(this._oRolloverArea._elArea, "dblclick"),
...
jindo.Pagination = jindo.$Class({
    ...
    _getPageList: function(t) {
        if (this.option("bAlignCenter")) {
            var e = Math.floor(this.option("nPagePerPageList") / 2)
              , n = t - e;
            return n = Math.max(n, 1),
            n = Math.min(n, this._getLastPage())
        }
    ...
    _onClickPageList: function(t) {
        ...
        var e = null
          , n = this.option()
          , i = t.element;
        if (this._isIn(i, n.elFirstPageLinkOn))
            e = this._getRelativePage("pre_end");
        else if (this._isIn(i, n.elPrevPageLinkOn))
            e = this._getRelativePage("pre");
        else if (this._isIn(i, n.elNextPageLinkOn))
            e = this._getRelativePage("next");
        else if (this._isIn(i, n.elLastPageLinkOn))
            e = this._getRelativePage("next_end");
        else {
    ...
    movePageTo: function(t, e) {
        ...
        (!e || this.fireEvent("beforeMove", {
            nPage: t
        })) && (this._paginate(t),
        e && this.fireEvent("move", {
            nPage: t
        }))
    },
    reset: function(t) {
    ...
    _paginate: function(t) {
        ...
        0 === u ? this._welPageList.addClass(this._wrapPrefix("no-result")) : 1 == u ? this._welPageList.addClass(this._wrapPrefix("only-one")).removeClass(this._wrapPrefix("no-result")) : this._welPageList.removeClass(this._wrapPrefix("only-one")).removeClass(this._wrapPrefix("no-result"));
        var d, _;
        if (e.bAlignCenter) {
            ...
            _ = Math.min(_, u);
        "page" == e.sMoveUnit && (c = t,
        f = u),
        t > 1 ? n && (this._welPageList.append(n),
        this._addTextNode()) : o && (this._welPageList.append(o),
        this._addTextNode()),
        c > 1 ? i && (this._welPageList.append(i),
        this._addTextNode()) : r && (this._welPageList.append(r),
        this._addTextNode());
        for (var p, v, m = d; _ >= m; m++)
            m == t ? p = jindo.$(jindo.$Template(e.sCurrentPageTemplate).process({
                page: m.toString()
            })) : (p = jindo.$(jindo.$Template(e.sPageTemplate).process({
                page: m.toString()
            })),
            this._waPage.push(p)),
            v = jindo.$Element(p),
            ...
            this._addTextNode();
        f > c ? s && (this._welPageList.append(s),
        this._addTextNode()) : h && (this._welPageList.append(h),
        this._addTextNode()),
        u > t ? a && (this._welPageList.append(a),
        this._addTextNode()) : l && (this._welPageList.append(l),
        this._addTextNode())
    },
    _empty: function() {
        var t = this.option();
...
jindo.DatePicker = jindo.$Class({
    ...
    addDatePickerSet: function(t) {
        ...
        if ("undefined" != typeof t.htOption)
            for (var i in t.htOption)
                "undefined" != typeof n[i] && (n[i] = t.htOption[i]);
        t.htOption = n,
        this._aDatePickerSet.push(t);
        var s = this.getLayerManager();
        return "undefined" != typeof t.elInput && (s.link(t.elInput),
        ...
        "undefined" != typeof t.elButton && (s.link(t.elButton),
        this._wfClickLinkedElement.attach(t.elButton, "click")),
    ...
    removeDatePickerSet: function(t) {
        for (var e = -1, n = 0, i = this._aDatePickerSet.length; i > n; n++)
            if (this._aDatePickerSet[n].elInput == t.elInput || this._aDatePickerSet[n].elButton == t.elButton) {
                e = n;
                break
            }
        var s = this._aDatePickerSet[e]
          , a = this.getLayerManager();
        return "undefined" != typeof s.elButton && (a.unlink(s.elButton),
        this._wfClickLinkedElement.detach(s.elButton, "click")),
        "undefined" != typeof s.elInput && (this._wfFocusInput.detach(s.elInput, "focus"),
    ...
    _initCalendar: function() {
        ...
        this._oCalendar = new jindo.Calendar(this.getCalendarLayer(),this.option("Calendar")).attach({
            ...
            draw: function(e) {
                ...
                t.isSelectable(i, e) ? (e.bSelectable = !0,
                jindo.Calendar.isSameDate(e, i) && jindo.$Element(e.elDateContainer).addClass(n + "selected")) : (e.bSelectable = !1,
                jindo.$Element(e.elDateContainer).addClass(this.option("sClassPrefix") + "unselectable")),
    ...
    _initLayerManager: function() {
        ...
        this._oLayerManager = new jindo.LayerManager(e,this.option("LayerManager")).attach({
            hide: function(e) {
    ...
    _initLayerPosition: function() {
        this.option("bUseLayerPosition") && (this._oLayerPosition = new jindo.LayerPosition(null,this.getCalendarLayer(),this.option("LayerPosition")))
    },
    ...
    isSelectable: function(t, e) {
        return jindo.Calendar.isBetween(e, t.htOption.htSelectableDateFrom, t.htOption.htSelectableDateTo)
    },
    setDate: function(t, e) {
        if (this.isSelectable(t, e)) {
            ...
            return this.fireEvent("beforeSelect", i) && (this._setDate(t, e),
            this.fireEvent("select", i) && this.getLayerManager().hide()),
            !0
        }
        return !1
    },
    _getDateFormat: function(t, e) {
        var n = e.nYear
          , i = e.nMonth
          , s = e.nDate;
        10 > i && (i = ("0" + 1 * i).toString()),
        10 > s && (s = ("0" + 1 * s).toString());
        var a = t.htOption.sDateFormat;
        return a = a.replace(/yyyy/g, n).replace(/y/g, n.toString().substr(2, 2)).replace(/mm/g, i).replace(/m/g, 1 * i).replace(/M/g, this.getCalendar().option("aMonthTitle")[i - 1]).replace(/dd/g, s).replace(/d/g, 1 * s)
    },
    ...
    _onClickLinkedElement: function(t) {
        if (t.stop(jindo.$Event.CANCEL_DEFAULT),
        this.fireEvent("click", {
            element: t.element
        })) {
            ...
            if (e) {
                ...
                this.option("bUseLayerPosition") && ("undefined" != typeof e.elLayerPosition ? this.getLayerPosition().setElement(e.elLayerPosition).setPosition() : this.getLayerPosition().setElement(e.elInput).setPosition())
            }
        }
    },
    ...
    _getTargetDateContainerElement: function(t) {
        ...
        if (n) {
            for (var i = t; !jindo.$Element(i.parentNode).hasClass(e + "week"); )
                i = i.parentNode;
    ...
    _onMouseOverOutDate: function(t) {
        ...
        if (i) {
            ...
            if (this._htSelectedDatePickerSet && this.isSelectable(this._htSelectedDatePickerSet, s)) {
                if ("mouseover" == t.type)
                    return this._elSelected || (this._elSelected = jindo.$$.getSingle("." + e + "selected", this.elWeekAppendTarget),
                    this._elSelected && jindo.$Element(this._elSelected).removeClass(e + "selected")),
                    void jindo.$Element(i).addClass(e + "over");
                if ("mouseout" == t.type)
                    return void jindo.$Element(i).removeClass(e + "over")
            } else
                this._elSelected && (jindo.$Element(this._elSelected).addClass(e + "selected"),
...
jindo.StarRating = jindo.$Class({
    ...
    getValueToBeSet: function(t) {
        return t = this._round(t, this.option("nStep")),
    ...
    setValue: function(t, e) {
        ...
        return i = Math.min(i, this._nBaseWidth),
        this._welRatingElement.width(i),
        this._nValue = t,
        e && this.fireEvent("set", {
            nValue: this._nValue
        }),
        this
    },
    reset: function() {
        ...
        return this.setValue(t, !1),
        this
    },
    _round: function(t, e) {
        var n, i, s = t, a = Math.floor(t), o = a + 1, r = 1;
        for (i = a; o >= i; i += e)
            n = Math.abs(t - i),
            r >= n && (r = n,
            s = i);
    ...
    _onMouseMove: function(t) {
        var e, n = t.pos(!0).offsetX + 1, i = n > this._nBaseWidth ? this._nBaseWidth : n;
        this.option("bSnap") && (e = n / this._nBaseWidth * this.option("nMaxValue"),
        i = this._round(e, this.option("nStep")) * this._nBaseWidth / this.option("nMaxValue"),
        i = Math.min(i, this._nBaseWidth)),
        this._welRatingElement.css("width", i + "px"),
        e = this.getValueByWidth(),
        this.fireEvent("move", {
            nValue: e,
            nValueToBeSet: this.getValueToBeSet(e)
        })
    },
    _onMouseLeave: function(t) {
        this.setValue(this._nValue, !1),
        this.fireEvent("out")
    },
    _onClick: function(t) {
...
jindo.DragArea = jindo.$Class({
    ...
    _findDraggableElement: function(t) {
        if (1 === t.nodeType && jindo.$$.test(t, "input[type=text], textarea, select"))
            return null;
        var e = this
          , n = "." + this.option("sClassName")
          , i = function(t) {
            return null === t ? !1 : e._el === document || e._el === t ? !0 : jindo.$Element(e._el).isParentOf(t)
        }
    ...
    stopDragging: function() {
        return this._stopDragging(!0),
        this
    },
    _stopDragging: function(t) {
        if (this._wfOnMouseMove.detach(document, "mousemove"),
        ...
        this.isDragging()) {
            ...
            e.bForceDrag = !1,
            e.bPrepared = !1,
            this._bIE && this._elSetCapture && (this._elSetCapture.releaseCapture(),
    ...
    startDragging: function(t) {
        ...
        return e ? (this._htDragInfo.bForceDrag = !0,
    ...
    _onMouseDown: function(t) {
        var e = t.mouse(!0);
        if (!e.left || e.right || e.scrollbar)
            return void this._stopDragging(!0);
    ...
    _onMouseMove: function(t) {
        var e, n, i = this._htDragInfo, s = t.pos(), a = {
            nX: s.pageX - i.nPageX,
            nY: s.pageY - i.nPageY
        };
        if (i.bPrepared) {
        ...
        if (i.bForceDrag && (a.nX = s.clientX - i.nClientX,
        a.nY = s.clientY - i.nClientY),
        e = {
            elArea: this._el,
        ...
        this.fireEvent("beforeDrag", e)) {
            ...
            if (this.option("bFlowOut") === !1) {
                var f = e.elFlowOut
                  ...
                  , _ = 0
                  , g = 0;
                if (f == document.body && (f = null),
                f && d[0] <= f.scrollWidth && d[1] <= f.scrollHeight)
                    n = {
                        nWidth: f.clientWidth,
                        nHeight: f.clientHeight
                    },
                    _ = f.scrollLeft,
                    g = f.scrollTop;
                else {
                ...
                null !== e.nX && (e.nX = Math.max(e.nX, _),
                e.nX = Math.min(e.nX, n.nWidth - d[0] + _)),
                null !== e.nY && (e.nY = Math.max(e.nY, g),
                e.nY = Math.min(e.nY, n.nHeight - d[1] + g))
            }
    ...
    _onSelectStart: function(t) {
        (this.isDragging() || this._findDraggableElement(t.element)) && t.stop(jindo.$Event.CANCEL_DEFAULT)
    }
}).extend(jindo.UIComponent),
jindo.DefaultTextValue = jindo.$Class({
    ...
    setDefault: function() {
        return this.getBaseElement().value = this.option("sValue"),
        this
    },
    setDefaultValue: function(t) {
        var e = this.option("sValue");
        return this.option("sValue", t),
        this.getBaseElement().value == e && this.setDefault(),
        this
    },
    ...
    _onFocusAndBlur: function(t) {
        ...
        switch (t.type) {
        case "focus":
            n == this.getDefaultValue() && (e.value = "",
            e.select());
            break;
        case "blur":
...
jindo.NumericStepper = jindo.$Class({
    ...
    setValue: function(t) {
        ...
        return t > n || e > t ? void this.fireEvent("overLimit", i) : void (this.fireEvent("beforeChange", i) && (this._elInput.value = i.nValue,
    ...
    _onWheel: function(t) {
        this.isFocused() && (t.stop(jindo.$Event.CANCEL_DEFAULT),
...
jindo.LazyLoading.load = function(t, e, n) {
    ...
    this._checkIsLoading(t))
        return !1;
    if (this._checkAlreadyLoaded(t))
        return this._doCallback(t),
        !0;
    ...
    : a.onreadystatechange = function() {
        ("complete" == this.readyState || "loaded" == this.readyState) && (i._waLoaded.push(t),
        i._waLoading = i._waLoading.refuse(t),
        i._doCallback(t),
...
jindo.LazyLoading._doCallback = function(t) {
    for (var e = this._whtCallback.$(t).concat(), n = 0; n < e.length; n++)
        this._whtCallback.$(t).splice(n, 1),
        e[n]()
}
,
jindo.LazyLoading.abort = function(t) {
    if (this._checkIsLoading(t)) {
        ...
        return this._waLoading = this._waLoading.refuse(t),
